...
export type VNLayerDataElement = { key: string; type: string; element: HTMLElement };

export function getDataElements(name?: string, root?: Element | Document): VNLayerDataElement[] {
