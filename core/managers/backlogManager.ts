...
export const linesAtomFamily = atomFamily((_atomKey: string) =>
  atom<LineEntry[]>([]),
);
...
export function getLines(atomKey: string): LineEntry[] {
...
export function clear(atomKey: string, instanceId: string | undefined): void {
