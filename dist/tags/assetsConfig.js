...
export function setAssetsConfig(patch, scope) {
    store.set(patch, scope);
}
export function getAssetsConfig(scope) {
...
export function getAllAssetsConfigPatches() {
    return store.getAllPatches();
}
export function restoreAssetsConfigPatches(patches) {
...
export function shouldFallbackToMock(context, scope) {
