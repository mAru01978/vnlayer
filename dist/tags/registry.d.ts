...
export declare function registerAlias(
  alias: string,
  canonicalKey: string,
): void;
export declare function setTagConfig(
  key: string,
...
export declare function runTag(
  key: string,
  args: string[],
  handlers: TagHandlers,
): Promise<void>;
...
export declare function registerBasicTag<TConfig, TValue>(
