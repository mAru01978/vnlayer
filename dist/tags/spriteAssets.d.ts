...
export declare function setSpriteAssets(
...
export declare function getCharacterSlot(name: string):
  ...
  | undefined;
export declare function getAllCharacterSlots(): Record<
  string,
  {
    originX: number;
    originY: number;
...
export declare function getBackgroundSlot(bgName: string):
  ...
  | undefined;
export declare function getAllBackgroundSlots(): Record<
  string,
  {
    color?: string;
    image?: string;
...
>;
export declare function resolveSpriteSrc(
  name: string,
  variant: string,
): string | undefined;
export declare function shouldFallbackForSprite(
  name: string,
  variant: string,
): boolean;
