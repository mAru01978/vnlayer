...
export declare const positionOverridesAtomFamily: import("jotai-family").AtomFamily<string, import("jotai").PrimitiveAtom<PositionOverrides> & {
    init: PositionOverrides;
}>;
export declare function setPos(atomKey: string, name: string, coords: {
    originX: number;
    originY: number;
