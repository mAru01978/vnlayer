...
export declare const linesAtomFamily: import("jotai-family").AtomFamily<
  string,
  import("jotai").PrimitiveAtom<LineEntry[]> & {
    init: LineEntry[];
  }
>;
export declare function pushLine(
  atomKey: string,
  instanceId: string | undefined,
  speaker: string,
  content: string,
): void;
export declare function pushChoice(
  atomKey: string,
  instanceId: string | undefined,
  number: number,
  text: string,
