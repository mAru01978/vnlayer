(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(exports, require("jotai/vanilla"))
    : typeof define === "function" && define.amd
      ? define(["exports", "jotai/vanilla"], factory)
      : ((global =
          typeof globalThis !== "undefined" ? globalThis : global || self),
        factory((global.jotaiVanillaUtils = {}), global.jotaiVanilla));
})(this, function (exports, vanilla) {
  "use strict";
  ...
  function atomFamily(initializeAtom, areEqual) {
    ...
    var notifyListeners = function notifyListeners(type, param, atom) {
      for (
        var _iterator2 = _createForOfIteratorHelperLoose(listeners), _step2;
    ...
    _createAtom.setShouldRemove = function (fn) {
      ...
      for (
        var _iterator4 = _createForOfIteratorHelperLoose(atoms), _step4;
        ...
        var _getMapping = function getMapping(arr, prev) {
          ...
          arr.forEach(function (item, index) {
            ...
            atomList[index] = isWritable(arrAtom)
              ? vanilla.atom(read, write)
              : vanilla.atom(read);
          });
          if (
            prevMapping &&
            prevMapping.keyList.length === keyList.length &&
            prevMapping.keyList.every(function (x, i) {
              return x === keyList[i];
            })
          ) {
            mapping = prevMapping;
                ...
                switch (action.type) {
                  case "remove": {
                    ...
                    if (index >= 0) {
                      ...
                      set(
                        arrAtom,
                        [].concat(arr.slice(0, index), arr.slice(index + 1)),
                      );
                    }
                    break;
                  }
                  case "insert": {
                    var _index = action.before
                    ...
                    if (index1 >= 0 && index2 >= 0) {
                      ...
                      if (index1 < index2) {
                        set(
                          arrAtom,
                          [].concat(
                            _arr2.slice(0, index1),
                            _arr2.slice(index1 + 1, index2),
                            [_arr2[index1]],
                            _arr2.slice(index2),
                          ),
                        );
                        ...
                        set(
                          arrAtom,
                          [].concat(
                            _arr2.slice(0, index2),
                            [_arr2[index1]],
                            _arr2.slice(index2, index1),
                            _arr2.slice(index1 + 1),
                          ),
                        );
                      }
                    }
  ...
  function createJSONStorage(getStringStorage, options) {
    ...
    var storage = {
      getItem: function getItem(key, initialValue) {
        ...
        var str =
          (_getStringStorage$get =
            (_getStringStorage = getStringStorage()) == null
              ? void 0
              : _getStringStorage.getItem(key)) != null
            ? _getStringStorage$get
            : null;
      ...
      setItem: function setItem(key, newValue) {
        ...
        return (_getStringStorage2 = getStringStorage()) == null
          ? void 0
          : _getStringStorage2.setItem(
              key,
              JSON.stringify(
                newValue,
      ...
      removeItem: function removeItem(key) {
        ...
        return (_getStringStorage3 = getStringStorage()) == null
          ? void 0
          : _getStringStorage3.removeItem(key);
      },
    };
    ...
    try {
      ...
      subscriber =
        (_getStringStorage4 = getStringStorage()) == null
          ? void 0
          : _getStringStorage4.subscribe;
    } catch (_unused3) {}
    if (
      !subscriber &&
  ...
  function atomWithObservable(getObservable, options) {
    ...
    var observableResultAtom = vanilla.atom(function (get) {
      ...
      var subscribable =
        ((_Symbol$observable = (_ref = observable)[Symbol.observable]) == null
          ? void 0
          : _Symbol$observable.call(_ref)) || observable;
      var resolve;
    ...
    var observableAtom = vanilla.atom(
      function (get) {
