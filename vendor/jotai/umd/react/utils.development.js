...
(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    : typeof define === "function" && define.amd
      ...
      : ((global =
        ...
        factory(
          (global.jotaiReactUtils = {}),
          global.React,
          global.jotaiReact,
          global.jotaiVanillaUtils,
          global.jotaiVanilla,
        ));
})(this, function (exports, react$1, react, utils, vanilla) {
  "use strict";

  function useResetAtom(anAtom, options) {
    var setAtom = react.useSetAtom(anAtom, options);
    var resetAtom = react$1.useCallback(
      function () {
  ...
  function useReducerAtom(anAtom, reducer, options) {
    ...
    var _useAtom = react.useAtom(anAtom, options),
      state = _useAtom[0],
      setState = _useAtom[1];
    var dispatch = react$1.useCallback(
      function (action) {
  ...
  function useHydrateAtoms(values, options) {
    ...
    for (
      ...
      if (
        ...
        (options != null && options.dangerouslyForceHydrate)
      ) {
