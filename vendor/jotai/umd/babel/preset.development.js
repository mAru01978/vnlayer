(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? (module.exports = factory(require("@babel/template")))
    : typeof define === "function" && define.amd
      ? define(["@babel/template"], factory)
      : ((global =
          typeof globalThis !== "undefined" ? globalThis : global || self),
        (global.jotaiBabelPreset = factory(global._templateBuilder)));
})(this, function (_templateBuilder) {
  "use strict";
        ...
        ExportDefaultDeclaration: function ExportDefaultDeclaration(
          ...
          if (
            ...
            if (displayName === "index") {
              displayName =
                filename.slice(0, -"/index".length).split("/").pop() ||
                "unknown";
            }
      ...
      visitor: {
        ...
        VariableDeclarator: function VariableDeclarator(nodePath, state) {
          ...
          if (
            ...
            (((_nodePath$parentPath$ = nodePath.parentPath.parentPath) !=
              null &&
              _nodePath$parentPath$.isProgram()) ||
              ((_nodePath$parentPath$2 = nodePath.parentPath.parentPath) !=
                null &&
                _nodePath$parentPath$2.isExportNamedDeclaration()))
          ) {
            var filename = state.filename || "unknown";
            var atomKey = filename + "/" + nodePath.node.id.name;
            var buildAtomDeclaration = templateBuilder(
