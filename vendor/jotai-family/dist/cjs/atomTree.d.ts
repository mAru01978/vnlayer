...
type AtomTree<Path extends readonly unknown[], AtomType extends Atom<unknown>> = {
    (path: Path): AtomType;
 ...
 */
export declare function atomTree<Path extends readonly unknown[], AtomType extends Atom<unknown>>(initializePathAtom: (path: Path) => AtomType): AtomTree<Path, AtomType>;
export {};
