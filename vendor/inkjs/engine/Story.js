...
class Story extends Object_1.InkObject {
  ...
  constructor() {
    ...
    // ------ Story (Container contentContainer, List<Runtime.ListDefinition> lists = null)
    if (lists != null)
      this._listDefinitions = new ListDefinitionsOrigin_1.ListDefinitionsOrigin(
        lists,
      );
    ...
    if (json !== null) {
      ...
      if ((listDefsObj = rootObject["listDefs"])) {
        this._listDefinitions =
          JsonSerialisation_1.JsonSerialisation.JTokenToListDefinitions(
            listDefsObj,
          );
      }
      this._mainContentContainer = (0, TypeAssertion_1.asOrThrows)(
        JsonSerialisation_1.JsonSerialisation.JTokenToRuntimeObject(rootToken),
  ...
  ToJson(writer) {
    ...
    writer.WriteProperty("root", (w) =>
      JsonSerialisation_1.JsonSerialisation.WriteRuntimeContainer(
        w,
    ...
    if (!this.state.inStringEvaluation) {
      if (this._stateSnapshotAtLastNewline !== null) {
        if (this._stateSnapshotAtLastNewline.currentTags === null) {
          return (0, NullException_1.throwNullException)(
            "this._stateAtLastNewline.currentTags",
          );
        }
  ...
  KnotContainerWithName(name) {
    ...
    if (namedContainer instanceof Container_1.Container) return namedContainer;
    else return null;
  }
  PointerAtPath(path) {
  ...
  Step() {
    ...
    let containerToEnter = (0, TypeAssertion_1.asOrNull)(
      pointer.Resolve(),
      Container_1.Container,
    );
    while (containerToEnter) {
      ...
      containerToEnter = (0, TypeAssertion_1.asOrNull)(
        pointer.Resolve(),
        Container_1.Container,
      );
    }
    ...
    let choicePoint = (0, TypeAssertion_1.asOrNull)(
      currentContentObj,
      ChoicePoint_1.ChoicePoint,
    );
    if (choicePoint) {
    ...
    if (shouldAddToStream) {
      ...
      let varPointer = (0, TypeAssertion_1.asOrNull)(
        currentContentObj,
        Value_1.VariablePointerValue,
      );
      if (varPointer && varPointer.contextIndex == -1) {
        ...
        currentContentObj = new Value_1.VariablePointerValue(
          varPointer.variableName,
          contextIdx,
        );
      }
    ...
    let controlCmd = (0, TypeAssertion_1.asOrNull)(
      currentContentObj,
      ControlCommand_1.ControlCommand,
    );
    if (
      controlCmd &&
      controlCmd.commandType ==
        ControlCommand_1.ControlCommand.CommandType.StartThread
    ) {
  ...
  VisitChangedContainersDueToDivert() {
    ...
    if (!previousPointer.isNull) {
      ...
      while (prevAncestor) {
        ...
        prevAncestor = (0, TypeAssertion_1.asOrNull)(
          prevAncestor.parent,
          Container_1.Container,
        );
      }
    ...
    let currentContainerAncestor = (0, TypeAssertion_1.asOrNull)(
    ...
    while (
      ...
      currentContainerAncestor = (0, TypeAssertion_1.asOrNull)(
  ...
  PopChoiceStringAndTags(tags) {
    let choiceOnlyStrVal = (0, TypeAssertion_1.asOrThrows)(
    ...
    while (
      ...
      let tag = (0, TypeAssertion_1.asOrNull)(
        this.state.PopEvaluationStack(),
        Tag_1.Tag,
      );
    ...
    if (contentObj instanceof Divert_1.Divert) {
      ...
      if (currentDivert.hasVariableTarget) {
        ...
        if (varContents == null) {
          ...
          let intContent = (0, TypeAssertion_1.asOrNull)(
            varContents,
            Value_1.IntValue,
          );
          let errorMessage =
        ...
        let target = (0, TypeAssertion_1.asOrThrows)(
          varContents,
          Value_1.DivertTargetValue,
        );
    ...
    // Start/end an expression evaluation? Or print out the result?
      ...
      switch (evalCommand.commandType) {
        ...
        case ControlCommand_1.ControlCommand.CommandType.PopTunnel:
          let popType =
            evalCommand.commandType ==
            ControlCommand_1.ControlCommand.CommandType.PopFunction
          ...
          if (popType == PushPop_1.PushPopType.Tunnel) {
            ...
            overrideTunnelReturnTarget = (0, TypeAssertion_1.asOrNull)(
              popped,
              Value_1.DivertTargetValue,
            );
            if (overrideTunnelReturnTarget === null) {
              this.Assert(
                popped instanceof Void_1.Void,
        ...
        case ControlCommand_1.ControlCommand.CommandType.EndTag: {
          if (this.state.inStringEvaluation) {
            ...
            for (let i = this.state.outputStream.length - 1; i >= 0; --i) {
              ...
              let command = (0, TypeAssertion_1.asOrNull)(
                obj,
                ControlCommand_1.ControlCommand,
              );
              if (command != null) {
                if (
                  command.commandType ==
                  ControlCommand_1.ControlCommand.CommandType.BeginTag
                ) {
                  break;
                } else {
                  this.Error(
        ...
        case ControlCommand_1.ControlCommand.CommandType.EndString: {
          ...
          for (let i = this.state.outputStream.length - 1; i >= 0; --i) {
            ...
            if (
              command &&
              command.commandType ==
                ControlCommand_1.ControlCommand.CommandType.BeginString
            ) {
              break;
            }
          ...
          this.state.PushEvaluationStack(
            new Value_1.StringValue(sb.toString()),
          );
          break;
        }
        ...
        case ControlCommand_1.ControlCommand.CommandType.Turns:
          this.state.PushEvaluationStack(
            new Value_1.IntValue(this.state.currentTurnIndex + 1),
          );
          break;
        ...
        case ControlCommand_1.ControlCommand.CommandType.ReadCount:
          ...
          let divertTarget = (0, TypeAssertion_1.asOrThrows)(
            target,
            Value_1.DivertTargetValue,
          );
          // var container = ContentAtPath (divertTarget.targetPath).correctObj as Container;
          let container = (0, TypeAssertion_1.asOrNull)(
          ...
          if (container != null) {
            if (
              evalCommand.commandType ==
              ControlCommand_1.ControlCommand.CommandType.TurnsSince
            )
        ...
        case ControlCommand_1.ControlCommand.CommandType.Random: {
          let maxInt = (0, TypeAssertion_1.asOrNull)(
            this.state.PopEvaluationStack(),
            Value_1.IntValue,
          );
          let minInt = (0, TypeAssertion_1.asOrNull)(
            this.state.PopEvaluationStack(),
            Value_1.IntValue,
          );
        ...
        case ControlCommand_1.ControlCommand.CommandType.SeedRandom:
          let seed = (0, TypeAssertion_1.asOrNull)(
            this.state.PopEvaluationStack(),
            Value_1.IntValue,
          );
        ...
        case ControlCommand_1.ControlCommand.CommandType.ListFromInt:
          ...
          let intVal = (0, TypeAssertion_1.asOrNull)(
            this.state.PopEvaluationStack(),
            Value_1.IntValue,
          );
          // var listNameVal = state.PopEvaluationStack () as StringValue;
          let listNameVal = (0, TypeAssertion_1.asOrThrows)(
            this.state.PopEvaluationStack(),
            Value_1.StringValue,
          );
          if (intVal === null) {
            throw new StoryException_1.StoryException(
        ...
        case ControlCommand_1.ControlCommand.CommandType.ListRange:
          let max = (0, TypeAssertion_1.asOrNull)(
            this.state.PopEvaluationStack(),
            Value_1.Value,
          );
          let min = (0, TypeAssertion_1.asOrNull)(
            this.state.PopEvaluationStack(),
            Value_1.Value,
          );
          // var targetList = state.PopEvaluationStack () as ListValue;
          let targetList = (0, TypeAssertion_1.asOrNull)(
            this.state.PopEvaluationStack(),
            Value_1.ListValue,
          );
  ...
  ChoosePathString(path, resetCallstack = true, args = []) {
    ...
    if (resetCallstack) {
      ...
      if (
        this.state.callStack.currentElement.type ==
        PushPop_1.PushPopType.Function
      ) {
        let funcDetail = "";
        let container =
  ...
  ChooseChoiceIndex(choiceIdx) {
    ...
    if (choiceToChoose.threadAtGeneration === null) {
      return (0, NullException_1.throwNullException)(
        "choiceToChoose.threadAtGeneration",
      );
    }
    if (choiceToChoose.targetPath === null) {
      return (0, NullException_1.throwNullException)(
        "choiceToChoose.targetPath",
      );
    }
  ...
  CallExternalFunction(funcName, numberOfArguments) {
    ...
    if (!foundExternal) {
      if (this.allowExternalFunctionFallbacks) {
        ...
        this.state.divertedPointer = Pointer_1.Pointer.StartOf(
    ...
    for (let i = 0; i < numberOfArguments; ++i) {
      ...
      let poppedObj = (0, TypeAssertion_1.asOrThrows)(
        this.state.PopEvaluationStack(),
        Value_1.Value,
      );
  ...
  ValidateExternalBindings() {
    ...
    if (c === null && o === null) {
      ...
      for (let [, value] of c.namedContent) {
        this.ValidateExternalBindings(
          (0, TypeAssertion_1.asOrNull)(value, Object_1.InkObject),
          missingExternals,
        );
      }
    } else if (o != null) {
    ...
    for (let c of flowContainer.content) {
      ...
      if (command != null) {
        if (
          ...
          command.commandType ==
          ControlCommand_1.ControlCommand.CommandType.EndTag
        ) {
          inTag = false;
        }
      } else if (inTag) {
  ...
  IncrementContentPointer() {
    ...
    while (pointer.index >= pointer.container.content.length) {
      ...
      let nextAncestor = (0, TypeAssertion_1.asOrNull)(
  ...
  NextSequenceShuffleIndex() {
    ...
    let numElementsIntVal = (0, TypeAssertion_1.asOrNull)(
      this.state.PopEvaluationStack(),
      Value_1.IntValue,
    );
    ...
    let seqCountVal = (0, TypeAssertion_1.asOrThrows)(
      this.state.PopEvaluationStack(),
      Value_1.IntValue,
    );
...
(function (Story) {
  ...
  (function (OutputStateChange) {
    ...
    OutputStateChange[(OutputStateChange["ExtendedBeyondNewline"] = 1)] =
      "ExtendedBeyondNewline";
    OutputStateChange[(OutputStateChange["NewlineRemoved"] = 2)] =
      "NewlineRemoved";
  })(
    (OutputStateChange =
