...
class StoryState {
  ...
  VisitCountAtPathString(pathString) {
    let visitCountOut;
    if (this._patch !== null) {
      let container = this.story.ContentAtPath(
        new Path_1.Path(pathString),
      ).container;
      if (container === null)
    ...
    visitCountOut = (0, TryGetResult_1.tryGetValueFromMap)(
      this._visitCounts,
      pathString,
      null,
    );
  ...
  VisitCountForContainer(container) {
    ...
    let count2 = (0, TryGetResult_1.tryGetValueFromMap)(
      this._visitCounts,
      containerPathStr,
      null,
    );
  ...
  IncrementVisitCountForContainer(container) {
    ...
    let containerPathStr = container.path.toString();
    let count = (0, TryGetResult_1.tryGetValueFromMap)(
      this._visitCounts,
      containerPathStr,
      null,
    );
  ...
  TurnsSinceForContainer(container) {
    ...
    let containerPathStr = container.path.toString();
    let index2 = (0, TryGetResult_1.tryGetValueFromMap)(
      this._turnIndices,
      containerPathStr,
      0,
    );
  ...
  get currentText() {
    if (this._outputStreamTextDirty) {
      ...
      for (let outputObj of this.outputStream) {
        ...
        let textContent = (0, TypeAssertion_1.asOrNull)(
          outputObj,
          Value_1.StringValue,
        );
        if (!inTag && textContent !== null) {
          ...
          let controlCommand = (0, TypeAssertion_1.asOrNull)(
            outputObj,
    ...
    if (this._outputStreamTagsDirty) {
      ...
      for (let outputObj of this.outputStream) {
        ...
        if (controlCommand != null) {
          ...
          let strVal = (0, TypeAssertion_1.asOrNull)(
            outputObj,
            Value_1.StringValue,
          );
          if (strVal !== null) {
  ...
  constructor(story) {
    ...
    this._variablesState = new VariablesState_1.VariablesState(
      this.callStack,
  ...
  GoToStart() {
    this.callStack.currentElement.currentPointer = Pointer_1.Pointer.StartOf(
  ...
  SwitchFlow_Internal(flowName) {
    ...
    let flow;
    let content = (0, TryGetResult_1.tryGetValueFromMap)(
      this._namedFlows,
      flowName,
      null,
    );
  ...
  CopyAndStartPatching(forBackgroundSave) {
    ...
    copy._currentFlow.callStack = new CallStack_1.CallStack(
  ...
  WriteJson(writer) {
    ...
    writer.WriteProperty("evalStack", (w) =>
      JsonSerialisation_1.JsonSerialisation.WriteListRuntimeObjs(
        w,
    ...
    writer.WriteProperty("visitCounts", (w) =>
      JsonSerialisation_1.JsonSerialisation.WriteIntDictionary(
        w,
        this._visitCounts,
      ),
    );
    ...
    writer.WriteIntProperty(
      "inkFormatVersion",
      Story_1.Story.inkVersionCurrent,
    );
    writer.WriteObjectEnd();
  }
  LoadJsonObj(value) {
    ...
    if (flowsObj != null) {
      ...
      this._currentFlow.callStack.SetJsonToken(
        jObject["callstackThreads"],
        this.story,
      );
      this._currentFlow.outputStream =
        JsonSerialisation_1.JsonSerialisation.JArrayToRuntimeObjList(
    ...
    this._visitCounts =
      JsonSerialisation_1.JsonSerialisation.JObjectToIntDictionary(
        jObject["visitCounts"],
      );
    this._turnIndices =
      JsonSerialisation_1.JsonSerialisation.JObjectToIntDictionary(
  ...
  TrySplittingHeadTailWhitespace(single) {
    ...
    if (headFirstNewlineIdx != -1) {
      if (headFirstNewlineIdx > 0) {
        let leadingSpaces = new Value_1.StringValue(
    ...
    if (tailLastNewlineIdx != -1 && tailFirstNewlineIdx > headLastNewlineIdx) {
      ...
      if (tailLastNewlineIdx < str.length - 1) {
        ...
        let trailingSpaces = new Value_1.StringValue(
          str.substring(
  ...
  TrimNewlinesFromOutputStream() {
    ...
    while (i >= 0) {
      ...
      let cmd = (0, TypeAssertion_1.asOrNull)(
        obj,
        ControlCommand_1.ControlCommand,
      );
    ...
    if (removeWhitespaceFrom >= 0) {
      ...
      while (i < this.outputStream.length) {
        let text = (0, TypeAssertion_1.asOrNull)(
          this.outputStream[i],
          Value_1.StringValue,
        );
        if (text) {
  ...
  get inStringEvaluation() {
    for (let i = this.outputStream.length - 1; i >= 0; i--) {
      ...
      if (
        cmd instanceof ControlCommand_1.ControlCommand &&
        cmd.commandType ==
          ControlCommand_1.ControlCommand.CommandType.BeginString
      ) {
        return true;
        ...
        for (let n of rawList.originNames) {
          if (this.story.listDefinitions === null)
            return (0, NullException_1.throwNullException)(
              "StoryState.story.listDefinitions",
            );
          let def = this.story.listDefinitions.TryListGetDefinition(n, null);
          if (def.result === null)
            return (0, NullException_1.throwNullException)(
              "StoryState def.result",
            );
  ...
  TrimWhitespaceFromFunctionEnd() {
    Debug_1.Debug.Assert(
      this.callStack.currentElement.type == PushPop_1.PushPopType.Function,
    );
  ...
  CompleteFunctionEvaluationFromGame() {
    ...
    if (returnedObj) {
      ...
      let returnVal = (0, TypeAssertion_1.asOrThrows)(
        returnedObj,
        Value_1.Value,
      );
