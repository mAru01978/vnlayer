    ...
    if (this._targetPointer.isNull) {
      ...
      if (this._targetPath.lastComponent === null)
        return (0, NullException_1.throwNullException)(
          "this._targetPath.lastComponent",
        );
      if (this._targetPath.lastComponent.isIndex) {
        if (targetObj === null)
          return (0, NullException_1.throwNullException)("targetObj");
        this._targetPointer.container =
          targetObj.parent instanceof Container_1.Container
            ? targetObj.parent
            : null;
        this._targetPointer.index = this._targetPath.lastComponent.index;
      } else {
        this._targetPointer = Pointer_1.Pointer.StartOf(
          targetObj instanceof Container_1.Container ? targetObj : null,
        );
      }
    }
