...
class JsonSerialisation {
  ...
  static WriteRuntimeObject(writer, obj) {
    ...
    let divTargetVal = (0, TypeAssertion_1.asOrNull)(
      obj,
    ...
    let varPtrVal = (0, TypeAssertion_1.asOrNull)(
      obj,
    ...
    let nativeFunc = (0, TypeAssertion_1.asOrNull)(
      obj,
      NativeFunctionCall_1.NativeFunctionCall,
    );
    if (nativeFunc) {
    ...
    let varRef = (0, TypeAssertion_1.asOrNull)(
      obj,
      VariableReference_1.VariableReference,
    );
    if (varRef) {
      writer.WriteObjectStart();
    ...
    let varAss = (0, TypeAssertion_1.asOrNull)(
      obj,
      VariableAssignment_1.VariableAssignment,
    );
    if (varAss) {
      writer.WriteObjectStart();
  ...
  static JTokenToRuntimeObject(token) {
    ...
    if (typeof token === "string") {
      ...
      // String value
      let firstChar = str[0];
      if (firstChar == "^") return new Value_1.StringValue(str.substring(1));
      else if (firstChar == "\n" && str.length == 1)
      ...
      // Pop
      if (str == "->->") return ControlCommand_1.ControlCommand.PopTunnel();
      else if (str == "~ret")
    ...
    if (typeof token === "object" && !Array.isArray(token)) {
      ...
      if (obj["^->"]) {
        propValue = obj["^->"];
        return new Value_1.DivertTargetValue(
          new Path_1.Path(propValue.toString()),
        );
      }
      ...
      if (isVarAss) {
        ...
        let varAss = new VariableAssignment_1.VariableAssignment(
          varName,
          isNewDecl,
        );
  ...
  static WriteRuntimeContainer(writer, container, withoutName = false) {
    ...
    if (namedOnlyContent != null) {
      for (let [key, value] of namedOnlyContent) {
        let name = key;
        let namedContainer = (0, TypeAssertion_1.asOrNull)(
          value,
    ...
    if (terminatingObj != null) {
      ...
      for (let key in terminatingObj) {
        if (key == "#f") {
          ...
          let namedSubContainer = (0, TypeAssertion_1.asOrNull)(
            namedContentItem,
            Container_1.Container,
          );
...
JsonSerialisation._controlCommandNames = (() => {
  ...
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.EvalStart] =
    "ev";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.EvalOutput] =
    "out";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.EvalEnd] =
    "/ev";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.Duplicate] =
    "du";
  _controlCommandNames[
    ControlCommand_1.ControlCommand.CommandType.PopEvaluatedValue
  ] = "pop";
  _controlCommandNames[
  ...
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.EndString] =
    "/str";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.NoOp] =
    "nop";
  _controlCommandNames[
    ControlCommand_1.ControlCommand.CommandType.ChoiceCount
  ] = "choiceCnt";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.Turns] =
    "turn";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.TurnsSince] =
    "turns";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.ReadCount] =
    "readc";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.Random] =
    "rnd";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.SeedRandom] =
    "srnd";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.VisitIndex] =
    "visit";
  _controlCommandNames[
    ControlCommand_1.ControlCommand.CommandType.SequenceShuffleIndex
  ] = "seq";
  _controlCommandNames[
    ControlCommand_1.ControlCommand.CommandType.StartThread
  ] = "thread";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.Done] =
    "done";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.End] = "end";
  _controlCommandNames[
    ControlCommand_1.ControlCommand.CommandType.ListFromInt
  ] = "listInt";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.ListRange] =
    "range";
  _controlCommandNames[ControlCommand_1.ControlCommand.CommandType.ListRandom] =
    "lrnd";
  ...
  for (
    let i = 0;
    i < ControlCommand_1.ControlCommand.CommandType.TOTAL_VALUES;
    ++i
  ) {
