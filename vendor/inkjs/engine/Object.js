...
class InkObject {
      ...
      if (this.parent == null) {
        ...
        while (container !== null) {
          ...
          if (namedChild != null && namedChild.hasValidName) {
            ...
            comps.unshift(
              new Path_1.Path.Component(container.content.indexOf(child)),
            );
          }
          child = container;
          container = (0, TypeAssertion_1.asOrNull)(
            container.parent,
            Container_1.Container,
          );
        }
  ...
  ResolvePath(path) {
    ...
    if (path.isRelative) {
      let nearestContainer = (0, TypeAssertion_1.asOrNull)(
        this,
        Container_1.Container,
      );
      if (nearestContainer === null) {
        ...
        nearestContainer = (0, TypeAssertion_1.asOrNull)(
          this.parent,
          Container_1.Container,
        );
        Debug_1.Debug.Assert(
