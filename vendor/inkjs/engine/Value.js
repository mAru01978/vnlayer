...
exports.ValueType =
  exports.ListValue =
  exports.VariablePointerValue =
  exports.DivertTargetValue =
  exports.StringValue =
  exports.FloatValue =
  exports.IntValue =
  exports.BoolValue =
  exports.Value =
  exports.AbstractValue =
    void 0;
...
class AbstractValue extends Object_1.InkObject {
  static Create(val, preferredNumberType) {
    ...
    if (preferredNumberType) {
      if (
        preferredNumberType === ValueType.Int &&
    ...
    if (typeof val === "string") {
      ...
      return new DivertTargetValue(
        (0, TypeAssertion_1.asOrThrows)(val, Path_1.Path),
      );
    } else if (val instanceof InkList_1.InkList) {
      return new ListValue(
        (0, TypeAssertion_1.asOrThrows)(val, InkList_1.InkList),
      );
    }
    return null;
  }
  Copy() {
    return (0, TypeAssertion_1.asOrThrows)(
      AbstractValue.Create(this.valueObject),
      Object_1.InkObject,
    );
  }
  BadCastException(targetType) {
    return new StoryException_1.StoryException(
      "Can't cast " +
        this.valueObject +
        " from " +
        this.valueType +
...
class ListValue extends Value {
  ...
  constructor(listOrSingleItem, singleValue) {
    ...
    if (!listOrSingleItem && !singleValue) {
      ...
      listOrSingleItem instanceof InkList_1.InkListItem &&
