...
class VariablesState extends VariablesStateAccessor() {
  ...
  $(variableName, value) {
    if (typeof value === "undefined") {
      ...
      if (typeof varContents !== "undefined") return varContents.valueObject;
      else return null;
    } else {
  ...
  SetJsonToken(jToken) {
    ...
    for (let [varValKey, varValValue] of this._defaultGlobalVariables) {
      ...
      if (typeof loadedToken !== "undefined") {
        let tokenInkObject =
          JsonSerialisation_1.JsonSerialisation.JTokenToRuntimeObject(
            loadedToken,
          );
  ...
  RuntimeObjectsEqual(obj1, obj2) {
    ...
    if (boolVal !== null) {
      return (
        boolVal.value ===
        (0, TypeAssertion_1.asOrThrows)(obj2, Value_1.BoolValue).value
      );
    }
    ...
    if (intVal !== null) {
      return (
        intVal.value ===
        (0, TypeAssertion_1.asOrThrows)(obj2, Value_1.IntValue).value
      );
    }
    ...
    if (floatVal !== null) {
      return (
        floatVal.value ===
        (0, TypeAssertion_1.asOrThrows)(obj2, Value_1.FloatValue).value
      );
    }
    ...
    if (val1 !== null && val2 !== null) {
      if (
        (0, TypeAssertion_1.isEquatable)(val1.valueObject) &&
        (0, TypeAssertion_1.isEquatable)(val2.valueObject)
      ) {
  ...
  TryGetDefaultVariableValue(name) {
    let val = (0, TryGetResult_1.tryGetValueFromMap)(
  ...
  GetRawVariableWithName(name, contextIndex) {
    ...
    if (contextIndex == 0 || contextIndex == -1) {
      ...
      variableValue = (0, TryGetResult_1.tryGetValueFromMap)(
      ...
      if (this._listDefsOrigin === null)
        return (0, NullException_1.throwNullException)(
          "VariablesState._listDefsOrigin",
        );
  ...
  Assign(varAss, value) {
    ...
    if (varAss.isNewDeclaration) {
      ...
      do {
        ...
        existingPointer = (0, TypeAssertion_1.asOrNull)(
  ...
  SetGlobal(variableName, value) {
    let oldValue = null;
    if (this.patch === null) {
      oldValue = (0, TryGetResult_1.tryGetValueFromMap)(
        this._globalVariables,
        variableName,
        null,
      );
    ...
    if (
      ...
      if (this._batchObservingVariableChanges) {
        if (this._changedVariablesForBatchObs === null) {
          return (0, NullException_1.throwNullException)(
            "this._changedVariablesForBatchObs",
          );
        }
        if (this.patch !== null) {
  ...
  ResolveVariablePointer(varPointer) {
    ...
    let doubleRedirectionPointer = (0, TypeAssertion_1.asOrNull)(
    ...
    if (doubleRedirectionPointer != null) {
      ...
      return new Value_1.VariablePointerValue(
        varPointer.variableName,
        contextIndex,
      );
    }
