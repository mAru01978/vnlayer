...
class CallStack {
  ...
  constructor() {
    ...
    if (arguments[0] instanceof Story_1.Story) {
      ...
      this._startOfRoot = Pointer_1.Pointer.StartOf(
        storyContext.rootContentContainer,
      );
      this.Reset();
    } else {
  ...
  Reset() {
    ...
    this._threads[0].callstack.push(
      new CallStack.Element(PushPop_1.PushPopType.Tunnel, this._startOfRoot),
    );
  }
  ...
  GetTemporaryVariableWithName(name, contextIndex = -1) {
    ...
    let varValue = (0, TryGetResult_1.tryGetValueFromMap)(
  ...
  SetTemporaryVariable(name, value, declareNew, contextIndex = -1) {
    ...
    let oldValue = (0, TryGetResult_1.tryGetValueFromMap)(
      contextElement.temporaryVariables,
      name,
      null,
    );
        ...
        for (let jElTok of jThreadCallstack) {
          ...
          if (typeof currentContainerPathStrToken !== "undefined") {
            ...
            let threadPointerResult = storyContext.ContentAtPath(
              new Path_1.Path(currentContainerPathStr),
            );
          ...
          if (typeof temps !== "undefined") {
            el.temporaryVariables =
              JsonSerialisation_1.JsonSerialisation.JObjectToDictionaryRuntimeObjs(
                temps,
              );
          } else {
    ...
    WriteJson(writer) {
      ...
      for (let el of this.callstack) {
        ...
        if (el.temporaryVariables.size > 0) {
          ...
          JsonSerialisation_1.JsonSerialisation.WriteDictionaryRuntimeObjs(
            writer,
            el.temporaryVariables,
          );
          writer.WritePropertyEnd();
