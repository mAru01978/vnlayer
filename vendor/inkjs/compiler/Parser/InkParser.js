...
class InkParser extends StringParser_1.StringParser {
  ...
  constructor(
    ...
    this.ParseStory = () => {
      const topLevelContent = this.StatementsAtLevel(
        StatementLevel_1.StatementLevel.Top,
      );
    ...
    this.CreateDebugMetadata = (stateAtStart, stateAtEnd) => {
      ...
      md.startLineNumber =
        ((stateAtStart === null || stateAtStart === void 0
          ? void 0
          : stateAtStart.lineIndex) || 0) + 1;
      md.endLineNumber = stateAtEnd.lineIndex + 1;
      md.startCharacterNumber =
        ((stateAtStart === null || stateAtStart === void 0
          ? void 0
          : stateAtStart.characterInLineIndex) || 0) + 1;
    ...
    this.RuleDidSucceed = (result, stateAtStart, stateAtEnd) => {
      ...
      const parsedObj = (0, TypeAssertion_1.asOrNull)(
        result,
        Object_1.ParsedObject,
      );
      if (parsedObj) {
      ...
      if (parsedListObjs !== null) {
        for (const parsedListObj of parsedListObjs) {
          const singleObj = (0, TypeAssertion_1.asOrNull)(
            parsedListObj,
            Object_1.ParsedObject,
          );
    ...
    this.OnStringParserError = (
      ...
      if (this._externalErrorHandler !== null) {
        this._externalErrorHandler(
          fullMessage,
          isWarning
            ? ErrorType_1.ErrorType.Warning
            : ErrorType_1.ErrorType.Error,
        );
      } else {
    ...
    this.Choice = () => {
      ...
      if (hasWeaveStyleInlineBrackets) {
        ...
        if (optionOnlyTextAndLogic !== null) {
          optionOnlyContent = new ContentList_1.ContentList(
            optionOnlyTextAndLogic,
          );
        }
      ...
      this.EndTagIfNecessary(
        innerContent !== null && innerContent !== void 0
          ? innerContent
          : startContent,
      );
      ...
      const choice = new Choice_1.Choice(
        startContent,
        optionOnlyContent,
        innerContent,
      );
    ...
    this.ChoiceCondition = () => {
      ...
      return new MultipleConditionExpression_1.MultipleConditionExpression(
        conditions,
      );
    };
    this.ChoiceConditionsSpace = () => {
    ...
    this.InnerConditionalContent = (initialQueryExpression) => {
      ...
      if (isInline) {
        ...
        if (alternatives === null) {
          ...
          if (initialQueryExpression) {
            let soleContent = this.StatementsAtLevel(
              StatementLevel_1.StatementLevel.InnerBlock,
            );
            if (soleContent !== null) {
              const soleBranch =
                new ConditionalSingleBranch_1.ConditionalSingleBranch(
                  soleContent,
                );
          ...
          const emptyTrueBranch =
            new ConditionalSingleBranch_1.ConditionalSingleBranch(null);
      ...
      const cond = new Conditional_1.Conditional(
        initialQueryExpression,
        alternatives,
      );
      return cond;
    ...
    this.InlineConditionalBranches = () => {
      ...
      if (listOfLists.length > 2) {
        ...
        const trueBranch =
          new ConditionalSingleBranch_1.ConditionalSingleBranch(listOfLists[0]);
    ...
    this.SingleMultilineCondition = () => {
      ...
      // }
      this.MultilineWhitespace();
      const branch = new ConditionalSingleBranch_1.ConditionalSingleBranch(
        content,
      );
    ...
    this.ContentTextNoEscape = () => {
      ...
      if (this._nonTextEndCharacters === null) {
        ...
        this._notTextEndCharactersChoice = new CharacterSet_1.CharacterSet(
          this._nonTextEndCharacters,
        );
        this._notTextEndCharactersChoice.AddCharacters("[]");
        this._notTextEndCharactersString = new CharacterSet_1.CharacterSet(
          this._nonTextEndCharacters,
        );
        ...
        if (isArrow) {
          ...
          if (arrowsAndDiverts[ii] === "->->") {
            ...
            if (ii < arrowsAndDiverts.length - 1) {
              const tunnelOnwardDivert = (0, TypeAssertion_1.asOrNull)(
    ...
    this.DivertIdentifierWithArguments = () => {
      this.Whitespace();
      const targetComponents = this.Parse(
    ...
    this.TempDeclarationOrAssignment = () => {
      ...
      if (isIncrement || isDecrement) {
        const result = new IncDecExpression_1.IncDecExpression(
          varIdentifier,
          assignedExpression,
          isIncrement,
        );
    ...
    this.ExpressionUnary = () => {
      ...
      if (postfixOp !== null) {
        ...
        if (!(expr instanceof VariableReference_1.VariableReference)) {
          ...
          const varRef = expr;
          expr = new IncDecExpression_1.IncDecExpression(
            varRef.identifier,
            isInc,
          );
        }
    ...
    this.ExpressionInfixRight = (left, op) => {
      ...
      if (right) {
        ...
        const expr = new BinaryExpression_1.BinaryExpression(
          left,
          right,
          op.type,
        );
    ...
    this.RegisterBinaryOperator = (
      op,
      precedence,
      requireWhitespace = false,
    ) => {
      const infix = new InfixOperator_1.InfixOperator(
        op,
        precedence,
        requireWhitespace,
      );
    ...
    this.FilenameIsAlreadyOpen = (fullFilename) =>
    ...
    this.KnotDefinition = () => {
      ...
      const innerKnotStatements = () =>
        this.StatementsAtLevel(StatementLevel_1.StatementLevel.Knot);
      const content = this.Expect(
        innerKnotStatements,
        "at least one line within the knot",
        this.KnotStitchNoContentRecoveryRule,
      );
      return new Knot_1.Knot(
        knotDecl.name,
        content,
        knotDecl.args,
        knotDecl.isFunction,
    ...
    this.StitchDefinition = () => {
      ...
      const innerStitchStatements = () =>
        this.StatementsAtLevel(StatementLevel_1.StatementLevel.Stitch);
      const content = this.Expect(
        innerStitchStatements,
        "at least one line within the stitch",
        this.KnotStitchNoContentRecoveryRule,
      );
      return new Stitch_1.Stitch(
        decl.name,
        content,
        decl.args,
        decl.isFunction,
    ...
    this.KnotStitchNoContentRecoveryRule = () => {
      ...
      this.ParseUntil(
        this.KnotDeclaration,
        new CharacterSet_1.CharacterSet("="),
        null,
      );
    ...
    this.ExternalDeclaration = () => {
      ...
      this.Whitespace();
      const funcIdentifier =
        this.Expect(this.IdentifierWithMetadata, "name of external function") ||
        new Identifier_1.Identifier("");
      this.Whitespace();
      ...
      const argNames = parameterNames
        .map((arg) => {
          var _a;
          return (_a = arg.identifier) === null || _a === void 0
            ? void 0
            : _a.name;
        })
        .filter(TypeAssertion_1.filterUndef);
      return new ExternalDeclaration_1.ExternalDeclaration(
        funcIdentifier,
        argNames,
      );
    };
    ...
    this.LogicLine = () => {
      ...
      if (
        result instanceof Expression_1.Expression &&
        !(
          result instanceof FunctionCall_1.FunctionCall ||
          result instanceof IncDecExpression_1.IncDecExpression
        )
      ) {
        this.Error(
      ...
      const funCall = (0, TypeAssertion_1.asOrNull)(
        result,
        FunctionCall_1.FunctionCall,
      );
      if (funCall) {
    ...
    this.VariableDeclaration = () => {
      ...
      if (expr) {
        const check =
          expr instanceof NumberExpression_1.NumberExpression ||
    ...
    this.ListElementDefinition = () => {
      ...
      return new ListElementDefinition_1.ListElementDefinition(
        name,
        inInitialList,
        elementValue,
      );
    ...
    this.ConstDeclaration = () => {
      ...
      const result = new ConstantDeclaration_1.ConstantDeclaration(
        varName,
        expr,
      );
      return result;
    ...
    this.InlineLogic = () => {
      ...
      let contentList = (0, TypeAssertion_1.asOrNull)(
        logic,
    ...
    this.SequenceTypeAnnotation = () => {
      ...
      switch (annotation) {
        ...
        case SequenceType_1.SequenceType.Shuffle |
          SequenceType_1.SequenceType.Stopping:
        // eslint-disable-next-line @typescript-eslint/no-unsafe-enum-comparison
        case SequenceType_1.SequenceType.Shuffle |
          SequenceType_1.SequenceType.Once:
          break;
        default:
    ...
    this.SingleMultilineSequenceElement = () => {
      ...
      this.Whitespace();
      const content = this.StatementsAtLevel(
        StatementLevel_1.StatementLevel.InnerBlock,
      );
      if (content === null) {
        this.MultilineWhitespace();
 ...
 */
InkParser.LatinBasic = CharacterRange_1.CharacterRange.Define(
  "\u0041",
  "\u007A",
  new CharacterSet_1.CharacterSet().AddRange("\u005B", "\u0060"),
);
InkParser.LatinExtendedA = CharacterRange_1.CharacterRange.Define(
  "\u0100",
  "\u017F",
  // no excludes here
);
InkParser.LatinExtendedB = CharacterRange_1.CharacterRange.Define(
  "\u0180",
  "\u024F",
  // no excludes here
);
InkParser.Greek = CharacterRange_1.CharacterRange.Define(
  "\u0370",
  "\u03FF",
  new CharacterSet_1.CharacterSet()
    .AddRange("\u0378", "\u0385")
...
InkParser.Cyrillic = CharacterRange_1.CharacterRange.Define(
  "\u0400",
  "\u04FF",
  new CharacterSet_1.CharacterSet().AddRange("\u0482", "\u0489"),
);
InkParser.Armenian = CharacterRange_1.CharacterRange.Define(
  "\u0530",
  "\u058F",
  new CharacterSet_1.CharacterSet()
    .AddCharacters("\u0530")
...
InkParser.Hebrew = CharacterRange_1.CharacterRange.Define(
  "\u0590",
  "\u05FF",
  new CharacterSet_1.CharacterSet(),
);
InkParser.Arabic = CharacterRange_1.CharacterRange.Define(
  "\u0600",
  "\u06FF",
  new CharacterSet_1.CharacterSet(),
);
InkParser.Korean = CharacterRange_1.CharacterRange.Define(
  "\uAC00",
  "\uD7AF",
  new CharacterSet_1.CharacterSet(),
);
InkParser.Latin1Supplement = CharacterRange_1.CharacterRange.Define(
  "\u0080",
  "\u00FF",
  new CharacterSet_1.CharacterSet(),
);
InkParser.Chinese = CharacterRange_1.CharacterRange.Define(
  "\u4E00",
  "\u9FFF",
  new CharacterSet_1.CharacterSet(),
);
