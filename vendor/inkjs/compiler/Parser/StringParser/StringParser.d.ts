...
export type ParseRuleReturn =
  object | string | null | number | (typeof StringParser)["ParseSuccess"];
...
export declare class StringParser {
  ...
  readonly ErrorWithParsedObject: (
    message: string,
    result: ParsedObject,
    isWarning?: boolean,
  ) => void;
  readonly ErrorOnLine: (
    message: string,
    lineNumber: number,
    isWarning: boolean,
  ) => void;
  ...
  readonly Parse: <T extends ParseRule>(
  ...
  readonly ParseUntilCharactersFromString: (
    str: string,
    maxCount?: number,
  ) => string | null;
  readonly ParseUntilCharactersFromCharSet: (
    charSet: CharacterSet,
    maxCount?: number,
  ) => string | null;
  readonly ParseCharactersFromString: (
    str: string,
    maxCountOrShouldIncludeStrChars?: boolean | number,
    maxCount?: number,
  ) => string | null;
  readonly ParseCharactersFromCharSet: (
    charSet: CharacterSet,
    shouldIncludeChars?: boolean,
    maxCount?: number,
  ) => string | null;
