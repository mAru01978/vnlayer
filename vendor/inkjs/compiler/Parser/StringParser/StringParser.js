...
class StringParser {
  constructor(str) {
    ...
    this.ParseUntilCharactersFromString = (str, maxCount = -1) =>
      this.ParseCharactersFromString(str, false, maxCount);
    this.ParseUntilCharactersFromCharSet = (charSet, maxCount = -1) =>
      this.ParseCharactersFromCharSet(charSet, false, maxCount);
    this.ParseCharactersFromString = (
      str,
      maxCountOrShouldIncludeStrChars = -1,
      maxCount = -1,
    ) => {
...
StringParser.numbersCharacterSet = new CharacterSet_1.CharacterSet(
  "0123456789",
);
