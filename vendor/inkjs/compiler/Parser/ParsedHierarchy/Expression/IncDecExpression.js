...
class IncDecExpression extends Expression_1.Expression {
  constructor(varIdentifier, isIncOrExpression, isInc) {
    ...
    this.GenerateIntoContainer = (container) => {
      ...
      container.AddContent(
        new VariableReference_1.VariableReference(
          ((_a = this.varIdentifier) === null || _a === void 0
            ? void 0
            : _a.name) || null,
        ),
      );
      ...
      // 4.
      this._runtimeAssignment = new VariableAssignment_1.VariableAssignment(
        ((_b = this.varIdentifier) === null || _b === void 0
          ? void 0
          : _b.name) || null,
        false,
      );
    ...
    this.toString = () => {
      ...
      return (
        `${(_b = this.varIdentifier) === null || _b === void 0 ? void 0 : _b.name}` +
        (this.isInc ? "++" : "--")
      );
    };
  ...
  ResolveReferences(context) {
    ...
    if (
      !(this.parent instanceof Weave_1.Weave) &&
