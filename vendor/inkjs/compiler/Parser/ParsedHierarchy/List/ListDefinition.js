...
class ListDefinition extends Object_1.ParsedObject {
  ...
  get runtimeListDefinition() {
    ...
    return new ListDefinition_1.ListDefinition(
    ...
    this.GenerateRuntimeObject = () => {
      ...
      for (const itemDef of this.itemDefinitions) {
        if (itemDef.inInitialList) {
          const item = new InkList_2.InkListItem(
            ((_a = this.identifier) === null || _a === void 0
              ? void 0
              : _a.name) || null,
            itemDef.name || null,
          );
      ...
      // Set origin name, so
      initialValues.SetInitialOriginName(
        ((_b = this.identifier) === null || _b === void 0 ? void 0 : _b.name) ||
          "",
      );
