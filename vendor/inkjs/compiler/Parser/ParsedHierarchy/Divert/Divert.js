...
class Divert extends Object_1.ParsedObject {
  ...
  constructor(target, args) {
        ...
        if (requiresArgCodeGen) {
          ...
          for (let ii = 0; ii < this.args.length; ++ii) {
            ...
            if (argExpected && argExpected.isByReference) {
              const varRef = (0, TypeAssertion_1.asOrNull)(
                argToPass,
    ...
    this.ResolveTargetContent = () => {
      ...
      if (this.targetContent === null) {
        ...
        if (variableTargetName !== null) {
          const flowBaseScope = (0, TypeAssertion_1.asOrNull)(
            (0, ClosestFlowBase_1.ClosestFlowBase)(this),
            FlowBase_1.FlowBase,
          );
          if (flowBaseScope) {
            ...
            if (resolveResult.found) {
              ...
              if (
                ...
                let argument = resolveResult.ownerFlow.args.find((a) => {
                  var _a;
                  return (
                    ((_a = a.identifier) === null || _a === void 0
                      ? void 0
                      : _a.name) == variableTargetName
                  );
                });
    ...
    this.CheckArgumentValidity = () => {
      ...
      const targetFlow = (0, TypeAssertion_1.asOrNull)(
        this.targetContent,
        FlowBase_1.FlowBase,
      );
      // No error, crikey!
      ...
      for (let ii = 0; ii < paramCount; ++ii) {
        ...
        if (flowArg.isDivertTarget) {
          ...
          if (
            !(divArgExpr instanceof DivertTarget_1.DivertTarget) &&
            varRef === null
          ) {
            this.Error(
  ...
  ResolveReferences(context) {
    ...
    let targetFlow = (0, TypeAssertion_1.asOrNull)(
      this.targetContent,
      FlowBase_1.FlowBase,
    );
    if (targetFlow) {
    ...
    if (!this.target) {
      ...
      isBuiltIn = FunctionCall_1.FunctionCall.IsBuiltIn(
      ...
      if (isBuiltIn || isExternal) {
        ...
        if (isExternal) {
          ...
          this.runtimeDivert.targetPath = new Path_2.Path(
            this.target.firstComponent,
          );
          this.CheckExternalArgumentValidity(context);
        }
