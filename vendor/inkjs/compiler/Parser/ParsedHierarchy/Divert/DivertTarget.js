...
class DivertTarget extends Expression_1.Expression {
  ...
  constructor(divert) {
    ...
    this.Equals = (obj) => {
      ...
      const otherTargetStr =
        otherDivTarget.divert.target.dotSeparatedComponents;
  ...
  ResolveReferences(context) {
      ...
      if (usageParent instanceof BinaryExpression_1.BinaryExpression) {
        ...
        if (
          ...
          if (!(
            ...
            binaryExprParent.leftExpression instanceof
        ...
        usageParent instanceof
        MultipleConditionExpression_1.MultipleConditionExpression
      ) {
        badUsage = true;
        foundUsage = true;
      } else if (
        usageParent instanceof Choice_1.Choice &&
        usageParent.condition === usageContext
      ) {
        badUsage = true;
        foundUsage = true;
      } else if (
        usageParent instanceof Conditional_1.Conditional ||
    ...
    if (targetContent !== null) {
      ...
      if (target !== null) {
        ...
        const parentFunc = (0, TypeAssertion_1.asOrNull)(
          this.parent,
