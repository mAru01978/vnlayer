  ...
  constructor() {
    ...
    this.GenerateRuntimeObject = () => {
      ...
      if (this.divertAfter) {
            ...
            for (
              ...
              if (cmd) {
                if (
                  evalStart == -1 &&
                  cmd.commandType ===
                    ControlCommand_1.ControlCommand.CommandType.EvalStart
                ) {
                  evalStart = ii;
                } else if (
                  cmd.commandType ===
                  ControlCommand_1.ControlCommand.CommandType.EvalEnd
                ) {
                  evalEnd = ii;
                }
              }
        ...
        let returnDivertObj = (0, TypeAssertion_1.asOrNull)(
          returnRuntimeObj,
          Divert_1.Divert,
        );
        if (returnDivertObj != null && returnDivertObj.hasVariableTarget) {
          let runtimeVarRef = new VariableReference_1.VariableReference(
