...
export declare abstract class ParsedObject {
  ...
  readonly AddContent: <T extends ParsedObject, V extends T | T[]>(
    subContent: V,
  ) => V | undefined;
  readonly InsertContent: <T extends ParsedObject>(
    index: number,
    subContent: T,
  ) => T;
  readonly Find: <T extends ParsedObject>(
    type:
      | (new (...arg: any[]) => T)
      | (Function & {
          prototype: T;
  ...
  readonly FindAll: <T extends ParsedObject>(
    type:
      | (new (...arg: any[]) => T)
      | (Function & {
          prototype: T;
