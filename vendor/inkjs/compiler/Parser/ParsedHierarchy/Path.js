  ...
  constructor(argOne, argTwo) {
    ...
    this.ResolveTailComponents = (rootTarget) => {
      ...
      for (let ii = 1; ii < this.components.length; ++ii) {
        ...
        let foundFlow = (0, TypeAssertion_1.asOrNull)(
          foundComponent,
          FlowBase_1.FlowBase,
        );
        if (foundFlow !== null) {
    ...
    this.GetChildFromContext = (
      ...
      const weaveContext = (0, TypeAssertion_1.asOrNull)(
        context,
        Weave_1.Weave,
      );
      if (
      ...
      if (childName && flowContext !== null) {
        ...
        const shouldDeepSearch =
          forceDeepSearch ||
          flowContext.flowLevel === FlowLevel_1.FlowLevel.Knot;
