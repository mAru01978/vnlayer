  ...
  constructor(startContent, choiceOnlyContent, innerContent) {
    ...
    this.GenerateRuntimeObject = () => {
      ...
      if (this.startContent) {
        ...
        const varAssign = new VariableAssignment_1.VariableAssignment(
          "$r",
          true,
        );
        ...
        this._outerContainer.AddContent(
          ControlCommand_1.ControlCommand.BeginString(),
        );
        ...
        this._outerContainer.AddContent(
          ControlCommand_1.ControlCommand.EndString(),
        );
      ...
      if (this.choiceOnlyContent) {
        ...
        const choiceOnlyRuntimeContent =
          this.choiceOnlyContent.GenerateRuntimeObject();
      ...
      if (this.innerContent) {
        const innerChoiceOnlyContent =
          this.innerContent.GenerateRuntimeObject();
