  ...
  constructor(toplevelObjects, isInclude = false) {
    ...
    this.ExportRuntime = (errorHandler = null) => {
      ...
      for (const listDef of this.FindAll(ListDefinition_1.ListDefinition)()) {
        if (
          (_a = listDef.identifier) === null || _a === void 0 ? void 0 : _a.name
        ) {
          this._listDefs.set(
            (_b = listDef.identifier) === null || _b === void 0
              ? void 0
              : _b.name,
            listDef,
          );
      ...
      variableInitialisation.AddContent(
        ControlCommand_1.ControlCommand.EvalStart(),
      );
      ...
      for (const [key, value] of this.variableDeclarations) {
        if (value.isGlobalDeclaration) {
          ...
          const runtimeVarAss = new VariableAssignment_1.VariableAssignment(
            key,
            true,
          );
      ...
      variableInitialisation.AddContent(
        ControlCommand_1.ControlCommand.EvalEnd(),
      );
    ...
    this.FlattenContainersIn = (container) => {
      ...
      if (container.content) {
        for (const c of container.content) {
          const innerContainer = (0, TypeAssertion_1.asOrNull)(
            c,
      ...
      if (container.namedContent) {
        for (const [, value] of container.namedContent) {
          const namedInnerContainer = (0, TypeAssertion_1.asOrNull)(
            value,
            Container_1.Container,
          );
    ...
    this.TryFlattenContainer = (container) => {
      ...
      const parentContainer = (0, TypeAssertion_1.asOrNull)(
        container.parent,
        Container_1.Container,
      );
      if (parentContainer) {
    ...
    this.CheckForNamingCollisions = (
      ...
      if (
        ...
        FunctionCall_1.FunctionCall.IsBuiltIn(
          (identifier === null || identifier === void 0
            ? void 0
            : identifier.name) || "",
        )
      ...
      const maybeKnotOrFunction = this.ContentWithNameAtLevel(
        (identifier === null || identifier === void 0
          ? void 0
          : identifier.name) || "",
        FlowLevel_1.FlowLevel.Knot,
      );
      const knotOrFunction = (0, TypeAssertion_1.asOrNull)(
        maybeKnotOrFunction,
        FlowBase_1.FlowBase,
      );
      if (
