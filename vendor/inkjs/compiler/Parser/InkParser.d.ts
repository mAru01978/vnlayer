...
export declare class InkParser extends StringParser {
   ...
   */
  readonly InnerConditionalContent: (
  ...
  readonly RegisterBinaryOperator: (
    op: string,
    precedence: number,
