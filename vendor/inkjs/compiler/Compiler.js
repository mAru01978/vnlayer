...
exports.Compiler =
  exports.Story =
  exports.InkList =
  exports.JsonFileHandler =
  exports.StatementLevel =
  exports.InkParser =
...
class Compiler {
  ...
  constructor(inkSource, options = null) {
    ...
    this.Compile = () => {
      this._parser = new InkParser_1.InkParser(
        this.inputString,
    ...
    this.RetrieveDebugSourceForLatestContent = () => {
      ...
      for (const outputObj of this.runtimeStory.state.outputStream) {
        const textContent = (0, TypeAssertion_1.asOrNull)(
          outputObj,
          Value_1.StringValue,
        );
        if (textContent !== null) {
          const range = new DebugSourceRange_1.DebugSourceRange(
            ((_a = textContent.value) === null || _a === void 0
              ? void 0
              : _a.length) || 0,
