      ...
      if (null != r) {
        ...
        for (let [n, i] of e) {
          ...
          if (1 === Object.keys(t).length)
            this._currentFlow = new X(e, this.story, r);
          else {
          ...
          if (!(
            ...
            throw new Error(
              "ink arguments when calling EvaluateFunction / ChoosePathStringWithParameters must benumber, string, bool or InkList. Argument was " +
                (null === u(t[e]) ? "null" : t[e].constructor.name),
            );
      ...
      if (t instanceof k) {
        ...
        switch (e.commandType) {
          ...
          case k.CommandType.ReadCount:
            ...
            let o,
              u = l(a, P),
              h = s(this.ContentAtPath(u.targetPath).correctObj, x);
            (null != h
              ? (o =
