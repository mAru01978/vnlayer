...
function r(t, e) {
  return t instanceof e ? h(t) : null;
}
function s(t, e) {
  if (t instanceof e) return h(t);
    ...
    ((this._alreadyHadError = !1),
      ...
      (this.FindAll = (t) => (e, n) => {
        const i = Array.isArray(n) ? n : [],
          s = r(this, t);
        if (
          (null === s || (e && !0 !== e(s)) || i.push(s), null === this.content)
        )
          return [];
...
class S {
  ...
  get path() {
    if (null == this._path)
      if (null == this.parent) this._path = new p();
      else {
        let t = [],
          e = this,
          n = r(e.parent, k);
        for (; null !== n;) {
          ...
          if (null != i && i.hasValidName) {
            if (null === i.name) return C("namedChild.name");
            t.unshift(new p.Component(i.name));
          } else t.unshift(new p.Component(n.content.indexOf(e)));
          ((e = n), (n = r(n.parent, k)));
        }
        this._path = new p(t);
      }
    ...
    if (t.isRelative) {
      ...
      return (
        null === e &&
          ...
          (e = r(this.parent, k)),
          m.Assert(null !== e, "Expected parent to be a container"),
          m.Assert(t.GetComponent(0).isParent),
          (t = t.tail)),
        null === e ? C("nearestContainer") : e.ContentAtPath(t)
      );
    }
    {
      let e = this.rootContentContainer;
      return null === e ? C("contentContainer") : e.ContentAtPath(t);
    }
  }
  ConvertPathToRelative(t) {
    ...
    let r = e.componentCount - 1 - i,
      s = [];
    for (let t = 0; t < r; ++t) s.push(p.Component.ToParent());
...
class b {
  ...
  copy() {
    return new b(this.originName, this.itemName);
  }
  serialized() {
  ...
  static fromSerializedKey(t) {
    let e = JSON.parse(t);
    if (!b.isLikeInkListItem(e)) return b.Null;
    let n = e;
    return new b(n.originName, n.itemName);
  }
...
class w extends Map {
  constructor() {
    if (
      (super(arguments[0] instanceof w ? arguments[0] : []),
      (this.origins = null),
      (this._originNames = []),
      ...
      if (null === n.result) return C("def.result");
  ...
  static FromString(t, e) {
    var n;
    if (null == t || "" == t) return new w();
    let i =
      null === (n = e.listDefinitions) || void 0 === n
        ? void 0
        : n.FindSingleItemListWithName(t);
    if (i) return null === i.value ? C("listValue.value") : new w(i.value);
    throw new Error(
  ...
  AddItem(t) {
    ...
    if (t instanceof b) {
      ...
      if (null === this.origins) return C("this.origins");
    ...
    if (null !== t) {
      ...
      if (null == i) {
        ...
        {
          let t = w.FromString(n, e).orderedItems[0];
          this.Add(t.Key, t.Value);
        }
      } else {
        let t = new b(i.name, n),
          e = i.ValueForItem(t);
        this.Add(t, e);
      }
    }
  ...
  ContainsItemNamed(t) {
    for (let [e] of this) {
      if (b.fromSerializedKey(e).itemName == t) return !0;
    }
    return !1;
  }
  ContainsKey(t) {
  ...
  get originNames() {
    if (this.Count > 0) {
      ...
      for (let [t] of this) {
        let e = b.fromSerializedKey(t);
        if (null === e.originName) return C("item.originName");
  ...
  get maxItem() {
    let t = { Key: b.Null, Value: 0 };
    for (let [e, n] of this) {
      let i = b.fromSerializedKey(e);
  ...
  MaxAsList() {
    return this.Count > 0 ? new w(this.maxItem) : new w();
  }
  MinAsList() {
    return this.Count > 0 ? new w(this.minItem) : new w();
  }
  ListWithSubRange(t, e) {
    if (0 == this.Count) return new w();
    let n = this.orderedItems,
      i = 0,
      r = Number.MAX_SAFE_INTEGER;
    (Number.isInteger(t)
      ? (i = t)
      : t instanceof w && t.Count > 0 && (i = t.minItem.Value),
      Number.isInteger(e)
        ? (r = e)
        : e instanceof w && e.Count > 0 && (r = e.maxItem.Value));
    let s = new w();
  ...
  toString() {
    ...
    for (let n = 0; n < t.length; n++) {
      n > 0 && e.Append(", ");
      let i = t[n].Key;
      if (null === i.itemName) return C("item.itemName");
      e.Append(i.itemName);
    }
    return e.toString();
  }
...
class T extends S {
  static Create(t, e) {
    if (e) {
      if (e === f.Int && Number.isInteger(Number(t))) return new P(Number(t));
      if (e === f.Float && !isNaN(t)) return new N(Number(t));
    }
  ...
  Copy() {
    return s(T.Create(this.valueObject), S);
  }
  BadCastException(t) {
    return new E(
...
class x extends T {
  ...
  toString() {
    return null === this.value ? C("Value.value") : this.value.toString();
  }
}
class A extends x {
  constructor(t) {
  ...
  Cast(t) {
    if (null === this.value) return C("Value.value");
    if (t == this.valueType) return this;
    if (t == f.Int) return new P(this.value ? 1 : 0);
    if (t == f.Float) return new N(this.value ? 1 : 0);
    if (t == f.String) return new I(this.value ? "true" : "false");
...
class P extends x {
  ...
  Cast(t) {
    if (null === this.value) return C("Value.value");
    if (t == this.valueType) return this;
    if (t == f.Bool) return new A(0 !== this.value);
    if (t == f.Float) return new N(this.value);
    if (t == f.String) return new I("" + this.value);
    throw this.BadCastException(t);
  }
}
class N extends x {
  ...
  Cast(t) {
    ...
    if (t == this.valueType) return this;
    if (t == f.Bool) return new A(0 !== this.value);
    if (t == f.Int) return new P(this.value);
    if (t == f.String) return new I("" + this.value);
    throw this.BadCastException(t);
  }
}
class I extends x {
  ...
  get isTruthy() {
    return null === this.value ? C("Value.value") : this.value.length > 0;
  }
  get isNewline() {
  ...
  Cast(t) {
    ...
    if (t == f.Int) {
      ...
      if (e.exists) return new P(e.result);
      throw this.BadCastException(t);
    }
    if (t == f.Float) {
      let e = (function (t) {
...
class O extends x {
  ...
  get valueType() {
    return f.DivertTarget;
  }
  get targetPath() {
    return null === this.value ? C("Value.value") : this.value;
  }
  set targetPath(t) {
    this.value = t;
  }
...
class F extends x {
  ...
  Copy() {
    return new F(this.variableName, this.contextIndex);
  }
}
class W extends x {
  get isTruthy() {
    return null === this.value ? C("this.value") : this.value.Count > 0;
  }
  get valueType() {
    return f.List;
  }
  Cast(t) {
    ...
    if (t == f.Int) {
      ...
      return t.Key.isNull ? new P(0) : new P(t.Value);
    }
    if (t == f.Float) {
      let t = this.value.maxItem;
    ...
    if (t == f.String) {
      let t = this.value.maxItem;
      return t.Key.isNull ? new I("") : new I(t.Key.toString());
    }
    if (t == this.valueType) return this;
    throw this.BadCastException(t);
  }
    ...
    (super(null),
      t || e
        ? t instanceof w
          ...
          : t instanceof b &&
            "number" == typeof e &&
            (this.value = new w({ Key: t, Value: e }))
        : (this.value = new w()));
  }
...
class k extends S {
  ...
  get countFlags() {
    let t = 0;
    return (
      this.visitsShouldBeCounted && (t |= k.CountFlags.Visits),
      this.turnIndexShouldBeCounted && (t |= k.CountFlags.Turns),
      this.countingAtStartOnly && (t |= k.CountFlags.CountStartOnly),
      t == k.CountFlags.CountStartOnly && (t = 0),
      t
    );
  }
  set countFlags(t) {
    let e = t;
    ((e & k.CountFlags.Visits) > 0 && (this.visitsShouldBeCounted = !0),
      (e & k.CountFlags.Turns) > 0 && (this.turnIndexShouldBeCounted = !0),
      (e & k.CountFlags.CountStartOnly) > 0 && (this.countingAtStartOnly = !0));
  }
  ...
  get internalPathToFirstLeafContent() {
    let t = [],
      e = this;
    for (; e instanceof k;)
      e.content.length > 0 && (t.push(new p.Component(0)), (e = e.content[0]));
    return new p(t);
  }
  AddContent(t) {
  ...
  ContentAtPath(t) {
    ...
    for (let o = e; o < n; ++o) {
      ...
      let l = s.ContentWithPathComponent(e);
      if (null == l) {
        i.approximate = !0;
        break;
      }
  ...
  ContentWithPathComponent(t) {
    ...
    {
      if (null === t.name) return C("component.name");
      let e = _(this.namedContent, t.name, null);
      return e.exists ? s(e.result, S) : null;
    }
  }
  BuildStringOfHierarchy() {
    ...
    for (let r = 0; r < this.content.length; ++r) {
      ...
      (r != this.content.length - 1 && t.Append(","),
        s instanceof k || s != n || t.Append("  <---"),
        t.AppendLine());
    }
    let r = new Map();
    for (let [t, e] of this.namedContent)
      this.content.indexOf(s(e, S)) >= 0 || r.set(t, e);
    if (r.size > 0) {
      (i(), t.AppendLine("-- named: --"));
      for (let [, i] of r) {
        (m.AssertType(i, k, "Can only print out named Containers"),
    ...
    (super(...arguments),
      ...
      (this.GenerateConstantIntoContainer = (t) => {
        null === this._prototypeRuntimeConstantExpression &&
          ((this._prototypeRuntimeConstantExpression = new k()),
...
class j extends S {
  ...
  get name() {
    return null === this._name ? C("NativeFunctionCall._name") : this._name;
  }
  set name(t) {
    ((this._name = t),
      this._isPrototype ||
  ...
  CallType(t) {
    ...
    if (2 == r || 1 == r) {
      ...
      let a = this._operationFuncs.get(n);
      if (!a) {
        const t = f[n];
        throw new E("Cannot perform operation " + this.name + " on " + t);
      }
      if (2 == r) {
        let e = s(t[1], x),
          n = a;
      ...
      {
        let t = a;
        if (null === i.value) return C("NativeFunctionCall.Call UnaryOp value");
        let n = t(i.value);
        return this.name === j.Int
          ? x.Create(n, f.Int)
          : this.name === j.Float
            ? x.Create(n, f.Float)
            : x.Create(n, e.valueType);
      }
    }
    throw new Error(
  ...
  CallBinaryListOperation(t) {
    ...
    if (!(
      ("&&" != this.name && "||" != this.name) ||
      (e.valueType == f.List && n.valueType == f.List)
    )) {
      if (null === this._operationFuncs)
        return C("NativeFunctionCall._operationFuncs");
      let t = this._operationFuncs.get(f.Int);
      if (null === t) return C("NativeFunctionCall.CallBinaryListOperation op");
      let i = (function (t) {
    ...
    if (e.valueType == f.List && n.valueType == f.List)
  ...
  CallListIncrementOperation(t) {
    let e = s(t[0], W),
      ...
      i = new w();
    if (null === e.value)
      return C("NativeFunctionCall.CallListIncrementOperation listVal.value");
    for (let [t, r] of e.value) {
      let s = b.fromSerializedKey(t);
      if (null === this._operationFuncs)
        return C("NativeFunctionCall._operationFuncs");
      let a = this._operationFuncs.get(f.Int);
      if (null === n.value)
        return C("NativeFunctionCall.CallListIncrementOperation intVal.value");
      let o = a(r, n.value),
        l = null;
      ...
      if (null != l) {
        let t = l.TryGetItemWithValue(o, b.Null);
  ...
  CoerceValuesToSingleType(t) {
    ...
    for (let i of t) {
      ...
      (t.valueType > e && (e = t.valueType),
        t.valueType == f.List && (n = r(t, W)));
    }
    let i = [];
    if (f[e] == f[f.List])
      for (let e of t) {
        let t = s(e, x);
        if (t.valueType == f.List) i.push(t);
        else {
          if (t.valueType != f.Int) {
            const e = f[t.valueType];
            throw new E(
          ...
          }
          {
            ...
            let a = r.TryGetItemWithValue(e, b.Null);
            if (!a.exists)
              throw new E(
  ...
  static GenerateNativeFunctionsIfNecessary() {
    if (null == this._nativeFunctions) {
      ...
      let t = (t, e) => t.Equals(e),
        e = (t, e) => !t.Equals(e);
      (this.AddOpToNativeFunc(this.Equal, 2, f.DivertTarget, t),
        this.AddOpToNativeFunc(this.NotEquals, 2, f.DivertTarget, e));
    }
  }
  ...
  static AddIntBinaryOp(t, e) {
    this.AddOpToNativeFunc(t, 2, f.Int, e);
  }
  static AddIntUnaryOp(t, e) {
    this.AddOpToNativeFunc(t, 1, f.Int, e);
  }
  static AddFloatBinaryOp(t, e) {
    this.AddOpToNativeFunc(t, 2, f.Float, e);
  }
  static AddFloatUnaryOp(t, e) {
    this.AddOpToNativeFunc(t, 1, f.Float, e);
  }
  static AddStringBinaryOp(t, e) {
    this.AddOpToNativeFunc(t, 2, f.String, e);
  }
  static AddListBinaryOp(t, e) {
    this.AddOpToNativeFunc(t, 2, f.List, e);
  }
  static AddListUnaryOp(t, e) {
    this.AddOpToNativeFunc(t, 1, f.List, e);
  }
  toString() {
...
class B extends L {
  constructor(t, e) {
    if (
      ...
      (this.GenerateIntoContainer = (t) => {
        this.isInt()
          ? t.AddContent(new P(this.value))
          : this.isFloat()
            ? t.AddContent(new N(this.value))
            : this.isBool() && t.AddContent(new A(this.value));
      }),
    ...
    (super(),
      ...
      (this.GenerateIntoContainer = (t) => {
        (this.innerExpression.GenerateIntoContainer(t),
          t.AddContent(j.CallWithName(this.nativeNameForOp)));
      }),
...
M.WithInner = (t, e) => {
  ...
  if (n) {
    if ("-" === e) {
      if (n.isInt()) return new B(-n.value, "int");
      if (n.isFloat()) return new B(-n.value, "float");
    } else if ("!" == e || "not" == e) {
      if (n.isInt()) return new B(0 == n.value, "bool");
      if (n.isFloat()) return new B(0 == n.value, "bool");
      if (n.isBool()) return new B(!n.value, "bool");
    }
...
class G extends L {
    ...
    (super(),
      ...
      (this.GenerateIntoContainer = (t) => {
        (this.leftExpression.GenerateIntoContainer(t),
          ...
          t.AddContent(j.CallWithName(this.opName)));
      }),
  ...
  ResolveReferences(t) {
    if (
      ...
      const t = r(this.leftExpression, M);
      null === t ||
        ("not" !== t.op && "!" !== t.op) ||
        this.Error(
...
$.FromRange = (t, e) => new $().AddRange(t, e);
class q {
  constructor(t, e) {
    ...
    if (
      ((this._start = t),
      (this._end = e),
      (this._correspondingCharSet = new $()),
...
class U extends S {
  ...
  toString() {
    if (null === this.pathOnChoice) return C("ChoicePoint.pathOnChoice");
...
let H = class t extends S {
  ...
  set targetPathString(t) {
    this.targetPath = null == t ? null : new p(t);
  }
  ...
  X = class extends c {
    ...
    constructor(t, e, n) {
      (super(),
        ...
        (this.GenerateRuntimeObject = () => {
          if (
            ((this._outerContainer = new k()),
            (this._runtimeChoice = new U(this.onceOnly)),
            ...
            (this._outerContainer.AddContent(t),
              ...
              (this._divertToStartContentOuter = new H()),
          ...
          if (
            ...
            (this._innerContentContainer = new k()),
            this.startContent)
          ) {
            ((this._returnToR2 = new O()),
            ...
            (this._innerContentContainer.AddContent(t),
              (this._divertToStartContentInner = new H()),
    ...
    ResolveReferences(t) {
      ...
      (super.ResolveReferences(t),
        this.identifier &&
          ...
          t.CheckForNamingCollisions(this, this.identifier, J.SubFlowAndWeave));
    }
  };
class Y {
  constructor() {
    ((this.characterIndex = 0),
      ...
      (this.CopyFrom = (t) => {
        (Y._uniqueIdCounter++,
          (this.uniqueId = Y._uniqueIdCounter),
  ...
  constructor() {
    ((this._stack = []),
      ...
      (this.StringParserState = () => {
        ...
        for (let t = 0; t < 200; ++t) this._stack[t] = new Y();
        this._numElements = 1;
      }),
      (this.Push = () => {
...
const Q = Symbol("ParseSuccessStruct");
class tt {
  constructor(t) {
    var e = this;
    ((this.ParseRule = null),
      ...
      (this.SucceedRule = function (t) {
        ...
        let s = n;
        return (null === s && (s = tt.ParseSuccess), s);
      }),
      ...
      (this.Optional = (t) => () => {
        ...
        return null === e ? tt.ParseSuccess : e;
      }),
      (this.Exclude = (t) => () => this.ParseObject(t) && tt.ParseSuccess),
      ...
      (this.Interleave = function (t, n) {
        ...
        do {
          ...
          (null !== l || null !== h) &&
          (l !== tt.ParseSuccess || h != tt.ParseSuccess) &&
          e.remainingLength > 0
        );
      ...
      (this.ParseInt = () => {
        ...
        const i = this.ParseCharactersFromCharSet(tt.numbersCharacterSet);
        if (null === i)
      ...
      (this.ParseFloat = () => {
        ...
        if (null !== n && null !== this.ParseString(".")) {
          const t = this.ParseCharactersFromCharSet(tt.numbersCharacterSet);
          return Number(`${n}.${t}`);
        }
        return ((this.index = t), (this.characterInLineIndex = e), null);
      }),
...
((tt.ParseSuccess = Q), (tt.numbersCharacterSet = new $("0123456789")));
class et extends tt {
  constructor() {
    (super(...arguments),
      (this._commentOrNewlineStartCharacter = new $("/\r\n")),
      (this._commentBlockEndCharacter = new $("*")),
      (this._newlineCharacters = new $("\n\r")),
      (this.Process = () => {
...
class it extends c {
  constructor(t) {
    (super(),
      (this.text = t),
      (this.GenerateRuntimeObject = () => new I(this.text)),
...
class rt extends c {
  ...
  ResolveReferences(t) {
    (super.ResolveReferences(t),
      t.CheckForNamingCollisions(this, this.constantIdentifier, J.Var));
  }
}
var st;
!(function (t) {
...
class ot {
  get baseTargetLevel() {
    return this.baseLevelIsAmbiguous ? st.Story : this._baseTargetLevel;
  }
    ...
    ((this._dotSeparatedComponents = null),
      (this.toString = () =>
        null === this.components || 0 === this.components.length
          ? this.baseTargetLevel === st.WeavePoint
            ? "-> <next gather point>"
            : "<invalid Path>"
      ...
      (this.ResolveTailComponents = (t) => {
        ...
        for (let t = 1; t < this.components.length; ++t) {
          ...
          let i,
            s = r(e, ct);
          if (
            ((i = null !== s ? s.flowLevel + 1 : st.WeavePoint),
      ...
      (this.GetChildFromContext = function (t, e, n) {
        ...
        const s = null === n,
          a = r(t, At);
        if (e && null !== a && (s || n === st.WeavePoint))
          return a.WeavePointNamed(e);
        let o = r(t, ct);
        if (e && null !== o) {
          const t = i || o.flowLevel === st.Knot;
          return o.ContentWithNameAtLevel(e, n, t);
        }
        return null;
      }),
      Object.values(st).includes(t)
  ...
  constructor(t) {
    ...
    (super(),
      ...
      (this.SplitWeaveAndSubFlowContent = (t, e) => {
        ...
        e && s.push(new at(null, 1), new Ct(new ot(ut.Done())));
        const o = [];
        return (
          s.length > 0 &&
            ((this._rootWeave = new At(s, 0)), o.push(this._rootWeave)),
          a.length > 0 && o.push(...a),
          o
        );
      }),
      ...
      (this.GenerateRuntimeObject = () => {
        ...
        this.isFunction
          ...
          : (this.flowLevel !== st.Knot && this.flowLevel !== st.Stitch) ||
            ((e = this.Find(lt)()),
            null !== e &&
              this.Error(
        ...
        for (; null !== this.content && i < this.content.length;) {
          ...
          if (t instanceof ct) {
            ...
            0 !== i ||
              e.hasParameters ||
              this.flowLevel !== st.Knot ||
              ((this._startingSubFlowDivert = new H()),
      ...
      (this.DeepSearchForAnyLevelContent = (t) => {
        const e = this.ContentWithNameAtLevel(t, st.WeavePoint, !1);
        if (e) return e;
  ...
  ResolveReferences(t) {
    ...
    if ((super.ResolveReferences(t), null !== this.args)) {
      for (const e of this.args)
        t.CheckForNamingCollisions(this, e.identifier, J.Arg, "argument");
    ...
    if (this.flowLevel !== st.Story) {
      const e = this.flowLevel === st.Knot ? J.Knot : J.SubFlowAndWeave;
...
let pt = class extends S {
  ...
  set pathStringForCount(t) {
    this.pathForCount = null === t ? null : new p(t);
  }
  constructor() {
    let t =
      arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
...
class mt extends L {
  ...
  get path() {
    return this.pathIdentifiers.map((t) => t.name).filter(u);
  }
  get identifier() {
  ...
  constructor(t) {
    (super(),
      ...
      (this.GenerateIntoContainer = (t) => {
        ...
        if (
          ((this._runtimeVarRef = new pt(this.name)),
  ...
  ResolveReferences(t) {
    if (
      ...
      return;
    const e = new ot(this.pathIdentifiers),
...
class ft extends L {
  ...
  constructor(t, e) {
    (super(),
      ...
      (this.GenerateIntoContainer = (t) => {
        ...
        else if (j.CallExistsWithName(this.name)) {
          const e = j.CallWithName(this.name);
          if (e.numberOfParameters !== this.args.length) {
            let t = `${ft.name} should take ${e.numberOfParameters} parameter`;
            (e.numberOfParameters > 1 && (t += "s"), this.Error(t));
          }
          for (let e = 0; e < this.args.length; e += 1)
            this.args[e].GenerateIntoContainer(t);
          t.AddContent(j.CallWithName(this.name));
        } else if (null !== e)
          if (
            (this.args.length > 1 &&
              this.Error(
            ...
            (t.AddContent(new I(this.name)),
              this.args[0].GenerateIntoContainer(t),
              t.AddContent(D.ListFromInt()));
          else {
            const e = new w();
            (e.SetInitialOriginName(this.name), t.AddContent(new W(e)));
          }
      ...
      (this._proxyDivert = new Ct(new ot(t), e)),
  ...
  ResolveReferences(t) {
    ...
    if (this._divertTargetToCount) {
      ...
      null !== t.pathForCount &&
        this.Error(
          `Should be '${ft.name}'(-> '${this._variableReferenceToCount.name}). Usage without the '->' only makes sense for variable targets.`,
        );
    }
  }
}
ft.IsBuiltIn = (t) =>
  !!j.CallExistsWithName(t) ||
  "CHOICE_COUNT" === t ||
  "TURNS_SINCE" === t ||
  "TURNS" === t ||
  "RANDOM" === t ||
    ...
    (super(),
      ...
      (this.GenerateIntoContainer = (t) => {
        (this.divert.GenerateRuntimeObject(),
          ...
          (this._runtimeDivertTargetValue = new O()),
      ...
      if (i instanceof G) {
        ...
        ("==" !== e.opName && "!=" !== e.opName
          ...
          : ((e.leftExpression instanceof vt ||
              e.leftExpression instanceof mt) &&
              (e.rightExpression instanceof vt ||
                e.rightExpression instanceof mt)) ||
            (t = !0),
          (n = !0));
      } else if (i instanceof ft) {
        const e = i;
        (e.isTurnsSince || e.isReadCount || (t = !0), (n = !0));
      } else
        (i instanceof L ||
          i instanceof gt ||
          (i instanceof X && i.condition === e) ||
          i instanceof nt ||
          i instanceof Pt) &&
          ((t = !0), (n = !0));
      if (
...
class Ct extends c {
    ...
    (super(),
        ...
        if (t || this.isFunctionCall || this.isTunnel || this.isThread) {
          ...
          if (t) {
            ...
            for (let n = 0; n < this.args.length; ++n) {
              const i = this.args[n];
              let s = null;
              if ((t && n < t.length && (s = t[n]), s && s.isByReference)) {
                const t = r(i, mt);
                if (!t) {
                  this.Error(
                    `Expected variable name to pass by reference to 'ref ${s.identifier}' but saw ${i}`,
                  );
                  break;
                }
                const n = new ot(t.pathIdentifiers);
      ...
      (this.CheckArgumentValidity = () => {
        ...
        if (
          ...
          return;
        const e = r(this.targetContent, ct);
        ...
        for (let t = 0; t < n; ++t) {
          ...
          if (n.isDivertTarget) {
            ...
            if (i instanceof vt || null !== t) {
              if (t) {
                const e = new ot(t.pathIdentifiers);
  ...
  ResolveReferences(t) {
    ...
    if (1 === this.target.numberOfComponents) {
      ...
      if (
        ((i = ft.IsBuiltIn(this.target.firstComponent)),
        (s = t.IsExternal(this.target.firstComponent)),
        i || s)
      )
        return (
          this.isFunctionCall ||
          ...
          void (
            ...
            (this.runtimeDivert.targetPath = new p(this.target.firstComponent)),
            this.CheckExternalArgumentValidity(t))
          )
        );
    }
    null == this.runtimeDivert.variableDivertName &&
      (n || i || s || this.Error(`target not found: '${this.target}'`));
  }
  Error(t) {
    let e =
        arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
  ...
  constructor(t, e) {
    (super(),
      ...
      (this.GenerateRuntimeObject = () => {
        ...
        const e = (this.sequenceType & bt.Once) > 0,
          n = (this.sequenceType & bt.Cycle) > 0,
          i = (this.sequenceType & bt.Stopping) > 0,
          r = (this.sequenceType & bt.Shuffle) > 0;
        let s = this.sequenceElements.length;
        if (
          (e && (s += 1),
          i || e
            ? (t.AddContent(new P(s - 1)), t.AddContent(j.CallWithName("MIN")))
            : n &&
              (t.AddContent(new P(this.sequenceElements.length)),
              t.AddContent(j.CallWithName("%"))),
          r)
        ) {
          const n = D.NoOp();
          if (e || i) {
      ...
      (this.AddDivertToResolve = (t, e) => {
        this._sequenceDivertsToResolve.push(new yt(t, e));
      }),
      (this.sequenceType = e),
    ...
    for (const e of t) {
      const t = e.content;
      let n = null;
      ((n = null === t || 0 === t.length ? e : new At(t)),
      ...
      (this.GenerateRuntimeObject = () => {
        ...
        if ((t.AddContent(D.EvalStart()), this.divertAfter)) {
          ...
          if (null != i && i.hasVariableTarget) {
            let e = new pt(i.variableDivertName);
            t.AddContent(e);
          } else
            ((this._overrideDivertTarget = new O()),
              t.AddContent(this._overrideDivertTarget));
        } else t.AddContent(new V());
...
let _t = class {
  ...
  TryGetItemWithValue(t, e) {
    for (let [e, n] of this._itemNameToValues)
      if (n == t) return { result: new b(this.name, e), exists: !0 };
...
class Tt extends c {
  ...
  ResolveReferences(t) {
    (super.ResolveReferences(t),
      t.CheckForNamingCollisions(this, this.identifier, J.List));
  }
}
class xt extends c {
  get variableName() {
    ...
    (super(),
      ...
      (this.GenerateRuntimeObject = () => {
        ...
        if (
          (this.isGlobalDeclaration
            ? (t = this.story)
            : this.isNewTemporaryDeclaration && (t = ht(this)),
    ...
    if (
      ...
      this.isDeclaration &&
        ...
        t.CheckForNamingCollisions(
          ...
          this.isGlobalDeclaration ? J.Var : J.Temp,
        ),
      this.isGlobalDeclaration)
    ) {
      const t = r(this.expression, mt);
      !t ||
  ...
  constructor(t) {
    ...
    (super(),
      ...
      (this.ResolveWeavePointNaming = () => {
        var t, e, n;
        const i = [
          ...this.FindAll(at)((t) => !(null === t.name || void 0 === t.name)),
          ...this.FindAll(X)((t) => !(null === t.name || void 0 === t.name)),
        ];
        this._namedWeavePoints = new Map();
        for (const r of i) {
          ...
          if (i) {
            const t = i instanceof at ? "gather" : "choice",
              e = i;
            this.Error(
      ...
      (this.ConstructWeaveHierarchyFromIndentation = () => {
        ...
        for (; t < this.content.length;) {
          ...
          if (e instanceof X || e instanceof at) {
            const n = e.indentationDepth - 1;
            if (n > this.baseIndentIndex) {
              let e = t;
              for (; t < this.content.length;) {
                const e = r(this.content[t], X) || r(this.content[t], at);
                if (null !== e) {
      ...
      (this.DetermineBaseIndentationFromContent = (t) => {
        for (const e of t)
          if (e instanceof X || e instanceof at) return e.indentationDepth - 1;
        return 0;
      }),
      (this.GenerateRuntimeObject = () => {
        ((this._rootContainer = new k()),
          (this.currentContainer = this._rootContainer),
          (this.looseEnds = []),
          (this.gatherPointsToResolve = []));
        for (const t of this.content)
          if (t instanceof X || t instanceof at)
      ...
      (this.AddRuntimeForGather = (t) => {
        ...
        for (const e of this.looseEnds) {
          ...
          let r = null;
          if (i instanceof Ct) r = i.runtimeObject;
          else {
            r = new H();
            const t = i;
          ...
          this.gatherPointsToResolve.push(new St(r, n));
        }
        ((this.looseEnds = []), (this.currentContainer = n));
      }),
      (this.AddRuntimeForWeavePoint = (t) => {
        if (t instanceof at) this.AddRuntimeForGather(t);
        else if (t instanceof X) {
          if (!this.currentContainer) throw new Error();
          this.previousWeavePoint instanceof at &&
        ...
        if (
          ...
          r(t, X) && (this.addContentToPreviousWeavePoint = !0);
        }
      ...
      (this.PassLooseEndsToAncestors = () => {
        ...
        for (let i = this.parent; null !== i; i = i.parent) {
          const s = r(i, At);
          (s && (n || null !== t || (t = s), n && null === e && (e = s)),
            (i instanceof wt || i instanceof nt) && (n = !0));
        }
        if (null !== t || null !== e)
      ...
      (this.ContentThatFollowsWeavePoint = (t) => {
        ...
        for (let t = i.content.indexOf(n) + 1; t < i.content.length; t += 1) {
          ...
          if (!this.IsGlobalDeclaration(n)) {
            if (n instanceof X || n instanceof at) break;
            if (n instanceof At) break;
            e.push(n);
          }
        }
        return e;
      ...
      (this.ValidateTermination = (t) => {
        if (this.lastParsedSignificantObject instanceof d) return;
        if (null !== this.looseEnds && this.looseEnds.length > 0)
          ...
          for (const t of this.content)
            if (t instanceof X || t instanceof Ct) return;
      ...
      (this.BadNestedTerminationHandler = (t) => {
        ...
        for (let n = t.parent; null !== n; n = n.parent)
          if (n instanceof wt || n instanceof nt) {
            e = r(n, nt);
            break;
          }
        let n =
  ...
  ResolveReferences(t) {
    if (
      ...
      for (let e = this.parent; null !== e; e = e.parent)
        if (e instanceof wt || e instanceof nt) {
          t = !0;
          break;
        }
      ...
      (this.GenerateRuntimeObject = () => {
        ...
        if (
          ...
          (e && t.AddContent(D.EvalStart()),
            ...
            this.matchingEquality && t.AddContent(j.CallWithName("==")),
        ...
        return (
          ...
          this.isInline || this._contentContainer.InsertContent(new I("\n"), 0),
          ...
          (this.returnDivert = new H()),
          this._contentContainer.AddContent(this.returnDivert),
          t
        );
      }),
      (this.GenerateRuntimeForContent = () =>
        null === this._innerWeave ? new k() : this._innerWeave.rootContainer),
      t && ((this._innerWeave = new At(t)), this.AddContent(this._innerWeave)));
  }
  get typeName() {
      ...
      (this.GenerateIntoContainer = (t) => {
        ...
        (t.AddContent(
          ...
          this.expression
            ...
            : t.AddContent(new P(1)),
          t.AddContent(j.CallWithName(this.isInc ? "+" : "-")),
          (this._runtimeAssignment = new z(
...
class jt extends ct {
  ...
  ResolveReferences(t) {
    ...
    for (const t in this.subFlowsByName) {
      const n = e.ContentWithNameAtLevel(t, st.Knot, !1);
      if (n) {
...
class Mt extends c {
  ...
  ResolveReferences(t) {
    (super.ResolveReferences(t),
      t.CheckForNamingCollisions(this, this.indentifier, J.ListItem));
  }
}
var Gt;
!(function (t) {
...
class Ht {
  ...
  static WriteRuntimeObject(t, e) {
    ...
    if (i) {
      ...
      return (
        i.isExternal
          ? (n = "x()")
          : i.pushesToStack &&
            (i.stackPushType == g.Function
              ? (n = "f()")
              : i.stackPushType == g.Tunnel && (n = "->t->")),
    ...
    if (s)
      return (
        t.WriteObjectStart(),
        t.WriteProperty("*", s.pathStringOnChoice),
        t.WriteIntProperty("flg", s.flags),
        void t.WriteObjectEnd()
      );
    let a = r(e, A);
    ...
    if (r(e, kt)) return void t.Write("<>");
    let p = r(e, D);
    if (p) return void t.Write(Ht._controlCommandNames[p.commandType]);
    let m = r(e, j);
    if (m) {
      let e = m.name;
    ...
    if (v) {
      t.WriteObjectStart();
      let e = v.isGlobal ? "VAR=" : "temp=";
      return (
        t.WriteProperty(e, v.variableName),
        v.isNewDeclaration || t.WriteProperty("re", !0),
        void t.WriteObjectEnd()
      );
    }
    if (r(e, V)) return void t.Write("void");
    let S = r(e, qt);
    if (S)
      return (
        t.WriteObjectStart(),
        t.WriteProperty("#", S.text),
        void t.WriteObjectEnd()
      );
    let y = r(e, Ut);
    if (!y)
  ...
  static JTokenToRuntimeObject(t) {
    ...
    if ("string" == typeof t) {
      ...
      if (n) return new N(parseFloat(n[0]));
      let i = e[0];
      if ("^" == i) return new I(e.substring(1));
      if ("\n" == i && 1 == e.length) return new I("\n");
      if ("<>" == e) return new kt();
      for (let t = 0; t < Ht._controlCommandNames.length; ++t) {
        if (e == Ht._controlCommandNames[t]) return new D(t);
      }
      if (("L^" == e && (e = "^"), j.CallExistsWithName(e)))
        return j.CallWithName(e);
      if ("->->" == e) return D.PopTunnel();
      if ("~ret" == e) return D.PopFunction();
      if ("void" == e) return new V();
    }
    if ("object" == typeof t && !Array.isArray(t)) {
      let e,
        n = t;
      if (n["^->"]) return ((e = n["^->"]), new O(new p(e.toString())));
      if (n["^var"]) {
        e = n["^var"];
        let t = new F(e.toString());
      ...
      if (
        ((e = n["->"])
          ? (i = !0)
          : (e = n["f()"])
            ? ((i = !0), (r = !0), (s = g.Function))
            : (e = n["->t->"])
              ? ((i = !0), (r = !0), (s = g.Tunnel))
              : (e = n["x()"]) &&
                ((i = !0), (a = !0), (r = !1), (s = g.Function)),
        i)
      ) {
        let t = new H();
      ...
      if ((e = n["VAR?"])) return new pt(e.toString());
      if ((e = n["CNT?"])) {
        let t = new pt();
      ...
      if (void 0 !== n["#"]) return ((e = n["#"]), new qt(e.toString()));
      if ((e = n.list)) {
        let t = e,
          i = new w();
        if ((e = n.origins)) {
  ...
  static WriteRuntimeContainer(t, e) {
    let n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2];
    if ((t.WriteArrayStart(), null === e)) return C("container");
    ...
    if ((o && t.WriteObjectStart(), null != i))
      for (let [e, n] of i) {
        ...
        (t.WritePropertyStart(i),
          this.WriteRuntimeContainer(t, s, !0),
          t.WritePropertyEnd());
      }
  ...
  static WriteInkList(t, e) {
    let n = e.value;
    if (null === n) return C("rawList");
    (t.WriteObjectStart(), t.WritePropertyStart("list"), t.WriteObjectStart());
    for (let [e, i] of n) {
      let n = b.fromSerializedKey(e),
        r = i;
      if (null === n.itemName) return C("item.itemName");
...
class Jt {
  ...
  constructor() {
    if (
      ...
      (this._startOfRoot = K.Null),
      arguments[0] instanceof ie)
    ) {
      let t = arguments[0];
      ((this._startOfRoot = K.StartOf(t.rootContentContainer)), this.Reset());
    } else {
      let t = arguments[0];
      this._threads = [];
  ...
  Reset() {
    ((this._threads = []),
      this._threads.push(new Jt.Thread()),
      this._threads[0].callstack.push(
        new Jt.Element(g.Tunnel, this._startOfRoot),
      ));
  }
  SetJsonToken(t, e) {
    this._threads.length = 0;
    ...
    ((this._threadCounter = parseInt(t.threadCounter)),
      (this._startOfRoot = K.StartOf(e.rootContentContainer)));
  }
  WriteJson(t) {
    t.WriteObject((t) => {
  ...
  get elementIsEvaluateFromGame() {
    return this.currentElement.type == g.FunctionEvaluationFromGame;
  }
  Push(t) {
    let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
      n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0,
      i = new Jt.Element(t, this.currentElement.currentPointer, !1);
  ...
  GetTemporaryVariableWithName(t) {
    ...
    let n = _(this.callStack[e - 1].temporaryVariables, t, null);
  ...
  SetTemporaryVariable(t, e, n) {
    ...
    let s = _(r.temporaryVariables, t, null);
    (s.exists && W.RetainListOriginsForAssignment(s.result, e),
      ...
      if (
        ...
        for (let t of i) {
          ...
          let l = !!r.exp,
            ...
            u = r.temp;
          (void 0 !== u
            ? (h.temporaryVariables = Ht.JObjectToDictionaryRuntimeObjs(u))
            : h.temporaryVariables.clear(),
            this.callstack.push(h));
        }
        let r = t.previousContentObject;
        if (void 0 !== r) {
          let t = new p(r.toString());
      ...
      for (let e of this.callstack) {
        ...
        (t.WriteProperty("exp", e.inExpressionEvaluation),
          ...
          e.temporaryVariables.size > 0 &&
            ...
            Ht.WriteDictionaryRuntimeObjs(t, e.temporaryVariables),
            t.WritePropertyEnd()),
          t.WriteObjectEnd());
      }
      if (
        ...
        if (null === e) return C("this.previousPointer.Resolve()");
...
class zt extends class {} {
  ...
  ApplyPatch() {
    if (null === this.patch) return C("this.patch");
  ...
  SetJsonToken(t) {
    ...
    for (let [e, n] of this._defaultGlobalVariables) {
      let i = t[e];
      if (void 0 !== i) {
        let t = Ht.JTokenToRuntimeObject(i);
        if (null === t) return C("tokenInkObject");
  ...
  WriteJson(t) {
    ...
    for (let [e, n] of this._globalVariables) {
      let i = e,
        r = n;
      if (zt.dontSaveDefaultValues && this._defaultGlobalVariables.has(i)) {
        let t = this._defaultGlobalVariables.get(i);
        if (this.RuntimeObjectsEqual(r, t)) continue;
      }
      (t.WritePropertyStart(i),
        Ht.WriteRuntimeObject(t, r),
        t.WritePropertyEnd());
    }
    t.WriteObjectEnd();
  }
  RuntimeObjectsEqual(t, e) {
    if (null === t) return C("obj1");
    if (null === e) return C("obj2");
    if (t.constructor !== e.constructor) return !1;
    let n = r(t, A);
    if (null !== n) return n.value === s(e, A).value;
    let i = r(t, P);
    if (null !== i) return i.value === s(e, P).value;
    let a = r(t, N);
    if (null !== a) return a.value === s(e, N).value;
    let o = r(t, x),
      h = r(e, x);
    if (null !== o && null !== h)
      return l(o.valueObject) && l(h.valueObject)
        ? o.valueObject.Equals(h.valueObject)
        : o.valueObject === h.valueObject;
    throw new Error(
  ...
  TryGetDefaultVariableValue(t) {
    let e = _(this._defaultGlobalVariables, t, null);
  ...
  GetRawVariableWithName(t, e) {
    ...
    if (0 == e || -1 == e) {
      ...
      if (
        ...
        return e.result;
      if (((e = _(this._globalVariables, t, null)), e.exists)) return e.result;
      if (
        null !== this._defaultGlobalVariables &&
        ((e = _(this._defaultGlobalVariables, t, null)), e.exists)
      )
        return e.result;
  ...
  Assign(t, e) {
    ...
    if (null === n) return C("name");
    let i = -1,
      s = !1;
    if (
      ((s = t.isNewDeclaration
        ? t.isGlobal
      ...
      let t = null;
      do {
        ((t = r(this.GetRawVariableWithName(n, i), F)),
          null != t &&
            ((n = t.variableName), (i = t.contextIndex), (s = 0 == i)));
      } while (null != t);
    }
    s
      ? this.SetGlobal(n, e)
  ...
  SetGlobal(t, e) {
    let n = null;
    if (
      (null === this.patch && (n = _(this._globalVariables, t, null)),
      null !== this.patch &&
        ((n = this.patch.TryGetGlobal(t, null)),
        n.exists || (n = _(this._globalVariables, t, null))),
      W.RetainListOriginsForAssignment(n.result, e),
      null === t)
    )
  ...
  ResolveVariablePointer(t) {
    ...
    let n = r(this.GetRawVariableWithName(t.variableName, e), F);
    return null != n ? n : new F(t.variableName, e);
  }
...
class Zt {
  static TextToDictionary(t) {
    return new Zt.Reader(t).ToDictionary();
  }
  static TextToArray(t) {
    return new Zt.Reader(t).ToArray();
  }
}
!(function (t) {
  t.Reader = class {
...
class Qt {
  constructor() {
    let t = arguments[0],
      e = arguments[1];
    if (((this.name = t), (this.callStack = new Jt(e)), arguments[2])) {
      let t = arguments[2];
      (this.callStack.SetJsonToken(t.callstack, e),
        (this.outputStream = Ht.JArrayToRuntimeObjList(t.outputStream)),
        (this.currentChoices = Ht.JArrayToRuntimeObjList(t.currentChoices)));
  ...
  WriteJson(t) {
    (t.WriteObjectStart(),
      ...
      t.WriteProperty("outputStream", (t) =>
        Ht.WriteListRuntimeObjs(t, this.outputStream),
      ));
    let e = !1;
    for (let n of this.currentChoices) {
      if (null === n.threadAtGeneration) return C("c.threadAtGeneration");
    ...
    (e && (t.WriteObjectEnd(), t.WritePropertyEnd()),
      t.WriteProperty("currentChoices", (t) => {
        t.WriteArrayStart();
        for (let e of this.currentChoices) Ht.WriteChoice(t, e);
        t.WriteArrayEnd();
      }),
      t.WriteObjectEnd());
  }
  LoadFlowChoiceThreads(t, e) {
    for (let n of this.currentChoices) {
      ...
      if (null !== i) n.threadAtGeneration = i.Copy();
        ...
        n.threadAtGeneration = new Jt.Thread(i, e);
      }
    }
  }
}
class te {
  ...
  constructor(t) {
    ((this.kInkSaveStateVersion = 10),
      ...
      (this.story = t),
      (this._currentFlow = new Qt(this.kDefaultFlowName, t)),
      this.OutputStreamDirty(),
      (this._aliveFlowNamesDirty = !0),
      (this._evaluationStack = []),
      (this._variablesState = new zt(this.callStack, t.listDefinitions)),
      (this._visitCounts = new Map()),
      (this._turnIndices = new Map()),
      (this.currentTurnIndex = -1));
    let e = new Date().getTime();
    ((this.storySeed = new Xt(e).next() % 100),
      (this.previousRandom = 0),
      this.GoToStart());
  }
  GoToStart() {
    this.callStack.currentElement.currentPointer = K.StartOf(
  ...
  SwitchFlow_Internal(t) {
    ...
    if (
      ...
      return;
    let e,
      n = _(this._namedFlows, t, null);
    (n.exists
      ? (e = n.result)
      : ((e = new Qt(t, this.story)),
  ...
  CopyAndStartPatching(t) {
    let e = new te(this.story);
    if (
      ((e._patch = new Yt(this._patch)),
      (e._currentFlow.name = this._currentFlow.name),
      (e._currentFlow.callStack = new Jt(this._currentFlow.callStack)),
  ...
  WriteJson(t) {
    ...
    if (
      ...
      t.WriteProperty("evalStack", (t) =>
        Ht.WriteListRuntimeObjs(t, this.evaluationStack),
      ),
      !this.divertedPointer.isNull)
    ) {
      if (null === this.divertedPointer.path) return C("divertedPointer");
      t.WriteProperty(
        "currentDivertTarget",
    ...
    (t.WriteProperty("visitCounts", (t) =>
      Ht.WriteIntDictionary(t, this._visitCounts),
    ),
      t.WriteProperty("turnIndices", (t) =>
        Ht.WriteIntDictionary(t, this._turnIndices),
      ),
      ...
      t.WriteIntProperty("inkFormatVersion", ie.inkVersionCurrent),
      t.WriteObjectEnd());
  }
  LoadJsonObj(t) {
    let e = t,
    ...
    if (null != i) {
      ...
      for (let [e, i] of n) {
        let n = e,
          r = i,
          s = new Qt(n, this.story, r);
        if (1 === Object.keys(t).length)
          this._currentFlow = new Qt(n, this.story, r);
        else {
          if (null === this._namedFlows) return C("this._namedFlows");
      ...
      ((this._namedFlows = null),
        ...
        (this._currentFlow.outputStream = Ht.JArrayToRuntimeObjList(
          e.outputStream,
        )),
        (this._currentFlow.currentChoices = Ht.JArrayToRuntimeObjList(
          e.currentChoices,
        )));
    ...
    (this.OutputStreamDirty(),
      ...
      (this.variablesState.callStack = this._currentFlow.callStack),
      (this._evaluationStack = Ht.JArrayToRuntimeObjList(e.evalStack)));
    let r = e.currentDivertTarget;
    if (null != r) {
      let t = new p(r.toString());
      this.divertedPointer = this.story.PointerAtPath(t);
    }
    ((this._visitCounts = Ht.JObjectToIntDictionary(e.visitCounts)),
      (this._turnIndices = Ht.JObjectToIntDictionary(e.turnIndices)),
  ...
  TrySplittingHeadTailWhitespace(t) {
    let e = t.value;
    if (null === e) return C("single.value");
    let n = -1,
      i = -1;
    ...
    if (-1 != r && s > i && (a.push(new I("\n")), r < e.length - 1)) {
      let t = e.length - r - 1,
        n = new I(e.substring(r + 1, r + 1 + t));
      a.push(n);
    }
    return a;
  }
  ...
  TrimNewlinesFromOutputStream() {
    ...
    for (; e >= 0;) {
      let n = this.outputStream[e],
        i = r(n, D),
        s = r(n, I);
      if (null != i || (null != s && s.isNonWhitespace)) break;
      (null != s && s.isNewline && (t = e), e--);
    }
    if (t >= 0)
      for (e = t; e < this.outputStream.length;) {
        r(this.outputStream[e], I) ? this.outputStream.splice(e, 1) : e++;
      }
    this.OutputStreamDirty();
  }
  RemoveExistingGlue() {
    for (let t = this.outputStream.length - 1; t >= 0; t--) {
      ...
      if (e instanceof kt) this.outputStream.splice(t, 1);
    ...
    if (e) {
      ...
      if (null != t.originNames) {
        ...
        for (let e of t.originNames) {
          ...
          if (null === n.result) return C("StoryState def.result");
  ...
  PopEvaluationStack(t) {
    ...
    return o(this.evaluationStack.splice(this.evaluationStack.length - t, t));
  }
  PeekEvaluationStack() {
  ...
  ForceEnd() {
    (this.callStack.Reset(),
      ...
      (this.currentPointer = K.Null),
      (this.previousPointer = K.Null),
      (this.didSafeExit = !0));
  }
  TrimWhitespaceFromFunctionEnd() {
    m.Assert(this.callStack.currentElement.type == g.Function);
  ...
  PopCallStack() {
    let t =
      arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
    (this.callStack.currentElement.type == g.Function &&
  ...
  StartFunctionEvaluationFromGame(t, e) {
    (this.callStack.Push(
      g.FunctionEvaluationFromGame,
      this.evaluationStack.length,
    ),
      (this.callStack.currentElement.currentPointer = K.StartOf(t)),
        ...
        if (!(
          ...
          throw new Error(
            "ink arguments when calling EvaluateFunction / ChoosePathStringWithParameters must benumber, string, bool or InkList. Argument was " +
              (null === o(t[e]) ? "null" : t[e].constructor.name),
          );
        this.PushEvaluationStack(x.Create(t[e]));
      }
  }
  TryExitFunctionEvaluationFromGame() {
    return (
      this.callStack.currentElement.type == g.FunctionEvaluationFromGame &&
      ((this.currentPointer = K.Null), (this.didSafeExit = !0), !0)
    );
  }
  CompleteFunctionEvaluationFromGame() {
    if (this.callStack.currentElement.type != g.FunctionEvaluationFromGame)
      throw new Error(
    ...
    if ((this.PopCallStack(g.FunctionEvaluationFromGame), e)) {
      if (e instanceof V) return null;
      let t = s(e, x);
      return t.valueType == f.DivertTarget
...
let ie = class t extends S {
  get currentChoices() {
    let t = [];
    if (null === this._state) return C("this._state");
  ...
  constructor() {
    ...
    if (arguments[0] instanceof k)
      ...
      let t = arguments[0];
      i = Zt.TextToDictionary(t);
    } else i = arguments[0];
    if (
      (null != n && (this._listDefinitions = new Kt(n)),
      ...
      ((a = e.listDefs) &&
        (this._listDefinitions = Ht.JTokenToListDefinitions(a)),
        (this._mainContentContainer = s(Ht.JTokenToRuntimeObject(o), k)),
        this.ResetState());
    }
  }
  ToJson(e) {
    let n = !1;
    if (
      (e || ((n = !0), (e = new Zt.Writer())),
      e.WriteObjectStart(),
      e.WriteIntProperty("inkVersion", t.inkVersionCurrent),
      e.WriteProperty("root", (t) =>
        Ht.WriteRuntimeContainer(t, this._mainContentContainer),
      ),
  ...
  ResetGlobals() {
    if (this._mainContentContainer.namedContent.get("global decl")) {
      ...
      (this.ChoosePath(new p("global decl"), !1),
  ...
  ContinueInternal() {
    ...
    if (
      ((!i && this.canContinue) ||
        ...
        this.canContinue ||
          ...
          0 != this.state.generatedChoices.length ||
            ...
            (this.state.callStack.CanPop(g.Tunnel)
              ? this.AddError(
                  "unexpectedly reached end of content. Do you need a '->->' to return from a tunnel?",
                )
              : this.state.callStack.CanPop(g.Function)
                ? this.AddError(
      ...
      if (this.state.hasError)
        for (let t of this.state.currentErrors) this.onError(t, ne.Error);
      if (this.state.hasWarning)
        for (let t of this.state.currentWarnings) this.onError(t, ne.Warning);
      this.ResetErrors();
    }
    null != r &&
  ...
  ContinueSingleStep() {
    if (
      ...
      if (null !== this._stateSnapshotAtLastNewline) {
        ...
        if (null === this.state.currentTags) return C("this.state.currentTags");
  ...
  CalculateNewlineOutputStateChange(e, n, i, r) {
    if (null === e) return C("prevText");
    if (null === n) return C("currText");
    let s =
  ...
  VisitChangedContainersDueToDivert() {
    ...
    if (((this._prevContainers.length = 0), !t.isNull)) {
      let e = r(t.Resolve(), k) || r(t.container, k);
      for (; e;) (this._prevContainers.push(e), (e = r(e.parent, k)));
    }
    let n = e.Resolve();
    if (null == n) return;
    let i = r(n.parent, k),
    ...
    for (
      ...
      let t = i.content.length > 0 && n == i.content[0] && s;
      (t || (s = !1), this.VisitContainer(i, t), (n = i), (i = r(i.parent, k)));
    }
  }
  PopChoiceStringAndTags(t) {
    let e = s(this.state.PopEvaluationStack(), I);
    for (
      ;
      this.state.evaluationStack.length > 0 &&
      null != r(this.state.PeekEvaluationStack(), qt);
    ) {
      let e = r(this.state.PopEvaluationStack(), qt);
      e && t.push(e.text);
    }
    return e.value;
  }
      ...
      switch (e.commandType) {
        ...
        case D.CommandType.PopTunnel:
          ...
          if (
            ...
            let e = new Map();
            (e.set(g.Function, "function return statement (~ return)"),
              e.set(g.Tunnel, "tunnel onwards statement (->->)"));
        ...
        case D.CommandType.EndString: {
          ...
          for (let i = this.state.outputStream.length - 1; i >= 0; --i) {
            let s = this.state.outputStream[i];
            n++;
            let a = r(s, D);
            if (a && a.commandType == D.CommandType.BeginString) break;
            (s instanceof qt && e.push(s), s instanceof I && t.push(s));
          }
          ...
          ((this.state.inExpressionEvaluation = !0),
            this.state.PushEvaluationStack(new I(i.toString())));
          break;
        }
        case D.CommandType.ChoiceCount:
          let i = this.state.generatedChoices.length;
          this.state.PushEvaluationStack(new P(i));
          break;
        ...
        case D.CommandType.ReadCount:
          ...
          let o,
            l = s(a, O),
            h = r(this.ContentAtPath(l.targetPath).correctObj, k);
          (null != h
            ? (o =
            ...
            this.state.PushEvaluationStack(new P(o)));
          break;
        case D.CommandType.Random: {
          let t = r(this.state.PopEvaluationStack(), P),
            e = r(this.state.PopEvaluationStack(), P);
          if (null == e || e instanceof P == !1)
            return this.Error(
              "Invalid value for minimum parameter of RANDOM(min, max)",
            );
          if (null == t || t instanceof P == !1)
            return this.Error(
              "Invalid value for maximum parameter of RANDOM(min, max)",
            );
          if (null === t.value) return C("maxInt.value");
          if (null === e.value) return C("minInt.value");
          ...
          let i = this.state.storySeed + this.state.previousRandom,
            s = new Xt(i).next(),
            a = (s % n) + e.value;
          (this.state.PushEvaluationStack(new P(a)),
            (this.state.previousRandom = s));
          break;
        }
        case D.CommandType.SeedRandom:
          let u = r(this.state.PopEvaluationStack(), P);
          if (null == u || u instanceof P == !1)
            return this.Error("Invalid value passed to SEED_RANDOM");
          if (null === u.value) return C("minInt.value");
          ((this.state.storySeed = u.value),
            (this.state.previousRandom = 0),
            this.state.PushEvaluationStack(new V()));
          break;
        case D.CommandType.VisitIndex:
          ...
          this.state.PushEvaluationStack(new P(c));
          break;
        ...
        case D.CommandType.Done:
          this.state.callStack.canPopThread
            ...
            : ((this.state.didSafeExit = !0),
              (this.state.currentPointer = K.Null));
          break;
        case D.CommandType.End:
          this.state.ForceEnd();
          break;
        case D.CommandType.ListFromInt:
          let p = r(this.state.PopEvaluationStack(), P),
            m = s(this.state.PopEvaluationStack(), I);
          if (null === p)
            throw new E(
              "Passed non-integer when creating a list element from a numerical value.",
            );
          let f = null;
          if (null === this.listDefinitions) return C("this.listDefinitions");
          let v = this.listDefinitions.TryListGetDefinition(m.value, null);
          if (!v.exists) throw new E("Failed to find LIST called " + m.value);
          {
            if (null === p.value) return C("minInt.value");
            let t = v.result.TryGetItemWithValue(p.value, b.Null);
            t.exists && (f = new W(t.result, p.value));
          }
          (null == f && (f = new W()), this.state.PushEvaluationStack(f));
          break;
        case D.CommandType.ListRange:
          let S = r(this.state.PopEvaluationStack(), x),
            _ = r(this.state.PopEvaluationStack(), x),
            T = r(this.state.PopEvaluationStack(), W);
          if (null === T || null === _ || null === S)
            throw new E("Expected list, minimum and maximum for LIST_RANGE");
          if (null === T.value) return C("targetList.value");
          let A = T.value.ListWithSubRange(_.valueObject, S.valueObject);
          this.state.PushEvaluationStack(new W(A));
          break;
        case D.CommandType.ListRandom: {
          let t = this.state.PopEvaluationStack();
          if (null === t) throw new E("Expected list for LIST_RANDOM");
          let e = t.value,
            n = null;
          if (null === e) throw C("list");
          if (0 == e.Count) n = new w();
          else {
            ...
            let a = s.next().value,
              o = { Key: b.fromSerializedKey(a[0]), Value: a[1] };
            if (null === o.Key.originName)
              return C("randomItem.Key.originName");
            ((n = new w(o.Key.originName, this)),
              n.Add(o.Key, o.Value),
              (this.state.previousRandom = i));
          }
          this.state.PushEvaluationStack(new W(n));
          break;
        }
        default:
  ...
  ChoosePathString(t) {
    ...
    if (
      ...
      this.ResetCallstack();
    else if (this.state.callStack.currentElement.type == g.Function) {
      let e = "",
    ...
    (this.state.PassArgumentsToEvaluationStack(n), this.ChoosePath(new p(t)));
  }
  IfAsyncWeCant(t) {
  ...
  EvaluateExpression(t) {
    ...
    (this.state.callStack.Push(g.Tunnel),
  ...
  CallExternalFunction(t, e) {
    ...
    if (!r) {
      if (this.allowExternalFunctionFallbacks)
        return (
          ...
          void (this.state.divertedPointer = K.StartOf(i))
        );
      this.Assert(
        !1,
        "Trying to call EXTERNAL function '" +
    ...
    let a = [];
    for (let t = 0; t < e; ++t) {
      let t = s(this.state.PopEvaluationStack(), x).valueObject;
      a.push(t);
    }
    a.reverse();
    let o = n.function(a),
  ...
  ValidateExternalBindings() {
    ...
    if (
      ...
      arguments[0] instanceof S && (e = arguments[0]),
      null === t && null === e)
    )
      if (
      ...
      for (let [, e] of t.namedContent)
        this.ValidateExternalBindings(r(e, S), n);
    } else if (null != e) {
      let t = r(e, H);
      if (t && t.isExternal) {
        let e = t.targetPathString;
        if (null === e) return C("name");
  ...
  TagsAtStartOfFlowContainerWithPathString(t) {
    ...
    if (null === n) return C("flowContainer");
    for (;;) {
      let t = n.content[0];
    ...
    for (let t of n.content) {
      ...
      if (null != e)
        ...
        if (!i) break;
        {
          let e = r(t, I);
          null !== e
            ? (null === s && (s = []), null !== e.value && s.push(e.value))
            : this.Error(
  ...
  NextContent() {
    if (
      ...
      !this.state.divertedPointer.isNull &&
        ...
        (this.state.divertedPointer = K.Null),
    ...
    if (!this.IncrementContentPointer()) {
      let t = !1;
      (this.state.callStack.CanPop(g.Function)
        ? (this.state.PopCallStack(g.Function),
          this.state.inExpressionEvaluation &&
            this.state.PushEvaluationStack(new V()),
          (t = !0))
        : this.state.callStack.canPopThread
  ...
  IncrementContentPointer() {
    ...
    if ((e.index++, null === e.container)) return C("pointer.container");
    for (; e.index >= e.container.content.length;) {
      t = !1;
      let n = r(e.container.parent, k);
      if (n instanceof k == !1) break;
      let i = n.content.indexOf(e.container);
      if (-1 == i) break;
      if (((e = new K(n, i)), e.index++, (t = !0), null === e.container))
        return C("pointer.container");
    }
    return (
      t || (e = K.Null),
  ...
  NextSequenceShuffleIndex() {
    ...
    if (null === e) return C("seqContainer");
    if (null === t.value) return C("numElementsIntVal.value");
    let n = t.value,
      i = s(this.state.PopEvaluationStack(), P).value;
    if (null === i) return C("seqCount");
    let a = i / n,
      o = i % n,
      l = e.path.toString(),
      h = 0;
    for (let t = 0, e = l.length; t < e; t++) h += l.charCodeAt(t) || 0;
    let u = h + a + this.state.storySeed,
      c = new Xt(Math.floor(u)),
      d = [];
    ...
    (super(
      ...
      (this.Error = (t, e, i) => {
        ...
        (this._errorHandler(t, r),
          (this._hadError = r === n.Error),
          (this._hadWarning = r === n.Warning));
      }),
      (this.ResetError = () => {
      ...
      (this.CheckForNamingCollisions = function (t, n, i) {
        ...
        const a =
          (arguments.length > 3 && void 0 !== arguments[3]
            ? arguments[3]
            : "") || t.typeName;
        if (re.IsReservedKeyword(null == n ? void 0 : n.name))
          return void t.Error(
            `'${n}' cannot be used for the name of a ${a.toLowerCase()} because it's a reserved keyword`,
          );
        if (ft.IsBuiltIn((null == n ? void 0 : n.name) || ""))
          return void t.Error(
        ...
        if (
          ...
          return;
        const h = new ot(n).ResolveFromContext(t);
        if (h && h !== t)
          e.NameConflictError(t, (null == n ? void 0 : n.name) || "", h, a);
        else if (!(i < J.Arg) && i !== J.Arg) {
          let e = r(t, ct);
          if ((e || (e = ht(t)), e && e.hasParameters && e.args))
            for (const i of e.args)
              if (
                (null === (s = i.identifier) || void 0 === s
                  ? void 0
                  : s.name) === (null == n ? void 0 : n.name)
              )
                return void t.Error(
      ...
      if (n instanceof Lt) {
        ...
        if ((t.splice(r, 1), i.includedStory)) {
          const n = [],
            s = i.includedStory;
          if (null != s.content) {
            for (const t of s.content) t instanceof ct ? e.push(t) : n.push(t);
            (n.push(new it("\n")), t.splice(r, 0, ...n));
          }
        }
      } else;
...
class se extends L {
  get isSingleString() {
    ...
    return this.content[0] instanceof it;
  }
  constructor(t) {
    (super(),
      (this.GenerateIntoContainer = (t) => {
...
class le extends tt {
  ...
  constructor(t) {
    ...
    if (
      ...
      (e = this),
      (this.ParseStory = () => {
        const t = this.StatementsAtLevel(Gt.Top);
        return new re(t, this._rootParser !== this);
      }),
      ...
      (this.OnStringParserError = function (t, i) {
        let r =
        ...
        if (
          ...
          throw new Error(a);
        e._externalErrorHandler(a, s ? n.Warning : n.Error);
      }),
      (this.AuthorWarning = () => {
        this.Whitespace();
      ...
      (this.ExtendIdentifierCharacterRanges = (t) => {
        const e = le.ListAllCharacterRanges();
      ...
      (this.Choice = () => {
        ...
        (this.Whitespace(), this.EndTagIfNecessary(null != l ? l : s));
      ...
      (this.ChoiceCondition = () => {
        ...
        return null === t ? null : 1 === t.length ? t[0] : new gt(t);
      }),
      (this.ChoiceConditionsSpace = () => (
        this.Newline(),
        this.Whitespace(),
      ...
      (this.InnerConditionalContent = (t) => {
        ...
        if (i) e = this.InlineConditionalBranches();
          ...
          if (((e = this.MultilineConditionalBranches()), null === e)) {
            if (t) {
              let t = this.StatementsAtLevel(Gt.InnerBlock);
              if (null !== t) {
                e = [new Pt(t)];
      ...
      (this.SingleMultilineCondition = () => {
        ...
        let n = this.StatementsAtLevel(Gt.InnerBlock);
        (null === t &&
          null === n &&
          (this.Error(
      ...
      (this.ElseExpression = () =>
        null === this.ParseString("else")
          ? null
          : (this.Whitespace(), null === this.ParseString(":") ? null : Q)),
      ...
      (this.LineOfMixedTextAndLogic = () => {
        ...
        if (
          ...
          return null;
        return (
          t[t.length - 1] instanceof Ct || this.TrimEndWhitespace(t, !1),
          this.EndTagIfNecessary(t),
          (t.length > 0 && t[0] instanceof ae && t[0].isStart) ||
            t.push(new it("\n")),
      ...
      (this.ContentTextAllowingEscapeChar = () => {
        ...
        return null !== t ? new it(t) : null;
      }),
      (this.ContentTextNoEscape = () => {
        (null === this._nonTextPauseCharacters &&
          (this._nonTextPauseCharacters = new $("-<")),
          null === this._nonTextEndCharacters &&
            ((this._nonTextEndCharacters = new $("{}|\n\r\\#")),
            (this._notTextEndCharactersChoice = new $(
              this._nonTextEndCharacters,
            )),
            this._notTextEndCharactersChoice.AddCharacters("[]"),
            (this._notTextEndCharactersString = new $(
              this._nonTextEndCharacters,
            )),
      ...
      (this.SingleDivert = () => {
        ...
        if (t[0] instanceof Et) return null;
        const e = t[0];
      ...
      (this.ExpressionUnary = () => {
        ...
        if (
          ...
          return null;
        (null !== e && (n = M.WithInner(n, e)), this.Whitespace());
      ...
      (this.ExpressionDivertTarget = () => {
        ...
        return !t || (t && t.isThread) ? null : (this.Whitespace(), new vt(t));
      }),
      (this.ExpressionInt = () => {
        const t = this.ParseInt();
        return null === t ? null : new B(t, "int");
      }),
      (this.ExpressionFloat = () => {
        const t = this.ParseFloat();
        return null === t ? null : new B(t, "float");
      }),
      (this.ExpressionString = () => {
        if (null === this.ParseString('"')) return null;
      ...
      (this.ExpressionVariableName = () => {
        ...
        return null === t || re.IsReservedKeyword(t[0].name) ? null : new mt(t);
      }),
      (this.ExpressionParen = () => {
        if (null === this.ParseString("(")) return null;
        const t = this.Parse(this.Expression);
      ...
      (this.ExpressionList = () => {
        ...
        return (
          this.Whitespace(),
          null === this.ParseString(")") ? null : new Bt(t)
        );
      }),
      (this.ListMember = () => {
        this.Whitespace();
      ...
      (this.IncludeStatement = () => {
        ...
        return (this.RemoveOpenFilename(e), new Lt(n));
      }),
      ...
      (this.KnotDefinition = () => {
        ...
        const e = this.Expect(
          () => this.StatementsAtLevel(Gt.Knot),
          "at least one line within the knot",
          this.KnotStitchNoContentRecoveryRule,
        );
        return new jt(t.name, e, t.args, t.isFunction);
      }),
      ...
      (this.StitchDefinition = () => {
        ...
        const e = this.Expect(
          () => this.StatementsAtLevel(Gt.Stitch),
          "at least one line within the stitch",
          this.KnotStitchNoContentRecoveryRule,
        );
        return new $t(t.name, e, t.args, t.isFunction);
      }),
      (this.StitchDeclaration = () => {
        ...
        return (this.Whitespace(), new Ft(e, n, t));
      }),
      (this.KnotStitchNoContentRecoveryRule = () => {
        this.ParseUntil(this.KnotDeclaration, new $("="), null);
        return [new it("<ERROR IN FLOW>")];
      }),
        ...
        return (
          ...
          null !== t && "ref" === t.name
            ...
            : (r.isDivertTarget ? (r.identifier = n) : (r.identifier = t),
              null === r.identifier && this.Error("Expected an parameter name"),
              (r.isByReference = !1)),
          r
        );
      }),
      ...
      (this.LogicLine = () => {
        ...
        if (null === t) return new dt();
        t instanceof L &&
          !(t instanceof ft || t instanceof Dt) &&
          this.Error(
        ...
        return (
          ...
          null !== t.Find(ft)() && (t = new dt(t, new it("\n"))),
          this.Expect(this.EndOfLine, "end of line", this.SkipToNextLine),
          t
        );
      }),
      ...
      (this.ListDeclaration = () => {
        ...
        return e
          ? ((e.identifier = new ut(t.name)),
            new xt({ variableIdentifier: t, listDef: e }))
          : null;
      }),
      (this.ListDefinition = () => {
        this.AnyWhitespace();
      ...
      (this.ListElementDefinition = () => {
        ...
        return (e && this.Error("Expected closing ')'"), new Mt(n, t, i));
      }),
      (this.ConstDeclaration = () => {
        ...
        (this.Whitespace(),
          ...
          this.Whitespace());
        const e = this.Expect(this.Expression, "initial value for ");
        if (e instanceof B || e instanceof vt || e instanceof se) {
          if (e instanceof se) {
            e.isSingleString ||
              this.Error("Constant strings cannot contain any logic.");
          }
      ...
      (this.Glue = () =>
        null !== this.ParseString("<>") ? new Rt(new kt()) : null),
      (this.InlineLogic = () => {
        if (null === this.ParseString("{")) return null;
      ...
      (this.SequenceTypeAnnotation = () => {
        ...
        switch (t) {
          ...
          case bt.Stopping:
          case bt.Shuffle:
          case bt.Shuffle | bt.Stopping:
          case bt.Shuffle | bt.Once:
            break;
          default:
            return (
      ...
      (this.SingleMultilineSequenceElement = () => {
        ...
        if (null === this.ParseString("-")) return null;
        this.Whitespace();
        const t = this.StatementsAtLevel(Gt.InnerBlock);
        return (
          null === t ? this.MultilineWhitespace() : t.unshift(new it("\n")),
          new dt(t)
        );
      }),
      ...
      (this.GenerateStatementLevelRules = () => {
        ...
        for (const e of t) {
          ...
          (t.push(this.Line(this.MultiDivert)),
            e >= Gt.Top && t.push(this.KnotDefinition),
            t.push(this.Line(this.Choice)),
            t.push(this.Line(this.AuthorWarning)),
            e > Gt.InnerBlock && t.push(this.Gather),
            e >= Gt.Knot && t.push(this.StitchDefinition),
            ...
            e <= Gt.Knot && n.push(this.KnotDeclaration),
            e <= Gt.Stitch && n.push(this.StitchDeclaration),
            e <= Gt.InnerBlock &&
      ...
      (this.StartTag = () => {
        ...
        if (this.tagActive) {
          let e = new dt();
          (e.AddContent(new ae(!1)), e.AddContent(new ae(!0)), (t = e));
        } else t = new ae(!0);
        return ((this.tagActive = !0), this.Whitespace(), t);
      }),
      (this._inlineWhitespaceChars = new $(" \t")),
      (this.EndOfLine = () => this.OneOf([this.Newline, this.EndOfFile])),
      (this.Newline = () => {
        this.Whitespace();
        return null !== this.ParseNewline() ? Q : null;
      }),
      (this.EndOfFile = () => (this.Whitespace(), this.endOfInput ? Q : null)),
      (this.MultilineWhitespace = () => {
        let t = this.OneOrMore(this.Newline);
        if (null === t) return null;
        return t.length >= 1 ? Q : null;
      }),
      (this.Whitespace = () =>
      ...
      (this._fileHandler = null === l ? new oe() : l),
      null === o)
    ) {
      if (
  ...
  PreProcessInputString(t) {
    return new et(t).Process();
  }
  get parsingStringExpression() {
    return this.GetFlag(Number(Nt.ParsingString));
  }
  set parsingStringExpression(t) {
    this.SetFlag(Number(Nt.ParsingString), t);
  }
  get tagActive() {
    return this.GetFlag(Number(Nt.TagActive));
  }
  set tagActive(t) {
    this.SetFlag(Number(Nt.TagActive), t);
  }
  get identifierCharSet() {
    return (
      null === this._identifierCharSet &&
        ((this._identifierCharSet = new $())
          .AddRange("A", "Z")
          .AddRange("a", "z")
          .AddRange("0", "9")
          .Add("_"),
  ...
  EndTagIfNecessary(t) {
    this.tagActive &&
      (null != t &&
        (t instanceof dt ? t.AddContent(new ae(!1)) : t.push(new ae(!1))),
      (this.tagActive = !1));
  }
}
((le.LatinBasic = q.Define("A", "z", new $().AddRange("[", "`"))),
  (le.LatinExtendedA = q.Define("Ā", "ſ")),
  (le.LatinExtendedB = q.Define("ƀ", "ɏ")),
  (le.Greek = q.Define(
    "Ͱ",
    "Ͽ",
    new $().AddRange("͸", "΅").AddCharacters("ʹ͵͸·΋΍΢"),
  )),
  (le.Cyrillic = q.Define("Ѐ", "ӿ", new $().AddRange("҂", "҉"))),
  (le.Armenian = q.Define(
    "԰",
    "֏",
    new $().AddCharacters("԰").AddRange("՗", "ՠ").AddRange("ֈ", "֎"),
  )),
  (le.Hebrew = q.Define("֐", "׿", new $())),
  (le.Arabic = q.Define("؀", "ۿ", new $())),
  (le.Korean = q.Define("가", "힯", new $())),
  (le.Latin1Supplement = q.Define("", "ÿ", new $())),
  (le.Chinese = q.Define("一", "鿿", new $())),
  (le.ListAllCharacterRanges = () => [
    le.LatinBasic,
    le.LatinExtendedA,
    le.LatinExtendedB,
    le.Arabic,
  ...
  constructor(i) {
    ...
    ((this._errors = []),
      ...
      (this.RetrieveDebugSourceForLatestContent = () => {
        var t;
        for (const n of this.runtimeStory.state.outputStream) {
          const i = r(n, I);
          if (null !== i) {
            const n = new e(
              (null === (t = i.value) || void 0 === t ? void 0 : t.length) || 0,
              i.debugMetadata,
              i.value || "unknown",
            );
            this.debugSourceRanges.push(n);
          }
        }
      }),
      (this.GenerateStats = () =>
        null === this._parsedStory
          ...
          : (function (t) {
              ...
              const i = t.FindAll(jt)(),
                r = t.FindAll($t)(),
                s = t.FindAll(X)(),
                a = t.FindAll(at)((t) => null != t.debugMetadata),
                o = t.FindAll(Ct)();
              return {
                words: n,
                knots: i.length,
...
export {
  ...
  w as InkList,
  le as InkParser,
  he as JsonFileHandler,
  Gt as StatementLevel,
  ie as Story,
};
