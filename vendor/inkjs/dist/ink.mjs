...
class p {
      ...
      if (null == this.parent) this._path = new t();
        ...
        for (; null !== i;) {
          ...
          if (null != r && r.hasValidName) {
            if (null === r.name) return d("namedChild.name");
            e.unshift(new t.Component(r.name));
          } else e.unshift(new t.Component(i.content.indexOf(n)));
          ((n = i), (i = a(i.parent, A)));
        }
        this._path = new t(e);
      }
    ...
    if (t.isRelative) {
      ...
      return (
        null === n &&
          ...
          (n = a(this.parent, A)),
          e.Assert(null !== n, "Expected parent to be a container"),
          e.Assert(t.GetComponent(0).isParent),
          (t = t.tail)),
        null === n ? d("nearestContainer") : n.ContentAtPath(t)
      );
    }
    {
      let e = this.rootContentContainer;
  ...
  ConvertPathToRelative(e) {
    ...
    let a = n.componentCount - 1 - r,
      s = [];
    for (let e = 0; e < a; ++e) s.push(t.Component.ToParent());
    for (let t = r + 1; t < e.componentCount; ++t) s.push(e.GetComponent(t));
    return new t(s, !0);
  }
  CompactPathString(t) {
    let e = null,
...
class g extends Map {
  constructor() {
    if (
      (super(arguments[0] instanceof g ? arguments[0] : []),
      (this.origins = null),
      (this._originNames = []),
      ...
      if ((this.SetInitialOriginName(t), null === e.listDefinitions))
        return d("originStory.listDefinitions");
      ...
      if (null === n.result) return d("def.result");
  ...
  static FromString(t, e) {
    var n;
    if (null == t || "" == t) return new g();
    let i =
      null === (n = e.listDefinitions) || void 0 === n
        ? void 0
        : n.FindSingleItemListWithName(t);
    if (i) return null === i.value ? d("listValue.value") : new g(i.value);
    throw new Error(
  ...
  AddItem(t) {
    ...
    if (null !== t) {
      ...
      if (null == i) {
        ...
        {
          let t = g.FromString(n, e).orderedItems[0];
          this.Add(t.Key, t.Value);
        }
      } else {
        let t = new f(i.name, n),
          e = i.ValueForItem(t);
        this.Add(t, e);
      }
    }
  ...
  ListWithSubRange(t, e) {
    ...
    (Number.isInteger(t)
      ? (i = t)
      : t instanceof g && t.Count > 0 && (i = t.minItem.Value),
      Number.isInteger(e)
        ? (r = e)
        : e instanceof g && e.Count > 0 && (r = e.maxItem.Value));
    let a = new g();
...
class v extends p {
  static Create(e, i) {
    if (i) {
      if (i === n.Int && Number.isInteger(Number(e))) return new _(Number(e));
      if (i === n.Float && !isNaN(e)) return new w(Number(e));
    }
  ...
  Copy() {
    return s(v.Create(this.valueObject), p);
  }
  BadCastException(t) {
    return new S(
...
class b extends C {
  ...
  Cast(t) {
    ...
    if (t == n.Int) return new _(this.value ? 1 : 0);
    if (t == n.Float) return new w(this.value ? 1 : 0);
    if (t == n.String) return new T(this.value ? "true" : "false");
...
class _ extends C {
  ...
  Cast(t) {
    if (null === this.value) return d("Value.value");
    if (t == this.valueType) return this;
    if (t == n.Bool) return new b(0 !== this.value);
    if (t == n.Float) return new w(this.value);
    if (t == n.String) return new T("" + this.value);
    throw this.BadCastException(t);
  }
}
class w extends C {
  ...
  Cast(t) {
    ...
    if (t == this.valueType) return this;
    if (t == n.Bool) return new b(0 !== this.value);
    if (t == n.Int) return new _(this.value);
    if (t == n.String) return new T("" + this.value);
    throw this.BadCastException(t);
  }
}
...
class P extends C {
  ...
  Copy() {
    return new P(this.variableName, this.contextIndex);
  }
}
class N extends C {
  get isTruthy() {
  ...
  Cast(t) {
    ...
    if (t == n.String) {
      let t = this.value.maxItem;
      return t.Key.isNull ? new T("") : new T(t.Key.toString());
    }
    if (t == this.valueType) return this;
    throw this.BadCastException(t);
  }
    ...
    (super(null),
      t || e
        ? t instanceof g
          ...
          : t instanceof f &&
            "number" == typeof e &&
            (this.value = new g({ Key: t, Value: e }))
        : (this.value = new g()));
  }
...
class A extends p {
  ...
  get countFlags() {
    let t = 0;
    return (
      this.visitsShouldBeCounted && (t |= A.CountFlags.Visits),
      this.turnIndexShouldBeCounted && (t |= A.CountFlags.Turns),
      this.countingAtStartOnly && (t |= A.CountFlags.CountStartOnly),
      t == A.CountFlags.CountStartOnly && (t = 0),
      t
    );
  }
  set countFlags(t) {
    let e = t;
    ((e & A.CountFlags.Visits) > 0 && (this.visitsShouldBeCounted = !0),
      (e & A.CountFlags.Turns) > 0 && (this.turnIndexShouldBeCounted = !0),
      (e & A.CountFlags.CountStartOnly) > 0 && (this.countingAtStartOnly = !0));
  }
  ...
  get internalPathToFirstLeafContent() {
    let e = [],
      n = this;
    for (; n instanceof A;)
      n.content.length > 0 && (e.push(new t.Component(0)), (n = n.content[0]));
    return new t(e);
  }
  AddContent(t) {
  ...
  BuildStringOfHierarchy() {
    ...
    for (let e = 0; e < this.content.length; ++e) {
      ...
      if (a instanceof A) {
        a.BuildStringOfHierarchy(t, n, i);
      } else
        (r(),
          a instanceof T
            ? (t.Append('"'),
              ...
              t.Append('"'))
            : t.Append(a.toString()));
      (e != this.content.length - 1 && t.Append(","),
        a instanceof A || a != i || t.Append("  <---"),
        t.AppendLine());
    }
    let a = new Map();
    for (let [t, e] of this.namedContent)
      this.content.indexOf(s(e, p)) >= 0 || a.set(t, e);
    if (a.size > 0) {
      (r(), t.AppendLine("-- named: --"));
      for (let [, r] of a) {
        (e.AssertType(r, A, "Can only print out named Containers"),
          r.BuildStringOfHierarchy(t, n, i),
          t.AppendLine());
      }
    }
    (n--, r(), t.Append("]"));
  ...
  get targetPointer() {
    if (this._targetPointer.isNull) {
      ...
      if (null === this._targetPath.lastComponent)
        return d("this._targetPath.lastComponent");
      if (this._targetPath.lastComponent.isIndex) {
        if (null === t) return d("targetObj");
        ((this._targetPointer.container =
          t.parent instanceof A ? t.parent : null),
          (this._targetPointer.index = this._targetPath.lastComponent.index));
      } else this._targetPointer = k.StartOf(t instanceof A ? t : null);
    }
...
class R extends p {
    ...
    ((this._name = t),
      this._isPrototype ||
        (null === R._nativeFunctions
          ...
          : (this._prototype = R._nativeFunctions.get(this._name) || null)));
  }
  ...
  CallType(t) {
    ...
    if (2 == a || 1 == a) {
      if (null === this._operationFuncs)
        return d("NativeFunctionCall._operationFuncs");
      let l = this._operationFuncs.get(i);
      if (!l) {
        const t = n[i];
        throw new S("Cannot perform operation " + this.name + " on " + t);
      }
      if (2 == a) {
        let e = s(t[1], C),
          n = l;
        if (null === r.value || null === e.value)
          return d("NativeFunctionCall.Call BinaryOp values");
        let i = n(r.value, e.value);
        return C.Create(i);
      }
      {
        let t = l;
        if (null === r.value) return d("NativeFunctionCall.Call UnaryOp value");
        let i = t(r.value);
        return this.name === R.Int
          ? C.Create(i, n.Int)
          : this.name === R.Float
            ? C.Create(i, n.Float)
            : C.Create(i, e.valueType);
      }
    }
    throw new Error(
  ...
  CallBinaryListOperation(t) {
    ...
    if (!(
      ("&&" != this.name && "||" != this.name) ||
      (e.valueType == n.List && i.valueType == n.List)
    )) {
      if (null === this._operationFuncs)
        return d("NativeFunctionCall._operationFuncs");
      let t = this._operationFuncs.get(n.Int);
      if (null === t) return d("NativeFunctionCall.CallBinaryListOperation op");
      let r = (function (t) {
        if ("boolean" == typeof t) return t;
        throw new Error(`${t} is not a boolean`);
      })(t(e.isTruthy ? 1 : 0, i.isTruthy ? 1 : 0));
      return new b(r);
    }
    if (e.valueType == n.List && i.valueType == n.List)
      return this.CallType([e, i]);
    throw new S(
      "Can not call use " +
        this.name +
        " operation on " +
  ...
  CallListIncrementOperation(t) {
    let e = s(t[0], N),
      ...
      r = new g();
    if (null === e.value)
      return d("NativeFunctionCall.CallListIncrementOperation listVal.value");
    for (let [t, a] of e.value) {
      let s = f.fromSerializedKey(t);
      if (null === this._operationFuncs)
        return d("NativeFunctionCall._operationFuncs");
      let l = this._operationFuncs.get(n.Int);
      if (null === i.value)
        return d("NativeFunctionCall.CallListIncrementOperation intVal.value");
      let o = l(a, i.value),
        h = null;
      ...
      if (null != h) {
        let t = h.TryGetItemWithValue(o, f.Null);
  ...
  CoerceValuesToSingleType(t) {
    ...
    for (let r of t) {
      ...
      (t.valueType > e && (e = t.valueType),
        t.valueType == n.List && (i = a(t, N)));
    }
    let r = [];
    if (n[e] == n[n.List])
      for (let e of t) {
        let t = s(e, C);
        if (t.valueType == n.List) r.push(t);
        else {
          if (t.valueType != n.Int) {
            const e = n[t.valueType];
            throw new S(
          ...
          }
          {
            ...
            if (((i = s(i, N)), null === i.value))
              return d(
                "NativeFunctionCall.CoerceValuesToSingleType specialCaseList.value",
              );
            let n = i.value.originOfMaxItem;
            if (null === n)
              return d("NativeFunctionCall.CoerceValuesToSingleType list");
            let a = n.TryGetItemWithValue(e, f.Null);
            if (!a.exists)
              throw new S(
  ...
  constructor() {
    if (
      ...
      let t = arguments[0];
      (R.GenerateNativeFunctionsIfNecessary(), (this.name = t));
  ...
  static GenerateNativeFunctionsIfNecessary() {
    if (null == this._nativeFunctions) {
      ...
      let t = (t, e) => t.Equals(e),
        e = (t, e) => !t.Equals(e);
      (this.AddOpToNativeFunc(this.Equal, 2, n.DivertTarget, t),
        this.AddOpToNativeFunc(this.NotEquals, 2, n.DivertTarget, e));
    }
  }
  ...
  static AddOpToNativeFunc(t, e, n, i) {
    if (null === this._nativeFunctions)
      return d("NativeFunctionCall._nativeFunctions");
    let r = this._nativeFunctions.get(t);
    (r || ((r = new R(t, e)), this._nativeFunctions.set(t, r)),
...
((R.Add = "+"),
  ...
  (R.All = "LIST_ALL"),
  (R.Count = "LIST_COUNT"),
  (R.ValueOfList = "LIST_VALUE"),
  (R.Invert = "LIST_INVERT"),
  (R._nativeFunctions = null));
class j extends p {
  constructor(t) {
...
class G {
  ...
  TryGetItemWithValue(t, e) {
    for (let [e, n] of this._itemNameToValues)
      if (n == t) return { result: new f(this.name, e), exists: !0 };
    return { result: f.Null, exists: !1 };
  }
...
class J {
  ...
  static WriteRuntimeObject(t, e) {
    ...
    if (r) {
      ...
      return (
        r.isExternal
          ? (n = "x()")
          : r.pushesToStack &&
            (r.stackPushType == i.Function
              ? (n = "f()")
              : r.stackPushType == i.Tunnel && (n = "->t->")),
        (e = r.hasVariableTarget ? r.variableDivertName : r.targetPathString),
        t.WriteObjectStart(),
        t.WriteProperty(n, e),
    ...
    if (p)
      return (
        t.WriteObjectStart(),
        null === p.value
          ? d("divTargetVal.value")
          : (t.WriteProperty("^->", p.value.componentsString),
            void t.WriteObjectEnd())
      );
    let m = a(e, P);
    if (m)
    ...
    if (a(e, x)) return void t.Write("<>");
    let f = a(e, I);
    if (f) return void t.Write(J._controlCommandNames[f.commandType]);
    let g = a(e, R);
    if (g) {
      let e = g.name;
    ...
    if (a(e, D)) return void t.Write("void");
    let v = a(e, j);
    if (v)
      return (
        t.WriteObjectStart(),
  ...
  static JTokenToRuntimeObject(e) {
    if (("number" == typeof e && !isNaN(e)) || "boolean" == typeof e)
      return C.Create(e);
    if ("string" == typeof e) {
      let t = e.toString();
      const n = /^([0-9]+.[0-9]+f)$/.exec(t);
      if (n) return new w(parseFloat(n[0]));
      let i = t[0];
      if ("^" == i) return new T(t.substring(1));
      if ("\n" == i && 1 == t.length) return new T("\n");
      if ("<>" == t) return new x();
      for (let e = 0; e < J._controlCommandNames.length; ++e) {
        if (t == J._controlCommandNames[e]) return new I(e);
      }
      if (("L^" == t && (t = "^"), R.CallExistsWithName(t)))
        return R.CallWithName(t);
      if ("->->" == t) return I.PopTunnel();
      if ("~ret" == t) return I.PopFunction();
      if ("void" == t) return new D();
    }
    if ("object" == typeof e && !Array.isArray(e)) {
      let n,
        r = e;
      if (r["^->"]) return ((n = r["^->"]), new E(new t(n.toString())));
      if (r["^var"]) {
        n = r["^var"];
        let t = new P(n.toString());
      ...
      if (
        ((n = r["->"])
          ? (a = !0)
          : (n = r["f()"])
            ? ((a = !0), (s = !0), (l = i.Function))
            : (n = r["->t->"])
              ? ((a = !0), (s = !0), (l = i.Tunnel))
              : (n = r["x()"]) &&
                ((a = !0), (o = !0), (s = !1), (l = i.Function)),
        a)
      ) {
        let t = new F();
        ...
        let e = n.toString();
        return (
          (n = r.var) ? (t.variableDivertName = e) : (t.targetPathString = e),
          (t.isConditional = !!r.c),
          o && (n = r.exArgs) && (t.externalArgs = parseInt(n)),
          t
        );
      }
      if ((n = r["*"])) {
        ...
        return (
          ...
          (n = r.flg) && (t.flags = parseInt(n)),
          t
        );
      }
      if ((n = r["VAR?"])) return new V(n.toString());
      if ((n = r["CNT?"])) {
        let t = new V();
    ...
    if (Array.isArray(e)) return this.JArrayToContainer(e);
    if (null == e) return null;
    throw new Error(
      "Failed to convert token to runtime object: " +
        this.toJson(e, ["parent"]),
    );
  }
  static toJson(t, e, n) {
    return JSON.stringify(
  ...
  static WriteRuntimeContainer(t, e) {
    ...
    if ((t.WriteArrayStart(), null === e)) return d("container");
...
J._controlCommandNames = (() => {
  let t = [];
  ((t[I.CommandType.EvalStart] = "ev"),
    (t[I.CommandType.EvalOutput] = "out"),
    (t[I.CommandType.EvalEnd] = "/ev"),
    (t[I.CommandType.Duplicate] = "du"),
    (t[I.CommandType.PopEvaluatedValue] = "pop"),
    (t[I.CommandType.PopFunction] = "~ret"),
    (t[I.CommandType.PopTunnel] = "->->"),
    (t[I.CommandType.BeginString] = "str"),
    (t[I.CommandType.EndString] = "/str"),
    (t[I.CommandType.NoOp] = "nop"),
    (t[I.CommandType.ChoiceCount] = "choiceCnt"),
    (t[I.CommandType.Turns] = "turn"),
    (t[I.CommandType.TurnsSince] = "turns"),
    (t[I.CommandType.ReadCount] = "readc"),
    (t[I.CommandType.Random] = "rnd"),
    (t[I.CommandType.SeedRandom] = "srnd"),
    (t[I.CommandType.VisitIndex] = "visit"),
    (t[I.CommandType.SequenceShuffleIndex] = "seq"),
    (t[I.CommandType.StartThread] = "thread"),
    (t[I.CommandType.Done] = "done"),
    (t[I.CommandType.End] = "end"),
    (t[I.CommandType.ListFromInt] = "listInt"),
    (t[I.CommandType.ListRange] = "range"),
    (t[I.CommandType.ListRandom] = "lrnd"),
    (t[I.CommandType.BeginTag] = "#"),
    (t[I.CommandType.EndTag] = "/#"));
  for (let e = 0; e < I.CommandType.TOTAL_VALUES; ++e)
    if (null == t[e])
...
class q {
  ...
  Reset() {
    ((this._threads = []),
      this._threads.push(new q.Thread()),
      this._threads[0].callstack.push(
        new q.Element(i.Tunnel, this._startOfRoot),
      ));
  }
  SetJsonToken(t, e) {
    this._threads.length = 0;
  ...
  Push(t) {
    let e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
      ...
      i = new q.Element(t, this.currentElement.currentPointer, !1);
  ...
  SetTemporaryVariable(t, e, n) {
    ...
    let a = y(r.temporaryVariables, t, null);
  ...
  get callStackTrace() {
    ...
    for (let e = 0; e < this._threads.length; e++) {
      ...
      for (let e = 0; e < n.callstack.length; e++) {
        n.callstack[e].type == i.Function
          ? t.Append("  [FUNCTION] ")
          : t.Append("  [TUNNEL] ");
        let r = n.callstack[e].currentPointer;
        if (!r.isNull) {
          if ((t.Append("<SOMEWHERE IN "), null === r.container))
            return d("pointer.container");
  ...
  class i {
    constructor() {
      if (
        ...
        let e = arguments[0],
          i = arguments[1];
        this.threadIndex = parseInt(e.threadIndex);
        let r = e.callstack;
        for (let e of r) {
          let r,
            a = e,
          ...
          let h = !!a.exp,
            ...
            c = a.temp;
          (void 0 !== c
            ? (u.temporaryVariables = J.JObjectToDictionaryRuntimeObjs(c))
            : u.temporaryVariables.clear(),
            this.callstack.push(u));
        }
        let a = e.previousContentObject;
        if (void 0 !== a) {
          let e = new t(a.toString());
          this.previousPointer = i.PointerAtPath(e);
        }
      }
    }
    Copy() {
      ...
      for (let e of this.callstack) {
        if ((t.WriteObjectStart(), !e.currentPointer.isNull)) {
          if (null === e.currentPointer.container)
            return d("el.currentPointer.container");
          (t.WriteProperty(
            "cPath",
        ...
        (t.WriteProperty("exp", e.inExpressionEvaluation),
          ...
          e.temporaryVariables.size > 0 &&
            ...
            J.WriteDictionaryRuntimeObjs(t, e.temporaryVariables),
            t.WritePropertyEnd()),
          t.WriteObjectEnd());
      }
      if (
...
class U extends class {} {
  ...
  SetJsonToken(t) {
    ...
    for (let [e, n] of this._defaultGlobalVariables) {
      let i = t[e];
      if (void 0 !== i) {
        let t = J.JTokenToRuntimeObject(i);
        if (null === t) return d("tokenInkObject");
  ...
  WriteJson(t) {
    ...
    for (let [e, n] of this._globalVariables) {
      let i = e,
        r = n;
      if (U.dontSaveDefaultValues && this._defaultGlobalVariables.has(i)) {
        let t = this._defaultGlobalVariables.get(i);
        if (this.RuntimeObjectsEqual(r, t)) continue;
      }
      (t.WritePropertyStart(i),
        J.WriteRuntimeObject(t, r),
        t.WritePropertyEnd());
    }
    t.WriteObjectEnd();
  }
  RuntimeObjectsEqual(t, e) {
    if (null === t) return d("obj1");
    if (null === e) return d("obj2");
    if (t.constructor !== e.constructor) return !1;
    let n = a(t, b);
    if (null !== n) return n.value === s(e, b).value;
    let i = a(t, _);
    if (null !== i) return i.value === s(e, _).value;
    let r = a(t, w);
    if (null !== r) return r.value === s(e, w).value;
    let l = a(t, C),
      o = a(e, C);
    if (null !== l && null !== o)
      return h(l.valueObject) && h(o.valueObject)
        ? l.valueObject.Equals(o.valueObject)
        : l.valueObject === o.valueObject;
    throw new Error(
  ...
  GetRawVariableWithName(t, e) {
    ...
    if (0 == e || -1 == e) {
      ...
      if (
        ...
        return e.result;
      if (((e = y(this._globalVariables, t, null)), e.exists)) return e.result;
      if (
        null !== this._defaultGlobalVariables &&
        ((e = y(this._defaultGlobalVariables, t, null)), e.exists)
      )
        return e.result;
      if (null === this._listDefsOrigin)
        return d("VariablesState._listDefsOrigin");
  ...
  Assign(t, e) {
    ...
    if (
      ...
      let t = null;
      do {
        ((t = a(this.GetRawVariableWithName(n, i), P)),
          null != t &&
  ...
  SetGlobal(t, e) {
    let n = null;
    if (
      (null === this.patch && (n = y(this._globalVariables, t, null)),
      null !== this.patch &&
        ((n = this.patch.TryGetGlobal(t, null)),
        n.exists || (n = y(this._globalVariables, t, null))),
    ...
    if (
      ...
      if (this._batchObservingVariableChanges) {
        if (null === this._changedVariablesForBatchObs)
          return d("this._changedVariablesForBatchObs");
        null !== this.patch
  ...
  ResolveVariablePointer(t) {
    ...
    let n = a(this.GetRawVariableWithName(t.variableName, e), P);
    return null != n ? n : new P(t.variableName, e);
  }
...
class H {
  static TextToDictionary(t) {
    return new H.Reader(t).ToDictionary();
  }
  static TextToArray(t) {
    return new H.Reader(t).ToArray();
  }
}
!(function (t) {
  t.Reader = class {
...
class $ {
  constructor() {
    let t = arguments[0],
      e = arguments[1];
    if (((this.name = t), (this.callStack = new q(e)), arguments[2])) {
      let t = arguments[2];
      (this.callStack.SetJsonToken(t.callstack, e),
        (this.outputStream = J.JArrayToRuntimeObjList(t.outputStream)),
        (this.currentChoices = J.JArrayToRuntimeObjList(t.currentChoices)));
  ...
  WriteJson(t) {
    (t.WriteObjectStart(),
      ...
      t.WriteProperty("outputStream", (t) =>
        J.WriteListRuntimeObjs(t, this.outputStream),
      ));
    let e = !1;
    for (let n of this.currentChoices) {
      if (null === n.threadAtGeneration) return d("c.threadAtGeneration");
    ...
    (e && (t.WriteObjectEnd(), t.WritePropertyEnd()),
      t.WriteProperty("currentChoices", (t) => {
        t.WriteArrayStart();
        for (let e of this.currentChoices) J.WriteChoice(t, e);
        t.WriteArrayEnd();
      }),
      t.WriteObjectEnd());
  }
  LoadFlowChoiceThreads(t, e) {
    for (let n of this.currentChoices) {
      ...
      if (null !== i) n.threadAtGeneration = i.Copy();
        ...
        n.threadAtGeneration = new q.Thread(i, e);
      }
    }
  }
}
class X {
  ...
  VisitCountAtPathString(e) {
    let n;
    if (null !== this._patch) {
      let i = this.story.ContentAtPath(new t(e)).container;
      if (null === i) throw new Error("Content at path not found: " + e);
      if (((n = this._patch.TryGetVisitCount(i, 0)), n.exists)) return n.result;
    }
    return ((n = y(this._visitCounts, e, null)), n.exists ? n.result : 0);
  }
    ...
    if (this._outputStreamTextDirty) {
      ...
      for (let n of this.outputStream) {
        ...
        if (e || null === i) {
          let t = a(n, I);
          null !== t &&
            (t.commandType == I.CommandType.BeginTag
              ? (e = !0)
              : t.commandType == I.CommandType.EndTag && (e = !1));
  ...
  get currentTags() {
    if (this._outputStreamTagsDirty) {
      ...
      for (let n of this.outputStream) {
        let i = a(n, I);
        if (null != i) {
          if (i.commandType == I.CommandType.BeginTag) {
            if (t && e.Length > 0) {
              let t = this.CleanOutputWhitespace(e.toString());
              (this._currentTags.push(t), e.Clear());
            }
            t = !0;
          } else if (i.commandType == I.CommandType.EndTag) {
            if (e.Length > 0) {
              let t = this.CleanOutputWhitespace(e.toString());
              (this._currentTags.push(t), e.Clear());
            }
  ...
  constructor(t) {
    ...
    ((this.storySeed = new K(e).next() % 100),
      (this.previousRandom = 0),
      this.GoToStart());
  }
  GoToStart() {
  ...
  RemoveFlow_Internal(t) {
    ...
    if (
      ...
      return d("this._namedFlows");
    (this._namedFlows.delete(t), (this._aliveFlowNamesDirty = !0));
  }
  CopyAndStartPatching(t) {
    let e = new X(this.story);
    if (
      ((e._patch = new z(this._patch)),
      (e._currentFlow.name = this._currentFlow.name),
      (e._currentFlow.callStack = new q(this._currentFlow.callStack)),
  ...
  WriteJson(t) {
    ...
    if (
      ...
      t.WriteProperty("evalStack", (t) =>
        J.WriteListRuntimeObjs(t, this.evaluationStack),
      ),
      !this.divertedPointer.isNull)
    ) {
    ...
    (t.WriteProperty("visitCounts", (t) =>
      J.WriteIntDictionary(t, this._visitCounts),
    ),
      t.WriteProperty("turnIndices", (t) =>
        J.WriteIntDictionary(t, this._turnIndices),
      ),
      ...
      t.WriteIntProperty("inkFormatVersion", Q.inkVersionCurrent),
      t.WriteObjectEnd());
  }
  LoadJsonObj(e) {
    let n = e,
    ...
    if (null != r) {
      ...
      ((this._namedFlows = null),
        ...
        (this._currentFlow.outputStream = J.JArrayToRuntimeObjList(
          n.outputStream,
        )),
        (this._currentFlow.currentChoices = J.JArrayToRuntimeObjList(
          n.currentChoices,
        )));
    ...
    (this.OutputStreamDirty(),
      ...
      (this.variablesState.callStack = this._currentFlow.callStack),
      (this._evaluationStack = J.JArrayToRuntimeObjList(n.evalStack)));
    let a = n.currentDivertTarget;
    if (null != a) {
      let e = new t(a.toString());
      this.divertedPointer = this.story.PointerAtPath(e);
    }
    ((this._visitCounts = J.JObjectToIntDictionary(n.visitCounts)),
      (this._turnIndices = J.JObjectToIntDictionary(n.turnIndices)),
  ...
  TrySplittingHeadTailWhitespace(t) {
    ...
    if (-1 != r && a > i && (s.push(new T("\n")), r < e.length - 1)) {
      let t = e.length - r - 1,
        n = new T(e.substring(r + 1, r + 1 + t));
      s.push(n);
    }
    return s;
  }
    ...
    if (e) (this.TrimNewlinesFromOutputStream(), (r = !0));
      ...
      for (let e = this.outputStream.length - 1; e >= 0; e--) {
        let n = this.outputStream[e],
          i = n instanceof I ? n : null;
        if (null != (n instanceof x ? n : null)) {
          a = e;
          break;
        }
        if (null != i && i.commandType == I.CommandType.BeginString) {
          e >= t && (t = -1);
          break;
        }
      }
  ...
  TrimNewlinesFromOutputStream() {
    ...
    if (t >= 0)
      for (e = t; e < this.outputStream.length;) {
        a(this.outputStream[e], T) ? this.outputStream.splice(e, 1) : e++;
      }
    this.OutputStreamDirty();
  }
  RemoveExistingGlue() {
    for (let t = this.outputStream.length - 1; t >= 0; t--) {
      ...
      if (e instanceof x) this.outputStream.splice(t, 1);
      else if (e instanceof I) break;
    }
    this.OutputStreamDirty();
  }
  get outputStreamEndsInNewline() {
    if (this.outputStream.length > 0)
      for (let t = this.outputStream.length - 1; t >= 0; t--) {
        if (this.outputStream[t] instanceof I) break;
        let e = this.outputStream[t];
        if (e instanceof T) {
  ...
  get outputStreamContainsContent() {
    for (let t of this.outputStream) if (t instanceof T) return !0;
    return !1;
  }
  get inStringEvaluation() {
    for (let t = this.outputStream.length - 1; t >= 0; t--) {
      let e = a(this.outputStream[t], I);
      if (e instanceof I && e.commandType == I.CommandType.BeginString)
        return !0;
    }
    return !1;
  }
      ...
      if (null != t.originNames) {
        ...
        for (let e of t.originNames) {
          if (null === this.story.listDefinitions)
            return d("StoryState.story.listDefinitions");
  ...
  PopCallStack() {
    let t =
      arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
    (this.callStack.currentElement.type == i.Function &&
  ...
  PassArgumentsToEvaluationStack(t) {
    if (null !== t)
      for (let e = 0; e < t.length; e++) {
        ...
        this.PushEvaluationStack(C.Create(t[e]));
      }
  }
  TryExitFunctionEvaluationFromGame() {
    return (
      this.callStack.currentElement.type == i.FunctionEvaluationFromGame &&
      ((this.currentPointer = k.Null), (this.didSafeExit = !0), !0)
    );
  }
  CompleteFunctionEvaluationFromGame() {
    if (this.callStack.currentElement.type != i.FunctionEvaluationFromGame)
      throw new Error(
    ...
    if ((this.PopCallStack(i.FunctionEvaluationFromGame), e)) {
      ...
      let t = s(e, C);
      return t.valueType == n.DivertTarget
...
class Q extends p {
  ...
  constructor() {
    ...
    if (arguments[0] instanceof A)
      ...
      let t = arguments[0];
      n = H.TextToDictionary(t);
    } else n = arguments[0];
    if (
      (null != e && (this._listDefinitions = new M(e)),
      ...
      i != Q.inkVersionCurrent &&
        console.warn(
          `WARNING: Version of ink ${Q.inkVersionCurrent} used to build story doesn't match current version of engine (${i}). Non-critical, but recommend synchronising.`,
        );
      let r,
        a = t.root;
      if (null == a)
      ...
      ((r = t.listDefs) &&
        (this._listDefinitions = J.JTokenToListDefinitions(r)),
        (this._mainContentContainer = s(J.JTokenToRuntimeObject(a), A)),
        this.ResetState());
    }
  }
  ToJson(t) {
    let e = !1;
    if (
      (t || ((e = !0), (t = new H.Writer())),
      t.WriteObjectStart(),
      t.WriteIntProperty("inkVersion", Q.inkVersionCurrent),
      t.WriteProperty("root", (t) =>
        J.WriteRuntimeContainer(t, this._mainContentContainer),
      ),
  ...
  ResetGlobals() {
    if (this._mainContentContainer.namedContent.get("global decl")) {
      ...
      (this.ChoosePath(new t("global decl"), !1),
        this.ContinueInternal(),
        (this.state.currentPointer = e));
    }
  ...
  ContinueInternal() {
    ...
    if (
      ((!a && this.canContinue) ||
        ...
        this.canContinue ||
          ...
          0 != this.state.generatedChoices.length ||
            ...
            (this.state.callStack.CanPop(i.Tunnel)
              ? this.AddError(
                  "unexpectedly reached end of content. Do you need a '->->' to return from a tunnel?",
                )
              : this.state.callStack.CanPop(i.Function)
                ? this.AddError(
      ...
      if (this.state.hasError)
        for (let t of this.state.currentErrors) this.onError(t, r.Error);
      if (this.state.hasWarning)
        for (let t of this.state.currentWarnings) this.onError(t, r.Warning);
      this.ResetErrors();
    }
    null != s &&
      Object.keys(s).length > 0 &&
      this._state.variablesState.NotifyObservers(s);
  }
  ContinueSingleStep() {
    if (
      ...
      if (null !== this._stateSnapshotAtLastNewline) {
        if (null === this._stateSnapshotAtLastNewline.currentTags)
          return d("this._stateAtLastNewline.currentTags");
        ...
        if (
          t == Q.OutputStateChange.ExtendedBeyondNewline ||
          this._sawLookaheadUnsafeFunctionAfterNewline
        )
          return (this.RestoreStateSnapshot(), !0);
        t == Q.OutputStateChange.NewlineRemoved && this.DiscardSnapshot();
      }
  ...
  CalculateNewlineOutputStateChange(t, e, n, i) {
    ...
    if (n == i && t.length == e.length && r)
      return Q.OutputStateChange.NoChange;
    if (!r) return Q.OutputStateChange.NewlineRemoved;
    if (i > n) return Q.OutputStateChange.ExtendedBeyondNewline;
    for (let n = t.length; n < e.length; n++) {
      let t = e.charAt(n);
      if (" " != t && "\t" != t)
        return Q.OutputStateChange.ExtendedBeyondNewline;
    }
    return Q.OutputStateChange.NoChange;
  }
  ContinueMaximally() {
  ...
  Step() {
    ...
    let l = a(i, I);
    l &&
      l.commandType == I.CommandType.StartThread &&
  ...
  VisitChangedContainersDueToDivert() {
    ...
    if (((this._prevContainers.length = 0), !t.isNull)) {
      let e = a(t.Resolve(), A) || a(t.container, A);
      for (; e;) (this._prevContainers.push(e), (e = a(e.parent, A)));
    }
    let n = e.Resolve();
    if (null == n) return;
    let i = a(n.parent, A),
    ...
    for (
      ...
      (t || (r = !1), this.VisitContainer(i, t), (n = i), (i = a(i.parent, A)));
    }
  }
  PopChoiceStringAndTags(t) {
    let e = s(this.state.PopEvaluationStack(), T);
    for (
      ;
      this.state.evaluationStack.length > 0 &&
      null != a(this.state.PeekEvaluationStack(), j);
    ) {
      let e = a(this.state.PopEvaluationStack(), j);
      e && t.push(e.text);
    }
    return e.value;
  }
    ...
    if (t instanceof I) {
      ...
      switch (e.commandType) {
        ...
        case I.CommandType.PopTunnel:
          let t =
              e.commandType == I.CommandType.PopFunction
                ? i.Function
                : i.Tunnel,
            n = null;
          if (t == i.Tunnel) {
          ...
          if (
            ...
            let e = new Map();
            (e.set(i.Function, "function return statement (~ return)"),
              e.set(i.Tunnel, "tunnel onwards statement (->->)"));
        ...
        case I.CommandType.EndString: {
          ...
          for (let i = this.state.outputStream.length - 1; i >= 0; --i) {
            ...
            n++;
            let s = a(r, I);
            if (s && s.commandType == I.CommandType.BeginString) break;
            (r instanceof j && e.push(r), r instanceof T && t.push(r));
          }
          ...
          ((this.state.inExpressionEvaluation = !0),
            this.state.PushEvaluationStack(new T(i.toString())));
          break;
        }
        case I.CommandType.ChoiceCount:
          let r = this.state.generatedChoices.length;
          this.state.PushEvaluationStack(new _(r));
          break;
        case I.CommandType.Turns:
          this.state.PushEvaluationStack(
            new _(this.state.currentTurnIndex + 1),
          );
          break;
        ...
        case I.CommandType.ReadCount:
          ...
          let o,
            h = s(l, E),
            u = a(this.ContentAtPath(h.targetPath).correctObj, A);
          (null != u
            ? (o =
                e.commandType == I.CommandType.TurnsSince
                  ? this.state.TurnsSinceForContainer(u)
                  : this.state.VisitCountForContainer(u))
            : ((o = e.commandType == I.CommandType.TurnsSince ? -1 : 0),
              this.Warning(
            ...
            this.state.PushEvaluationStack(new _(o)));
          break;
        case I.CommandType.Random: {
          let t = a(this.state.PopEvaluationStack(), _),
            e = a(this.state.PopEvaluationStack(), _);
          if (null == e || e instanceof _ == !1)
            return this.Error(
              "Invalid value for minimum parameter of RANDOM(min, max)",
            );
          if (null == t || t instanceof _ == !1)
            return this.Error(
          ...
          let i = this.state.storySeed + this.state.previousRandom,
            r = new K(i).next(),
            s = (r % n) + e.value;
          (this.state.PushEvaluationStack(new _(s)),
            (this.state.previousRandom = r));
          break;
        }
        case I.CommandType.SeedRandom:
          let c = a(this.state.PopEvaluationStack(), _);
          if (null == c || c instanceof _ == !1)
            return this.Error("Invalid value passed to SEED_RANDOM");
          if (null === c.value) return d("minInt.value");
        ...
        case I.CommandType.VisitIndex:
          ...
          this.state.PushEvaluationStack(new _(p));
          break;
        case I.CommandType.SequenceShuffleIndex:
          let y = this.NextSequenceShuffleIndex();
          this.state.PushEvaluationStack(new _(y));
          break;
        ...
        case I.CommandType.ListFromInt:
          let v = a(this.state.PopEvaluationStack(), _),
            b = s(this.state.PopEvaluationStack(), T);
          if (null === v)
            throw new S(
          ...
          let P = this.listDefinitions.TryListGetDefinition(b.value, null);
          if (!P.exists) throw new S("Failed to find LIST called " + b.value);
          {
            if (null === v.value) return d("minInt.value");
            let t = P.result.TryGetItemWithValue(v.value, f.Null);
            t.exists && (w = new N(t.result, v.value));
          }
          (null == w && (w = new N()), this.state.PushEvaluationStack(w));
          break;
        case I.CommandType.ListRange:
          let O = a(this.state.PopEvaluationStack(), C),
            x = a(this.state.PopEvaluationStack(), C),
            F = a(this.state.PopEvaluationStack(), N);
          if (null === F || null === x || null === O)
            throw new S("Expected list, minimum and maximum for LIST_RANGE");
          if (null === F.value) return d("targetList.value");
          let W = F.value.ListWithSubRange(x.valueObject, O.valueObject);
          this.state.PushEvaluationStack(new N(W));
          break;
        case I.CommandType.ListRandom: {
          let t = this.state.PopEvaluationStack();
          if (null === t) throw new S("Expected list for LIST_RANDOM");
          let e = t.value,
            n = null;
          ...
          if (0 == e.Count) n = new g();
            ...
            let s = a.next().value,
              l = { Key: f.fromSerializedKey(s[0]), Value: s[1] };
            if (null === l.Key.originName)
              return d("randomItem.Key.originName");
            ((n = new g(l.Key.originName, this)),
              n.Add(l.Key, l.Value),
  ...
  ChoosePathString(e) {
    ...
    if (
      ...
      null !== this.onChoosePathString && this.onChoosePathString(e, r),
      n)
    )
      this.ResetCallstack();
    ...
    (this.state.PassArgumentsToEvaluationStack(r), this.ChoosePath(new t(e)));
  }
  IfAsyncWeCant(t) {
  ...
  ChooseChoiceIndex(t) {
    ...
    return (
      ...
      null === n.threadAtGeneration
        ? d("choiceToChoose.threadAtGeneration")
        : null === n.targetPath
          ? d("choiceToChoose.targetPath")
  ...
  EvaluateExpression(t) {
    ...
    (this.state.callStack.Push(i.Tunnel),
  ...
  CallExternalFunction(t, e) {
    ...
    if (!a) {
      if (this.allowExternalFunctionFallbacks)
        return (
          ...
          void (this.state.divertedPointer = k.StartOf(r))
        );
      this.Assert(
        !1,
        "Trying to call EXTERNAL function '" +
    ...
    let l = [];
    for (let t = 0; t < e; ++t) {
      let t = s(this.state.PopEvaluationStack(), C).valueObject;
      l.push(t);
    }
    l.reverse();
    let o = n.function(l),
  ...
  ValidateExternalBindings() {
    ...
    if (
      (arguments[0] instanceof A && (t = arguments[0]),
      arguments[0] instanceof p && (e = arguments[0]),
      null === t && null === e)
    )
      if (
      ...
      for (let [, e] of t.namedContent)
        this.ValidateExternalBindings(a(e, p), n);
    } else if (null != e) {
      let t = a(e, F);
      if (t && t.isExternal) {
  ...
  TagsAtStartOfFlowContainerWithPathString(e) {
    ...
    for (let t of i.content) {
      let e = a(t, I);
      if (null != e)
        e.commandType == I.CommandType.BeginTag
          ? (r = !0)
          : e.commandType == I.CommandType.EndTag && (r = !1);
      else {
        if (!r) break;
        {
          let e = a(t, T);
  ...
  NextContent() {
    ...
    if (!this.IncrementContentPointer()) {
      let t = !1;
      (this.state.callStack.CanPop(i.Function)
        ? (this.state.PopCallStack(i.Function),
          this.state.inExpressionEvaluation &&
            this.state.PushEvaluationStack(new D()),
          (t = !0))
        : this.state.callStack.canPopThread
  ...
  IncrementContentPointer() {
    ...
    for (; e.index >= e.container.content.length;) {
      t = !1;
      let n = a(e.container.parent, A);
      if (n instanceof A == !1) break;
...
export { g as InkList, Q as Story };
