...
!(function (e, t) {
        ...
        t &&
          (n
            ? ((x = x || w(e)),
              ...
              x.appendChild(s))
            : (g || ((g = w(e)), Object.assign(g.style, l)),
    ...
    N = function _placeSiblings(e, t) {
      ...
      if ((d.length || d.push(w(e, 1), w(e, 2), w(e, 3)), (n = s ? x : g), s))
        (c
          ...
          (c || !e.getBoundingClientRect().width ? s : p).appendChild(n),
          n.setAttribute(
            "transform",
            "matrix(" +
              o.a +
  ...
  function _a(e) {
    ...
    xe
      ? ((_e = xe.plugins.inertia),
        (Ce = xe.core.context || function () {}),
        (c = xe.utils.checkPrefix),
        (O = c(O)),
        (Ye = c(Ye)),
        (Te = xe.utils.toArray),
        (Le = xe.core.getStyleSaver),
        (B = !!c("perspective")))
  ...
  function Draggable(h, p) {
    ...
    ((e = Ve.call(this) || this),
      be || _a(1),
      (h = Te(h)[0]),
      (e.styles = Le && Le(h, "transform,left,top")),
    ...
    function Bh(e, t) {
      ...
      (h._gsap || (se = xe.core.getCache(h)),
        ...
        W
          ...
          : Q
            ? (J.x = J.rotation = da(parseFloat(se.rotation)))
            : f
        ...
        (P || Y || k) &&
          ...
          (k &&
            ((He.x = J.x),
            (He.y = J.y),
            (n = k(He)).x !== J.x && ((J.x = n.x), (L = !0)),
            n.y !== J.y && ((J.y = n.y), (L = !0))),
          P &&
            (n = P(J.x)) !== J.x &&
            ((J.x = n), Q && (J.rotation = n), (L = !0)),
          Y && ((n = Y(J.y)) !== J.y && (J.y = n), (L = !0))),
        L && Ah(!0),
        e ||
          ((J.deltaX = J.x - r),
          (J.deltaY = J.y - i),
    ...
    function Ih(e) {
      var t,
        n = N;
      ((N = getGlobalMatrix(h.parentNode, !0)),
        e &&
          J.isPressed &&
          !N.equals(n || new ge()) &&
    ...
    function Jh() {
      ...
      (W &&
        ...
        (w = Ge.x),
        (b = Ge.y),
        L && (he(J.pointerX, J.pointerY), Ah(!0)),
        (d = getGlobalMatrix(h)),
        f
          ? (Eh(), (M = f.top()), (T = f.left()))
    ...
    function Mh(e, t) {
      ...
      if (
        ...
        if (
          ...
          (y = ae.call(J, e.target) && !1 === p.dragClickables && !t))
        )
          return (
        ...
        (Qa(J, "press", "onPress"),
          _e && _e.track(f || h, W ? "x,y" : Q ? "rotation" : "top,left"));
      }
    }
    function Qh(e) {
      if (e && J.isDragging && !f) {
    ...
    var u,
      ...
      he = function setPointerPosition(e, t, n) {
        ...
        ((J.pointerX = e),
          ...
          ce && ((e -= Ga(de)), (t -= Fa(de))),
          Q
            ? ((a = da(Math.atan2(C.y - t, e - C.x) * Ne)),
              180 < (l = J.y - a)
                ? ((M -= 360), (J.y = a))
                : l < -180 && ((M += 360), (J.y = a)),
              N &&
          ...
          (J.x === i && (J.y === a || Q)) ||
            (Q
              ? ((J.endRotation = J.x = J.endX = da(i)), (L = !0))
              : (U && ((J.y = J.endY = a), (L = !0)),
                K && ((J.x = J.endX = i), (L = !0))),
    ...
    return (
      ...
      (e.update = function (e, t, n) {
        if (t && J.isPressed) {
          if (Q) J.x = J.y = da(parseFloat(se.rotation));
          else {
        ...
        return (
          Ih(!t),
          e ? J.applyBounds() : (L && n && Ah(!0), Bh(!0)),
          t && (he(J.pointerX, J.pointerY), L && Ah(!0)),
          J.isPressed &&
            !t &&
