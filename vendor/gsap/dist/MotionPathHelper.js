(function (global, factory) {
  ...
  var _numbersExp = /(?:(-)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,
    ...
    _onPress = function _onPress(e) {
      ...
      if (_touchEventLookup[e.type]) {
        touchEventTarget =
          e.type.indexOf("touch") !== -1 ? e.currentTarget || e.target : _doc$1;
    ...
    function DraggableSVG(target, vars) {
      this.target =
        typeof target === "string"
          ? _doc$1.querySelectorAll(target)[0]
          : target;
      this.vars = vars || {};
  ...
  var gsap$1,
    ...
    _getPositionOnPage = function _getPositionOnPage(target) {
      var bounds = target.getBoundingClientRect(),
        windowOffsetY =
          _docEl.clientTop -
          (_win$2.pageYOffset || _docEl.scrollTop || _body$2.scrollTop || 0),
        windowOffsetX =
          _docEl.clientLeft -
          (_win$2.pageXOffset || _docEl.scrollLeft || _body$2.scrollLeft || 0);
      return {
  ...
  var MotionPathHelper = (function () {
    function MotionPathHelper(targetOrTween, vars) {
      ...
      (gsap$1.utils.toArray(vars.container)[0] || _body$2).appendChild(
        copyButton,
      );
