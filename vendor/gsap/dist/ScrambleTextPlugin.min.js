...
!(function (D, u) {
  ...
  function emojiSafeSplit(D, u, F, C, E) {
    if (
      ((D += ""),
      F && (D = D.trim ? D.trim() : D.replace(s, "")),
      u && "" !== u)
    )
      return D.replace(/>/g, "&gt;").replace(/</g, "&lt;").split(u);
    for (var e, t, i = [], n = D.length, r = 0; r < n; r++)
      (((55296 <= (t = D.charAt(r)).charCodeAt(0) &&
        t.charCodeAt(0) <= 56319) ||
        (65024 <= D.charCodeAt(r + 1) && D.charCodeAt(r + 1) <= 65039)) &&
        ((e = ((D.substr(r, 12).split(a) || [])[1] || "").length || 2),
        (t = D.substr(r, e)),
        (r += e - (i.emoji = 1))),
        i.push(
          E
        ...
        if (
          ...
          return (
            ...
            (r.original = emojiSafeSplit(
              getText(D).replace(l, " ").split("&nbsp;").join(""),
              C,
              n,
            )),
            ("{original}" !== i && !0 !== i && null != i) ||
              (i = r.original.join(C)),
            (r.text = emojiSafeSplit((i || "").replace(l, " "), C, n)),
            ...
            (r.charSet = e = A[u.chars || "upperCase"] || new o(u.chars)),
