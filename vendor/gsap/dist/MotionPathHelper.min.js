...
!(function (t, e) {
  ...
  function arcToSegment(t, e, n, i, s, a, o, r, h) {
    if (t !== r || e !== h) {
      ...
      var w = (a === o ? -1 : 1) * Z(C),
        ...
        H = (-m - x) / i,
        R = E * E + M * M,
        N = (M < 0 ? -1 : 1) * Math.acos(E / Z(R)),
        I =
          (E * H - M * T < 0 ? -1 : 1) *
          Math.acos((E * T + M * H) / Z(R * (T * T + H * H)));
      (isNaN(I) && (I = u),
        !o && 0 < I ? (I -= p) : o && I < 0 && (I += p),
        (N %= p),
        (I %= p));
      ...
      for (O = 0; O < L; O++)
        ((_ = W((s = N + O * q))),
          ...
          (E = W((s += q))),
          (M = F(s)),
          X.push(_ - G * m, m + G * _, E + G * M, M - G * E, E, M));
      for (O = 0; O < X.length; O += 2)
        ((_ = X[O]),
          (m = X[O + 1]),
          (X[O] = _ * j + m * V + D),
          (X[O + 1] = _ * z + m * Y + k));
  ...
  function stringToRawPath(t) {
    ...
    if (!t || !isNaN(m[0]) || isNaN(m[1])) return (console.log(C), v);
    for (e = 0; e < P; e++)
      if (
        ((g = a),
        isNaN(m[e]) ? (r = (a = m[e].toUpperCase()) !== m[e]) : e--,
        (i = +m[e + 1]),
        (s = +m[e + 2]),
        r && ((i += b), (s += y)),
        e || ((l = i), (c = s)),
        ...
        (h && (h.length < 8 ? --v.length : (A += h.length), o(h)),
          (b = l = i),
          (y = c = s),
          (h = [i, s]),
          v.push(h),
        ...
        ((d = b),
          (u = y),
          ("C" !== g && "S" !== g) ||
            ((d += b - h[h.length - 4]), (u += y - h[h.length - 3])),
          r || (b = y = 0),
          h.push(d, u, i, s, (b += 1 * m[e + 3]), (y += 1 * m[e + 4])),
          (e += 4));
      else if ("Q" === a)
        ((d = b + (2 / 3) * (i - b)),
          (u = y + (2 / 3) * (s - y)),
          ...
          (b += 1 * m[e + 3]),
          (y += 1 * m[e + 4]),
          h.push(d, u, b + (2 / 3) * (i - b), y + (2 / 3) * (s - y), b, y),
          (e += 4));
      else if ("T" === a)
        ((d = b - h[h.length - 4]),
          (u = y - h[h.length - 3]),
          ...
          (e += 2));
      else if ("H" === a) (ud(b, y, (b = i), y), (e += 1));
      else if ("V" === a) (ud(b, y, b, (y = i + (r ? y - b : 0))), (e += 1));
      else if ("L" === a || "Z" === a)
        ("Z" === a && ((i = l), (s = c), (h.closed = !0)),
          ("L" === a || 0.5 < U(b - i) || 0.5 < U(y - s)) &&
            (ud(b, y, i, s), "L" === a && (e += 2)),
          (b = i),
          (y = s));
      else if ("A" === a) {
        ...
        ((b = h[h.length - 2]), (y = h[h.length - 1]));
      } else console.log(C);
    return (
      (e = h.length) < 6 ? (v.pop(), (e = 0)) : o(h),
      (v.totalPoints = A + e),
      v
    );
  }
  function bezierToPoints(t, e, n, i, s, a, o, r, h, l, c) {
    ...
    return (
      ...
      h * (w * w + S * S) < (x + D) * (x + D) &&
        ((d = l.length),
        bezierToPoints(t, e, u, p, v, b, A, C, h, l, c),
      ...
      ((i = v),
        ...
        (v === y && b === P) ||
          ...
          S[a]
            ...
            : ((c =
                (((h = Z(o * o + r * r)) + (l = Z(C * C + w * w))) * e * 0.25) /
                Z(Math.pow(C / l + o / h, 2) + Math.pow(w / l + r / h, 2))),
              (p =
                v -
                ((d = v - (v - i) * (h ? c / h : 0)) +
                  ((((u = v + (y - v) * (l ? c / l : 0)) - d) *
              ...
              (_ =
                ...
                ((g = b - (b - s) * (h ? c / h : 0)) +
                  ((((f = b + (P - b) * (l ? c / l : 0)) - g) *
                    ((3 * h) / (h + l) + 0.5)) /
                    4 || 0))),
              A.push(n(d + p), n(g + _), n(v), n(b), n(u + p), n(f + _)))));
    return (
      v !== y || b !== P || A.length < 4
  ...
  function C(t) {
    ...
    !(k in t.style) &&
      ...
      (E = (k = "msTransform") + "Origin");
    for (; e.parentNode && (e = e.parentNode););
    if (((f = window), (y = new H()), e)) {
      ((_ = (g = e).documentElement),
        (m = e.body),
        ((x = g.createElementNS(
        ...
        e &&
          (n
            ? ((b = b || K(t)),
              ...
              b.appendChild(h))
            : (v || ((v = K(t)), Object.assign(v.style, r)),
              Object.assign(h.style, r, {
                width: "0.1px",
                height: "0.1px",
                top: o + "px",
                left: a + "px",
  ...
  function N(t, e) {
    var n,
      ...
      d = t.parentNode,
      u =
        d && !h && d.shadowRoot && d.shadowRoot.appendChild ? d.shadowRoot : d;
    if (t === f) return t;
    if ((c.length || c.push(K(t, 1), K(t, 2), K(t, 3)), (n = h ? b : v), h))
      (l
        ? ((a =
              ...
              (i = (i = t.transform ? t.transform.baseVal : {}).numberOfItems
                ? 1 < i.numberOfItems
                  ? (function _consolidate(t) {
                      for (var e = new H(), n = 0; n < t.numberOfItems; n++)
        ...
        (l || !t.getBoundingClientRect().width ? h : d).appendChild(n),
        n.setAttribute(
          "transform",
          "matrix(" +
            i.a +
      ...
      if (((a = o = 0), D))
        for (
          ...
          4 < (f.getComputedStyle(s)[k] + "").length &&
            ((a = s.offsetLeft), (o = s.offsetTop), (s = 0));
      if (
        "absolute" !== (r = f.getComputedStyle(t)).position &&
        "fixed" !== r.position
      )
  ...
  function getGlobalMatrix(t, e, n, i) {
    if (!t || !t.parentNode || (g || C(t)).documentElement === t)
      return new H();
  ...
  function pa(t) {
    return R.createElementNS
      ? R.createElementNS("http://www.w3.org/1999/xhtml", t)
      : R.createElement(t);
  }
  function qa(t, e, n) {
    var i,
  ...
  function sa(t) {
    return ((t.transform && t.transform.baseVal.consolidate()) || ot).matrix;
  }
  function va(t) {
    return ~~(1e3 * t + (t < 0 ? -0.5 : 0.5)) / 1e3;
  }
  function ya(t) {
    if (!t.target._gsSelection && !J && 100 < Q() - $) {
      for (var e = at.length; -1 < --e;) at[e].deselect();
      at.length = 0;
    }
  }
  function Ca(t, e, n, i) {
  ...
  function Fa(t) {
    ((rt = t.touches && _dragCount < t.touches.length),
      Da(t.target, "touchend", Fa));
  }
  function Ga(t) {
    ((rt = t.touches && _dragCount < t.touches.length),
      Ca(t.target, "touchend", Fa));
  }
  function Ha(e, n) {
    return function (t) {
      return e.call(n, t);
  ...
  function Ma(t) {
    ((R = document),
      ...
      (a = pa("div")),
      ((G = pa("textarea")).style.display = "none"),
      i && i.appendChild(G),
      (q = (function (t) {
        for (
          var e = t.split(","),
      ...
      R.addEventListener(
        ...
        function (t) {
          ...
          if ("Shift" === o || 16 === a) L = !0;
            ...
            for (u = !0, e = at.length; -1 < --e;) at[e]._onPressAlt();
            ...
            for (e = at.length; -1 < --e;) at[e]._deleteSelectedAnchors();
          else if (("a" === o || 65 === a) && (d || l))
            for (e = at.length; -1 < --e;) at[e].select(!0);
        },
        !0,
      ),
      R.addEventListener(
        ...
        function (t) {
          ...
          if ("Shift" === e || 16 === e) L = !1;
            ...
            u = !1;
            for (var n = at.length; -1 < --n;) at[n]._onReleaseAlt();
          }
        },
        !0,
      ),
      ...
      Ca(R, "touchcancel", ba),
      Ca(c, "touchmove", ba),
      i && i.addEventListener("touchstart", ba),
      (j = 1));
  }
  function Na(t) {
    var e,
    ...
    ((this._matrix = this.target.transform.baseVal.getItem(0).matrix),
      ...
      q[t.type]
        ? ((e =
            -1 !== t.type.indexOf("touch") ? t.currentTarget || t.target : R),
          Ca(e, "touchend", i._onRelease),
          Ca(e, "touchmove", i._onMove),
          Ca(e, "touchcancel", i._onRelease),
          Ca(R, "touchstart", Ga),
          Ca(c, "touchforcechange", oa))
        : ((e = null), Ca(R, "mousemove", i._onMove)),
      h || Ca(R, "mouseup", i._onRelease),
      oa(t),
      Ka(),
      t.changedTouches
  ...
  function Oa(t) {
    var e,
      ...
      i = this,
      s = t;
    if (i._enabled && !rt && i.isPressed && t) {
  ...
  function Pa(t, e) {
    ...
    if (
      ...
      if (
        (r
          ? (Da(r, "touchend", n._onRelease),
            Da(r, "touchmove", n._onMove),
            Da(r, "touchcancel", n._onRelease),
            Da(R, "touchstart", Ga))
          : Da(R, "mousemove", n._onMove),
        h ||
          (Da(R, "mouseup", n._onRelease),
          t && t.target && Da(t.target, "mouseup", n._onRelease)),
        o
          ? (n.isDragging = !1)
  ...
  var R,
    ...
    rt = 0,
    ht =
      (((z = DraggableSVG.prototype).setPointerPosition =
          ...
          ((this.pointerX = t),
            ...
            (this.x === s && this.y === a) ||
              ...
              !this.isDragging &&
                this.isPressed &&
                ((this.isDragging = !0),
                Ia("onDragStart", this, this.pointerEvent))));
        }),
      (z.enabled = function enabled(t) {
        return arguments.length
          ? ((this._enabled = t)
              ? (h || Ca(this.target, "mousedown", this._onPress),
                Ca(this.target, "touchstart", this._onPress),
                Ca(this.target, "click", this._onClick, !0))
              : ((e = this.isDragging),
                Da(this.target, "mousedown", this._onPress),
                Da(this.target, "touchstart", this._onPress),
                Da(c, "touchforcechange", oa),
                Da(this.target, "click", this._onClick),
                this.touchEventTarget &&
                  (Da(this.touchEventTarget, "touchcancel", this._onRelease),
                  Da(this.touchEventTarget, "touchend", this._onRelease),
                  Da(this.touchEventTarget, "touchmove", this._onMove)),
                Da(R, "mouseup", this._onRelease),
                Da(R, "mousemove", this._onMove),
                (this.isDragging = this.isPressed = !1),
                e && Ia("onDragEnd", this, this.pointerEvent)),
            this)
          : this._enabled;
        var e;
      }),
      (z.endDrag = function endDrag(t) {
        this._onRelease(t);
      }),
      DraggableSVG);
  function DraggableSVG(t, e) {
    ((this.target = "string" == typeof t ? R.querySelectorAll(t)[0] : t),
      (this.vars = e || {}),
      (this._onPress = Ha(Na, this)),
      (this._onMove = Ha(Oa, this)),
      (this._onRelease = Ha(Pa, this)),
      this.target.setAttribute(
        "transform",
        (this.target.getAttribute("transform") || "") + " translate(0,0)",
      ),
      (this._matrix = sa(this.target)),
  ...
  function Anchor(t, e, n, i, s) {
    ((this.editor = t),
      (this.element = qa("path", t._selection, {
        fill: Y,
        stroke: Y,
        strokeWidth: 2,
  ...
  var dt,
    ut =
      (((dt = PathEditor.prototype)._onRelease = function _onRelease(t) {
        ...
        (e && ((tt.x = e.segment[e.i]), (tt.y = e.segment[e.i + 1])),
          Da(c, "touchforcechange", oa),
          Ia("onRelease", this, t));
      }),
      (dt.init = function init() {
        ...
        if (((this._rawPath = i), a)) {
          if (((this._anchors = Qa(i, 0, this, o)), 1 < (t = i.length)))
            for (e = 1; e < t; e++)
              this._anchors = this._anchors.concat(Qa(i, e, this, o));
        } else
        ...
        return (
          ...
          this._g.setAttribute(
            ...
            (function _getConcatenatedTransforms(t) {
              for (
                var e = sa(t), n = t.ownerSVGElement;
      ...
      (dt._onClickSelectionPath = function _onClickSelectionPath(t) {
        if ("hidden" === this._selection.style.visibility) this.select();
          ...
          for (
            ...
            this._anchors[i].i >= e &&
              this._anchors[i].j === r.j &&
              (this._anchors[i].i += 6);
          ((s = new ct(this, this._rawPath, r.j, e, h)),
            this._selection.appendChild(this._handle1),
            this._selection.appendChild(this._handle2),
        ...
        (Ka(), Ca(c, "touchforcechange", oa), Ia("onPress", this));
      }),
      ...
      (dt.select = function select(t) {
        ...
        return (
          -1 === at.indexOf(this) && at.push(this),
          this._updateAnchors(),
          this
        );
      }),
      ...
      (dt._onPressAnchor = function _onPressAnchor(t) {
        (-1 === this._selectedAnchors.indexOf(t)
          ...
          (tt.x = t.segment[t.i]),
          (tt.y = t.segment[t.i + 1]),
          this._updateAnchors(),
          Ia("onPress", this));
      }),
      (dt._deleteSelectedAnchors = function _deleteSelectedAnchors() {
        for (var t, e, n, i, s = this._selectedAnchors, a = s.length; -1 < --a;)
          for (
            (t = s[a]).element.parentNode.removeChild(t.element),
          ...
          i && (t || i.isClosedStart)
            ? ((e = i.isClosedStart ? s[s.length - 4] : s[t - 2]),
              ...
              (this._handle1.style.visibility = this._line1.style.visibility =
                u || e !== s[t] || n !== s[t + 1] ? "visible" : "hidden"),
              this._handle1.setAttribute(
                "transform",
                "translate(" + e + st + n + ")",
              ),
      ...
      (dt.getString = function getString(t, e, i) {
        if (t) {
          var s = sa(this.path);
      ...
      (dt.getNormalizedSVG = function getNormalizedSVG(t, e, n, i) {
        var s,
          ...
          f = -t || c[p - 1] + u;
        for (
          f = f ? 1 / f : -g, g *= 1e3, f *= 1e3, a = it.length = 0;
          a < p;
          a += 2
        )
          ((it[a] = (((c[a] + d) * g) | 0) / 1e3),
            (it[a + 1] = (((c[a + 1] + u) * f) | 0) / 1e3));
        if (i) {
          for (s = [], p = it.length, a = 2; a < p; a += 6)
            ((o = it[a - 2]),
              (r = it[a - 1]),
              (h = it[a + 4]),
              (l = it[a + 5]),
        ...
        return n &&
          ...
          1 === it[p - 1]
          ? it.slice(2, 6).join(",")
          : ((it[2] = "C" + it[2]), "M" + it.join(","));
      }),
      (dt.kill = function kill() {
        (this.enabled(!1),
          this._g.parentNode && this._g.parentNode.removeChild(this._g));
      }),
      (dt.revert = function revert() {
        this.kill();
      }),
      PathEditor);
  function PathEditor(t, e) {
    ((e = e || {}),
      j || Ma(),
      (this.vars = e),
      (this.path = "string" == typeof t ? R.querySelectorAll(t)[0] : t),
      (this._g = qa("g", this.path.ownerSVGElement, {
        class: "path-editor-g path-editor",
      })),
      (this._selectionHittest = qa("path", this._g, {
        stroke: "transparent",
        strokeWidth: 16,
        fill: "none",
        vectorEffect: "non-scaling-stroke",
      ...
      (this._selection =
        e._selection ||
        qa("g", this._g, { class: "path-editor-selection path-editor" })),
      (this._selectionPath = qa("path", this._selection, {
        stroke: Y,
        strokeWidth: 2,
        fill: "none",
        vectorEffect: "non-scaling-stroke",
      ...
      (this._line1 = qa("polyline", this._selection, {
        stroke: Y,
        strokeWidth: 2,
        vectorEffect: "non-scaling-stroke",
      })),
      (this._line2 = qa("polyline", this._selection, {
        stroke: Y,
        strokeWidth: 2,
        vectorEffect: "non-scaling-stroke",
      })),
    ...
    ((this._squareHandle = (function _getSquarePathData(t) {
      return ["M-" + (t = va(t)), -t, t, -t, t, t, -t, t + "z"].join(st);
    })(i)),
      (this._circleHandle = (function _getCirclePathData(t) {
        var e = va(0.552284749831 * t);
        return (
          "M" +
          (t = va(t)) +
          ",0C" +
      ...
      (this._handle1 = qa("path", this._selection, {
        d: this._squareHandle,
        fill: Y,
        stroke: "transparent",
        strokeWidth: 6,
      })),
      (this._handle2 = qa("path", this._selection, {
        d: this._squareHandle,
        fill: Y,
        stroke: "transparent",
        strokeWidth: 6,
    ...
    (!1 !== e.draggable &&
      ...
      !1 !== e.selected && ((this.path._gsSelection = !0), at.push(this)),
      this._saveState(),
      h ||
        (Ca(
          this._selectionHittest,
          "mousedown",
          Ha(this._onClickSelectionPath, this),
        ),
        Ca(this._selectionHittest, "mouseup", Ha(this._onRelease, this))),
      Ca(
        this._selectionHittest,
        "touchstart",
        Ha(this._onClickSelectionPath, this),
      ),
      Ca(this._selectionHittest, "touchend", Ha(this._onRelease, this)),
      r(this));
  }
    ...
    (ut.simplifySVG = function (t, e) {
      ...
      if (
        ...
        ("#" !== t.charAt(0) && "." !== t.charAt(0)) ||
          ((n = R.querySelector(t)) && (t = n.getAttribute("d"))),
        (i =
  ...
  function kb(t, e, n) {
    return db(t) && Ct.test(t)
      ? ft.querySelector(t)
      : Array.isArray(t)
        ? yt(
            bt(
              [{ x: pt.getProperty(e, "x"), y: pt.getProperty(e, "y") }].concat(
                t,
              ),
              n,
            ),
  ...
  function pb(t, e) {
    ...
    ((gt = window),
      (pt = pt || t || gt.gsap || console.warn(n)) && ut.register(pt),
      (ft = document),
      (mt = ft.body),
      (_t = ft.documentElement),
      pt &&
        ((vt = pt.plugins.motionPath),
        (St.PathEditor = ut),
        (Pt = pt.core.context || function () {})),
      vt
        ? ((function _initCopyToClipboard() {
            (((At = eb("textarea")).style.display = "none"),
              mt.appendChild(At));
          })(),
  ...
  function MotionPathHelper(t, e) {
    ...
    var i,
      ...
      v = this,
      b = { x: 0, y: 0 };
    (t instanceof pt.core.Tween
      ? (i = (c = t).targets()[0])
      : ((i = pt.utils.toArray(t)[0]),
        (c = (function _findMotionPathTween(t) {
          for (var e = pt.getTweensOf(t), n = 0; n < e.length; n++) {
      ...
      (h = (function _getPositionOnPage(t) {
        var e = t.getBoundingClientRect(),
          n =
            _t.clientTop -
            (gt.pageYOffset || _t.scrollTop || mt.scrollTop || 0),
          i =
            _t.clientLeft -
            (gt.pageXOffset || _t.scrollLeft || mt.scrollLeft || 0);
        return {
          left: e.left + i,
          top: e.top + n,
          right: e.right + i,
      ...
      (o = parseFloat(pt.getProperty(i, "x", "px"))),
      (r = parseFloat(pt.getProperty(i, "y", "px"))),
      ...
      m.setAttribute("class", "copy-motion-path"),
      (m.style.cssText =
      ...
      (m.innerText = "COPY MOTION PATH"),
      (m._gsHelper = v),
      (pt.utils.toArray(e.container)[0] || mt).appendChild(m),
      ...
      (l = s && s.ownerSVGElement)
        ? (e.pathColor && pt.set(s, { stroke: e.pathColor }),
          e.pathWidth && pt.set(s, { strokeWidth: e.pathWidth }),
          e.pathOpacity && pt.set(s, { opacity: e.pathOpacity }))
        : ((d =
            (a &&
              i.ownerSVGElement &&
          ...
          a
            ? ((l = i.ownerSVGElement),
              (u = i.getBBox()),
              (o = (p = (function _getConsolidatedMatrix(t) {
      ...
      (this.kill = this.revert =
        function () {
          (n.editor.kill(),
            ...
            _ && l.parentNode && l.parentNode.removeChild(l),
            f && f.revert());
        }));
  }
  ((St.register = pb),
