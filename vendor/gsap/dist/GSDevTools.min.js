...
!(function (e, t) {
        ...
        t &&
          (o
            ? ((m = m || w(e)),
              ...
              m.appendChild(l))
            : (h || ((h = w(e)), Object.assign(h.style, s)),
  ...
  var g,
    ...
    M = function _setDoc(e) {
      ...
      if (((f = window), (v = new he()), t)) {
        ...
        i &&
          ...
          (o.style.transform = "translate3d(0,0,1px)"),
          (y = n.offsetParent !== o),
          i.removeChild(o));
      }
      return t;
    ...
    S = function _getDocScrollTop() {
      return f.pageYOffset || g.scrollTop || r.scrollTop || a.scrollTop || 0;
    },
    E = function _getDocScrollLeft() {
      return f.pageXOffset || g.scrollLeft || r.scrollLeft || a.scrollLeft || 0;
    },
    ...
    N = function _placeSiblings(e, t) {
      var o,
        ...
        p = e.parentNode,
        u =
          p && !l && p.shadowRoot && p.shadowRoot.appendChild
            ? p.shadowRoot
            : p;
      if (e === f) return e;
      if ((c.length || c.push(w(e, 1), w(e, 2), w(e, 3)), (o = l ? m : h), l))
        (d
          ? ((r =
          ...
          (d || !e.getBoundingClientRect().width ? l : p).appendChild(o),
          o.setAttribute(
            "transform",
            "matrix(" +
              n.a +
        ...
        if (((r = a = 0), y))
          for (
            ...
            4 < (f.getComputedStyle(i)[b] + "").length &&
              ((r = i.offsetLeft), (a = i.offsetTop), (i = 0));
        if (
          "absolute" !== (s = f.getComputedStyle(e)).position &&
          "fixed" !== s.position
        )
  ...
  function wa() {
    return !Oe.length && me.ticker.remove(ua);
  }
  function xa(e) {
  ...
  function Da(e) {
    ((ke = e.touches && Ne < e.touches.length), Aa(e.target, "touchend", Da));
  }
  function Ea(e) {
    ((ke = e.touches && Ne < e.touches.length), za(e.target, "touchend", Da));
  }
  function Fa(e) {
    return (
      ve.pageYOffset ||
  ...
  function Ha(e, t) {
    (za(e, "scroll", t), Ze(e.parentNode) || Ha(e.parentNode, t));
  }
  function Ia(e, t) {
    (Aa(e, "scroll", t), Ze(e.parentNode) || Ia(e.parentNode, t));
  }
  function Ka(e, t) {
  ...
  function $a(r, i) {
    ...
    (R && !1 !== i.force3D
      ...
      (this.left = function (e, t) {
        if (!arguments.length) return -(r.scrollLeft + f);
  ...
  function _a(e) {
    if (X() && document.body) {
      ...
      ((ve = window),
        ...
        (Se = "grab" === be.style.cursor ? "grab" : "move"),
    ...
    var o, n, i, r, a;
    me
      ? ((Ce = me.plugins.inertia),
        (Pe = me.core.context || function () {}),
        (d = me.utils.checkPrefix),
        (O = d(O)),
        (Re = d(Re)),
        (_e = me.utils.toArray),
    ...
    u = function _getElementBounds(e, t) {
      ...
      return e === t
        ...
        : ((s = (a = getGlobalMatrix(t, !0).multiply(getGlobalMatrix(e))).apply(
          ...
          (c = a.apply({ x: o, y: r })),
          {
            left: (o = Math.min(s.x, l.x, d.x, c.x)),
            top: (i = Math.min(s.y, l.y, d.y, c.y)),
            width: Math.max(s.x, l.x, d.x, c.x) - o,
            height: Math.max(s.y, l.y, d.y, c.y) - i,
          });
    },
    H =
    ...
    W =
      ...
      (Draggable.hitTest = function hitTest(e, t, o) {
        ...
        var n,
          ...
          u = a.width,
          g = a.height,
          f = s.left > c || s.right < d || s.top > p || s.bottom < l;
        return f || !o
          ? !f
          : ((r = -1 !== (o + "").indexOf("%")),
            (o = parseFloat(o) || 0),
            ((n = {
              left: Math.max(d, s.left),
              top: Math.max(l, s.top),
            }).width = Math.min(c, s.right) - n.left),
  ...
  function Draggable(g, p) {
    ...
    function ui(e) {
      if (q.autoScroll && q.isDragging && (te || L)) {
        var t,
          o,
          n,
          i,
        ...
        for (
          te = !1,
            ...
            r = q.pointerY - Ge.scrollTop;
          d && !o;
        )
          ((t = (o = Ze(d.parentNode)) ? Ge : d.parentNode),
            (n = o
              ? {
              ...
              ((l = t._gsMaxScrollY - t.scrollTop) < 0
                ...
                : r > n.bottom - ie && l
                  ? ((te = !0),
                    (s = Math.min(
                      l,
                      (c * (1 - Math.max(0, n.bottom - r) / ie)) | 0,
                    )))
                  : r < n.top + oe &&
                    t.scrollTop &&
                    ((te = !0),
      ...
      if (L) {
        ...
        (W
          ...
          : f
            ? (K && ((q.deltaY = u - f.top()), f.top(u)),
              U && ((q.deltaX = p - f.left()), f.left(p)))
            : G
              ? (K && ((q.deltaY = u - parseFloat(le.y)), (le.y = u + "px")),
                U && ((q.deltaX = p - parseFloat(le.x)), (le.x = p + "px")),
                le.renderTransform(1, le))
              : (K &&
          ...
          !h ||
            ...
            (!(H = !0) === Qa(q, "drag", "onDrag") &&
              (U && (q.x -= q.deltaX), K && (q.y -= q.deltaY), ui(!0)),
            (H = !1)));
      }
      L = !1;
    }
    function vi(e, t) {
      ...
      (g._gsap || (le = me.core.getCache(g)),
        ...
        G
          ...
          : W
            ? (q.x = q.rotation = da(parseFloat(le.rotation)))
            : f
        ...
        (N || R || A) &&
          ...
          (A &&
            ((ze.x = q.x),
            (ze.y = q.y),
            (o = A(ze)).x !== q.x && ((q.x = o.x), (L = !0)),
            o.y !== q.y && ((q.y = o.y), (L = !0))),
          N &&
            (o = N(q.x)) !== q.x &&
            ((q.x = o), W && (q.rotation = o), (L = !0)),
          R && ((o = R(q.y)) !== q.y && (q.y = o), (L = !0))),
        L && ui(!0),
        e ||
          ((q.deltaX = q.x - i),
          (q.deltaY = q.y - r),
    ...
    function wi(a, s, l, o) {
      return (
        ...
        Z(a)
          ...
          : Ae(a)
            ? function (e) {
                for (var t, o, n = a.length, i = 0, r = Be; -1 < --n;)
                  ((o = (t = a[n]) - e) < 0 && (o = -o),
                    o < r && s <= t && t <= l && ((i = n), (r = o)));
                return a[i];
              }
    ...
    function yi() {
      ...
      ((k = !1),
        f
          ? (f.calibrate(),
            (q.minX = C = -f.maxScrollLeft()),
            (q.minY = E = -f.maxScrollTop()),
            (q.maxX = D = q.maxY = S = 0),
            (k = !0))
          : p.bounds &&
            ...
            W
              ...
              : _(p.bounds.maxX) && _(p.bounds.maxY)
                ? ((t = Ra(g, g.parentNode)),
                  (q.minX = C = Math.round(Mh(V, "px") + e.left - t.left)),
                  (q.minY = E = Math.round(Mh(Q, "px") + e.top - t.top)),
                  (q.maxX = D = Math.round(C + (e.width - t.width))),
                  (q.maxY = S = Math.round(E + (e.height - t.height))))
                : ((e = p.bounds),
                  (q.minX = C = e.minX),
                  (q.minY = E = e.minY),
                  (q.maxX = D = e.maxX),
                  (q.maxY = S = e.maxY)),
            D < C && ((q.minX = D), (q.maxX = D = C), (C = q.minX)),
            S < E && ((q.minY = S), (q.maxY = S = E), (E = q.minY)),
            W && ((q.minRotation = C), (q.maxRotation = D)),
            (k = !0)),
        p.liveSnap &&
          ((o = !0 === p.liveSnap ? p.snap || {} : p.liveSnap),
          (n = Ae(o) || Z(o)),
          W
            ? ((N = wi(n ? o : o.rotation, C, D, 1)), (R = null))
            : o.points
              ? (A = (function buildPointSnapFunc(l, s, d, c, p, u, g) {
                  return (
                    (u = u && u < Be ? u * u : Be),
                    Z(l)
                      ? function (e) {
                      ...
                      : Ae(l)
                        ? function (e) {
                            for (
                              var t, o, n, i, r = l.length, a = 0, s = Be;
                              -1 < --r;
                            )
                              (i =
                                (t = (n = l[r]).x - e.x) * t +
                ...
                })(n ? o : o.points, C, D, E, S, o.radius, f ? -1 : 1))
              : (U &&
                  (N = wi(
    ...
    function Bi(e, t) {
      ...
      e && Ce
        ? (!0 === e &&
            ...
            W
              ? (e.rotation = Ua(q, n ? o : o.rotation, D, C, 1, t))
              : (U &&
                  (e[V] = Ua(
                    q,
                ...
                (o.points || (Ae(o) && $(o[0]))) &&
                  ((e.linkedProps = V + "," + Q), (e.radius = o.radius)))),
          (q.isThrowing = !0),
    ...
    function Ci(e) {
      var t,
        o = X;
      ((X = getGlobalMatrix(g.parentNode, !0)),
        e &&
          q.isPressed &&
          !X.equals(o || new he()) &&
    ...
    function Di() {
      ...
      (G &&
        ...
        (b = We.x),
        (w = We.y),
        L && (ge(q.pointerX, q.pointerY), ui(!0)),
        (c = getGlobalMatrix(g)),
        f
          ? (yi(), (M = f.top()), (T = f.left()))
          : (pe() ? (vi(!0, !0), yi()) : q.applyBounds(),
            W
              ? ((e = g.ownerSVGElement
                ...
                (o = P.y - q.pointerY + r),
                (T = q.x),
                (M = q.y = Math.atan2(o, t) * Xe))
              : ((M = Mh(Q, "px")), (T = Mh(V, "px")))),
        k &&
          n &&
          (D < T ? (T = D + (T - D) / n) : T < C && (T = C - (C - T) / n),
          W ||
            (S < M ? (M = S + (M - S) / n) : M < E && (M = E - (E - M) / n))),
        (q.startX = T = da(T)),
        (q.startY = M = da(M)));
    }
    function Fi() {
      !be.parentNode || pe() || q.isDragging || be.parentNode.removeChild(be);
    }
    function Gi(e, t) {
      var o;
      if (
        ...
        if (
          ...
          (function _addToRenderQueue(e) {
            (Oe.push(e), 1 === Oe.length && me.ticker.add(ua));
          })(ui),
          (w = q.pointerY = e.pageY),
          (b = q.pointerX = e.pageX),
          Qa(q, "pressInit", "onPressInit"),
          (Y || q.autoScroll) && La(g.parentNode),
          !g.parentNode ||
            !q.autoScroll ||
            f ||
            W ||
        ...
        (Qa(q, "press", "onPress"),
          Ce && Ce.track(f || g, G ? "x,y" : W ? "rotation" : "top,left"));
      }
    }
    function Ki(e) {
      if (e && q.isDragging && !f) {
    ...
    function Mi(e) {
      return X
        ? { x: e.x * X.a + e.y * X.c + X.e, y: e.x * X.b + e.y * X.d + X.f }
        : { x: e.x, y: e.y };
    }
    var u,
      f,
      ...
      de = (function _isFixed(e) {
        return (
          "fixed" === Na(e).position ||
          ((e = e.parentNode) && 1 === e.nodeType ? _isFixed(e) : void 0)
        );
      })(g),
      ce = g.ownerDocument || xe,
      ...
      ue = function onMove(e) {
        ...
        if (u && !ke && q.isPressed && e) {
          ...
          Y &&
          !O &&
          ((We.x = e.pageX - (de ? Ga(ce) : 0)),
          (We.y = e.pageY - (de ? Fa(ce) : 0)),
          X && X.apply(We, We),
          (o = We.x),
          (n = We.y),
          (((r = Math.abs(o - b)) !== (a = Math.abs(n - w)) &&
            ...
            (De && Y === O)) &&
            ((O = a < r && U ? "x" : "y"),
            Y && O !== Y && za(ve, "touchforcechange", Ba),
      ...
      ge = function setPointerPosition(e, t, o) {
        ...
        ((q.pointerX = e),
          ...
          de && ((e -= Ga(ce)), (t -= Fa(ce))),
          W
            ? ((a = da(Math.atan2(P.y - t, e - P.x) * Xe)),
              180 < (s = q.y - a)
                ? ((M -= 360), (q.y = a))
                : s < -180 && ((M += 360), (q.y = a)),
              X &&
                ...
                (e = l)),
              (r =
                q.x !== T || Math.max(Math.abs(b - e), Math.abs(w - t)) > j
                  ? ((q.y = a), da(T + (M - a) * d))
                  : T))
            : (X &&
                ((l = e * X.a + t * X.c + X.e),
          ...
          k &&
            (D < r
              ? (r = D + Math.round((r - D) * c))
              : r < C && (r = C + Math.round((r - C) * c)),
            W ||
              (S < a
                ? (a = Math.round(S + (a - S) * c))
                : a < E && (a = Math.round(E + (a - E) * c)))),
          (q.x === r && (q.y === a || W)) ||
            (W
              ? ((q.endRotation = q.x = q.endX = da(r)), (L = !0))
              : (K && ((q.y = q.endY = a), (L = !0)),
                U && ((q.x = q.endX = r), (L = !0))),
            o && !1 === Qa(q, "move", "onMove")
              ...
              : !q.isDragging &&
                q.isPressed &&
                ((q.isDragging = z = !0), Qa(q, "dragstart", "onDragStart"))));
      },
      fe = function onRelease(e, t) {
        if (
          ...
          var o,
            ...
            s = e,
            l = q.isDragging,
            d = q.vars.allowContextMenu && e && (e.ctrlKey || 2 < e.which),
            c = me.delayedCall(0.001, Fi);
          if (
            (y
            ...
            (Ee && y) ||
              (Aa(ce, "mouseup", onRelease),
              e && e.target && Aa(e.target, "mouseup", onRelease)),
            (L = !1),
            l && ((ee = Fe = Ye()), (q.isDragging = !1)),
            xa(ui),
            x && !d)
          )
            return (
          ...
          for (n = J.length; -1 < --n;)
            Ma(J[n], "cursor", p.cursor || (!1 !== p.cursor ? Se : null));
          if ((Ne--, e)) {
            if (
              (o = e.changedTouches) &&
              (e = o[0]) !== m &&
          ...
          return (
            d && s
              ? (Ba(s), (F = !0), Qa(q, "release", "onRelease"))
              : s && !l
                ? ((F = !1),
                  B && (p.snap || p.bounds) && Bi(p.inertia || p.throwProps),
                  Qa(q, "release", "onRelease"),
                  (De && "touchmove" === s.type) ||
                    -1 !== s.type.indexOf("cancel") ||
                    (Qa(q, "click", "onClick"),
                    Ye() - se < 300 && Qa(q, "doubleclick", "onDoubleClick"),
                    (r = s.target || g),
                    (se = Ye()),
                    ...
                    De || s.defaultPrevented || me.delayedCall(0.05, a)))
                : (Bi(p.inertia || p.throwProps),
                  q.allowEventDefault ||
                  !s ||
                  (!1 === p.dragClickables && ae.call(q, s.target)) ||
                  !l ||
                  (Y && (!O || Y !== O)) ||
                  !1 === s.cancelable
                    ? (F = !1)
                    : ((F = !0), Ba(s)),
                  Qa(q, "release", "onRelease")),
            pe() && c.duration(q.tween.duration()),
    ...
    return (
      ...
      (e.startDrag = function (e, t) {
        var o, n, i, r;
        (Gi(e || q.pointerEvent, !0),
          t &&
            !q.hitTest(e || q.pointerEvent) &&
            ((o = Pa(e || q.pointerEvent)),
            (n = Pa(g)),
            (i = Mi({ x: o.left + o.width / 2, y: o.top + o.height / 2 })),
            (r = Mi({ x: n.left + n.width / 2, y: n.top + n.height / 2 })),
            (b -= i.x - r.x),
            (w -= i.y - r.y)),
          q.isDragging ||
            ((q.isDragging = z = !0), Qa(q, "dragstart", "onDragStart")));
      ...
      (e.timeSinceDrag = function () {
        return q.isDragging ? 0 : (Ye() - ee) / 1e3;
      }),
      ...
      (e.getDirection = function (e, t) {
        var o,
          ...
          a,
          s,
          l = "velocity" === e && Ce ? e : $(e) && !W ? "element" : "start";
        return (
        ...
        if ((vi(!0), yi(), k && !pe())) {
          if (
            ...
            for (
              ...
              ((a = (s = Ze(r.parentNode)) ? Ge : r.parentNode),
                K &&
                ...
                (r = a));
          q.isThrowing &&
            (i || q.endX > D || q.endX < C || q.endY > S || q.endY < E) &&
            Bi(p.inertia || p.throwProps, i);
        }
        return q;
      }),
      (e.update = function (e, t, o) {
        if (t && q.isPressed) {
          if (W) q.x = q.y = da(parseFloat(le.rotation));
          else {
            var n = getGlobalMatrix(g),
              i = c.apply({ x: q.x - T, y: q.y - M }),
        ...
        return (
          Ci(!t),
          e ? q.applyBounds() : (L && o && ui(!0), vi(!0)),
          t && (ge(q.pointerX, q.pointerY), L && ui(!0)),
          q.isPressed &&
            !t &&
            ((U && 0.01 < Math.abs(a - q.x)) ||
              (K && 0.01 < Math.abs(s - q.y) && !W)) &&
            Di(),
          q.autoScroll &&
      ...
      (e.enable = function (e) {
        var t,
          ...
          i = { lazy: !0 };
        if (
          (!1 !== p.cursor && (i.cursor = p.cursor || Se),
          ...
          for (
            ...
            ((n = J[o]),
              ...
              p.allowContextMenu || za(n, "contextmenu", ti));
          Wa(J, !1);
        }
        return (
          Ha(g, Ki),
          ...
          Ce &&
            "soft" !== e &&
            Ce.track(f || g, G ? "x,y" : W ? "rotation" : "top,left"),
          (g._gsDragID = t = g._gsDragID || "d" + Ie++),
          (He[t] = q),
      ...
      (e.disable = function (e) {
        ...
        return (
          ...
          Ce &&
            "soft" !== e &&
            (Ce.untrack(f || g, G ? "x,y" : W ? "rotation" : "top,left"),
            q.tween && q.tween.kill()),
          f && f.disable(),
          xa(ui),
      ...
      ~o.indexOf("scroll") &&
        ...
        (g = f.content)),
      W ? (n.rotation = 1) : (U && (n[V] = 1), K && (n[Q] = 1)),
      (le.force3D = !("force3D" in p) || p.force3D),
      Pe(_assertThisInitialized(e)),
      e.enable(),
      e
    );
  }
  ...
  function Eb(e, t, o) {
    var n = U.createElementNS
      ? U.createElementNS("svg" === e ? z : G, e)
      : U.createElement(e);
    return (
      t && (ub(t) && (t = U.querySelector(t)), t.appendChild(n)),
      "svg" === e &&
        (n.setAttribute("xmlns", z), n.setAttribute("xmlns:xlink", G)),
      o && (n.style.cssText = o),
      n
    );
  }
  ...
  function Ub(e) {
    return V.getById(e) || oe.getById(e) || (e === j.vars.id && j);
  }
  function Vb(e) {
    ((V = e || tb()),
      Q ||
        (V &&
          ...
          (K = U.documentElement),
          (I = window),
          (ie = V.core.context || function () {}),
          V.registerPlugin(W),
          ((F = V.globalTimeline)._sort = !0),
          ...
          ne(2, function () {
            ...
            (2 < ue.globalRecordingTime
              ? ne(ue.globalRecordingTime - 2, function () {
  ...
  var V,
    ...
    ue = function GSDevTools(r) {
      (Q || (Vb(), V || console.warn("Please gsap.registerPlugin(GSDevTools)")),
        (this.vars = r = r || {}),
        r.animation &&
          (
        ...
        (r.id = r.id || (ub(r.animation) ? r.animation : le++)),
        (de[r.id + ""] = this),
      ...
      function No(e) {
        if (!X.isPressed) {
          ...
          (v.progress(o / 100).pause(), O(!0), X.startDrag(e));
        }
      }
      function Ro() {
        if (!X.isPressed) {
      ...
      function Uo() {
        var e,
          ...
          o = (function _getChildrenOf(e, t) {
            for (var o = [], n = 0, i = V.core.Tween, r = e._first; r;)
              (r instanceof i
                ? r.vars.id && (o[n++] = r)
                : (t && r.vars.id && (o[n++] = r),
        ...
        for (
          a && !r.globalSync
            ? o.unshift(a)
            : r.hideGlobalTimeline || o.unshift(j),
            t = 0;
          t < o.length;
          t++
        )
          (((e = n[t] || Eb("option", S)).animation = o[t]),
      ...
      function Vo(e) {
        ...
        if (
          ...
          if (
            (i && ((i._inProgress = D), (i._outProgress = C)),
            (i = e),
            v &&
              ((n = v.timeScale()),
              v._targets && v._targets[0] === a && (a.resume(), v.kill())),
            (D = i._inProgress || 0),
            (C = i._outProgress || 100),
            (M.style.left = D + "%"),
            (k.style.left = C + "%"),
            d && ($n("animation", i.vars.id), $n("in", D), $n("out", C)),
            (s = 0),
            (o = r.maxDuration || Math.min(1e3, Hb(i))),
            i === j || r.globalSync)
          ) {
            if (
              (Rb(),
            ...
            (o < l - s && (l = s + o),
              ...
              (J.vars.time = l),
              J.invalidate(),
              J.duration(l - s).timeScale(n),
              P
                ? J.progress(1, !0).pause(0, !0)
                : ne(0.01, function () {
                    (J.resume().progress(D / 100), P && H());
                  }));
          } else {
            if (
              (ee === p && (ee = null),
              ...
              for (
                ...
                ((s = s / (t._ts || t._rts) + t._start),
                  (l = l / (t._ts || t._rts) + t._start),
                  (t = t.parent));
              (o < l - s && (l = s + o),
                a.pause(s),
                (v = V.to(
            ...
            } else ((v = i), !c && v._repeat && So(!0));
            (v.timeScale(n), J.pause(), j.resume(), v.seek(0));
          }
          ((_.innerHTML = v.duration().toFixed(2)), Pb(S, i.vars.id, E));
        }
      }
      function Xo(e) {
        (Vo(S.options[S.selectedIndex].animation),
      ...
      function ap() {
        G || (z.play(), Z.pause(), (G = !0));
      }
      function bp() {
        (Z.pause(), G && (z.reverse(), (G = !1)));
      }
      function ep(e) {
        (ae && !se && (se = j._start),
          (d = !e),
          (a = (function _parseAnimation(e) {
            return e instanceof q ? e : e ? V.getById(e) : null;
          })(r.animation)) &&
            !a.vars.id &&
            (a.vars.id = "[no id]"),
          Rb(),
          Uo());
        var t = Ub(_n("animation"));
        (t &&
          ((t._inProgress = _n("in") || 0),
          (t._outProgress = _n("out") || 100)),
          r.paused && I(),
          (i = null),
          Vo(a || t || j));
        var o = r.timeScale || _n("timeScale"),
          n = t === i;
        (o && (Pb(R, o, A, o + "x"), v.timeScale(o)),
          100 ===
            (D =
              ("inTime" in r ? Jb(r.inTime, i, 0, 0) : n ? t._inProgress : 0) ||
              0) &&
            !r.animation &&
            t &&
            (Vo(j), (D = Jb(r.inTime, i, 0, 0) || 0)),
          D &&
            ((M.style.left = D + "%"),
            (M.style.display = k.style.display = "block")),
          (C =
            ("outTime" in r
              ? Jb(r.outTime, i, 100, D)
              : n
                ? t._outProgress
                : 0) || 100) < D && (C = 100),
          100 !== C &&
            ((k.style.left = C + "%"),
            (M.style.display = k.style.display = "block")),
          (c = "loop" in r ? r.loop : _n("loop")) && So(!0),
      ...
      var u,
        ...
        n = (function _createRootElement(e, t, o) {
          ...
          var n = Eb("div", e || K.getElementsByTagName("body")[0] || K);
          return (
        ...
        R = Zn(".time-scale select"),
        A = Zn(".time-scale-label"),
        X = W.create(x, {
          type: "x",
          cursor: "ew-resize",
          ...
          onDrag: function onDrag() {
            ...
            (e < 0 ? (e = 0) : e > v._dur && (e = v._dur),
              h || v.time(e),
              (b.style.width =
                Math.min(C - D, Math.max(0, (e / v._dur) * 100 - D)) + "%"),
        ...
        O = function updateProgress(e) {
          if (!X.isPressed || !0 === e) {
            ...
            (100 < o && (o = 100),
              C <= o
                ? !c || v.paused() || X.isDragging
                  ? ((o === C && -1 !== i._repeat) ||
                      ((o = C), v.progress(o / 100)),
                    !P &&
                      (C < 100 ||
                        1 === i.totalProgress() ||
                        -1 === i._repeat) &&
      ...
      (Nb(S, "change", Xo),
        Nb(S, "mousedown", Uo),
        Nb(t, "mousedown", F),
        Nb(Zn(".seek-bar"), "mousedown", No),
        Nb(Zn(".rewind"), "mousedown", Ro),
        Nb(L, "mousedown", To),
        Nb(R, "change", Yo),
        "auto" === r.visibility
          ? (Nb(n, "mouseout", _o), Nb(n, "mouseover", bp))
          : "hidden" === r.visibility && ((G = !0), z.progress(1)),
        !1 !== r.keyboard &&
          (te && r.keyboard
            ? console.warn(
        ...
        (this.kill = this.revert =
          function () {
            (Ob(S, "change", Xo),
              Ob(S, "mousedown", Uo),
              Ob(t, "mousedown", F),
              Ob(Zn(".seek-bar"), "mousedown", No),
              Ob(Zn(".rewind"), "mousedown", Ro),
              Ob(L, "mousedown", To),
              Ob(R, "change", Yo),
              X.disable(),
              B.disable(),
