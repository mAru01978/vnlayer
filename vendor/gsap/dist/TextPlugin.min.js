...
!(function (D, u) {
  ...
  function splitInnerHTML(D, u, F, C, E) {
    for (var e, t = D.firstChild, n = []; t;)
      (3 === t.nodeType
        ? ((e = (t.nodeValue + "").replace(/^\n+/g, "")),
          C || (e = e.replace(/\s+/g, " ")),
          n.push.apply(n, emojiSafeSplit(e, u, F, C, E)))
        : "br" === (t.nodeName + "").toLowerCase()
          ? (n[n.length - 1] += "<br>")
          : n.push(t.outerHTML),
        (t = t.nextSibling));
    if (!E) for (e = n.length; e--;) "&" === n[e] && n.splice(e, 1, "&amp;");
    return n;
  }
  function emojiSafeSplit(D, u, F, C, E) {
    ...
    for (var e, t, n = [], B = D.length, i = 0; i < B; i++)
      (((55296 <= (t = D.charAt(i)).charCodeAt(0) &&
        t.charCodeAt(0) <= 56319) ||
        (65024 <= D.charCodeAt(i + 1) && D.charCodeAt(i + 1) <= 65039)) &&
        ((e = ((D.substr(i, 12).split(A) || [])[1] || "").length || 2),
        (t = D.substr(i, e)),
        (i += e - (n.emoji = 1))),
        n.push(
          E
