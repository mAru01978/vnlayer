...
!(function (t, e) {
  ...
  function sliceRawPath(t, e, n) {
    ...
    if (p || r) {
      for (
        i = y < P || (R && b < M) || (L && m.t < d.t),
          z(a, P, M, d.t) &&
            (P++,
            i ||
              (y++,
              L ? ((m.t = (m.t - d.t) / (1 - d.t)), (b = 0)) : R && (b -= M))),
          Math.abs(1 - (n - e)) < 1e-5
            ? (y = P - 1)
            : !m.t && y
              ? y--
              : z(a, y, b, m.t) && i && P++,
          1 === d.t && (P = (P + 1) % a.length),
          u = [],
          f = 1 + (g = a.length) * r,
          f += (g - (c = P) + y) % g,
          h = 0;
        ...
        D(u, a[c++ % g]);
      a = u;
    } else if (((l = 1 === m.t ? 6 : subdivideSegment(v, b, m.t)), e !== n))
      for (
        s = subdivideSegment(w, M, L ? d.t / m.t : d.t),
          R && (l += s),
          v.splice(b + l + 2),
          (s || M) && w.splice(0, M + s),
          h = a.length;
        ...
        (h < P || y < h) && a.splice(h, 1);
    else
      ((v.angle = getRotationAtBezierT(v, b + l, 0)),
        (d = v[(b += l)]),
        (m = v[b + 1]),
  ...
  function measureSegment(t, e, n) {
    ...
    for (T.length = S.length = 0, a = e + 2; a < b; a += 6) {
      if (
        ...
        (f = t[a + 1] - R),
        (l = h = c = p = 0),
        U(o) < 0.01 && U(u) < 0.01 && U(s) + U(f) < 0.01)
      )
    ...
    if (T.length && C) {
      if (
        ...
        y / (t.minLength = C) < 9999)
      )
        for (w = v = 0, r = 0; r < y; r += C) S[w++] = T[v] < r ? ++v : v;
  ...
  function arcToSegment(t, e, n, r, a, o, i, s, l) {
    if (t !== s || e !== l) {
      ...
      var R = (o === i ? -1 : 1) * H(M),
        ...
        O = (-v - T) / r,
        B = _ * _ + N * N,
        E = (N < 0 ? -1 : 1) * Math.acos(_ / H(B)),
        z =
          (_ * O - N * A < 0 ? -1 : 1) *
          Math.acos((_ * A + N * O) / H(B * (A * A + O * O)));
      (isNaN(z) && (z = f),
        !i && 0 < z ? (z -= c) : i && z < 0 && (z += c),
        (E %= c),
        (z %= c));
      ...
      for (D = 0; D < I; D++)
        ((m = Z((a = E + D * k))),
          ...
          (_ = Z((a += k))),
          (N = F(a)),
          Y.push(m - G * v, v + G * m, _ + G * N, N - G * _, _, N));
      for (D = 0; D < Y.length; D += 2)
        ((m = Y[D]),
          (v = Y[D + 1]),
          (Y[D] = m * j + v * X + S),
          (Y[D + 1] = m * q + v * $ + C));
      return ((Y[D - 2] = s), (Y[D - 1] = l), Y);
    }
  }
  function stringToRawPath(t) {
    ...
    for (e = 0; e < x; e++)
      if (
        ...
        (s && (s.length < 8 ? --v.length : (P += s.length), L(s)),
          (w = l = r),
          (y = h = a),
          (s = [r, a]),
          v.push(s),
        ...
        ((u = w),
          (g = y),
          ("C" !== c && "S" !== c) ||
            ((u += w - s[s.length - 4]), (g += y - s[s.length - 3])),
          i || (w = y = 0),
          s.push(u, g, r, a, (w += 1 * m[e + 3]), (y += 1 * m[e + 4])),
          (e += 4));
      else if ("Q" === o)
        ((u = w + (2 / 3) * (r - w)),
          (g = y + (2 / 3) * (a - y)),
          ...
          (w += 1 * m[e + 3]),
          (y += 1 * m[e + 4]),
          s.push(u, g, w + (2 / 3) * (r - w), y + (2 / 3) * (a - y), w, y),
          (e += 4));
      else if ("T" === o)
        ((u = w - s[s.length - 4]),
          (g = y - s[s.length - 3]),
          ...
          (e += 2));
      else if ("H" === o) (Ef(w, y, (w = r), y), (e += 1));
      else if ("V" === o) (Ef(w, y, w, (y = r + (i ? y - w : 0))), (e += 1));
      else if ("L" === o || "Z" === o)
        ("Z" === o && ((r = l), (a = h), (s.closed = !0)),
          ("L" === o || 0.5 < U(w - r) || 0.5 < U(y - a)) &&
            (Ef(w, y, r, a), "L" === o && (e += 2)),
          (w = r),
          (y = a));
      else if ("A" === o) {
        ...
        ((w = s[s.length - 2]), (y = s[s.length - 1]));
      } else console.log(b);
    return (
      (e = s.length) < 6 ? (v.pop(), (e = 0)) : L(s),
      (v.totalPoints = P + e),
      v
    );
  }
  ...
  function pointsToSegment(t, e) {
    ...
    var n,
      ...
      M = x - w,
      R = t.nonSmooth || [],
      L = Math.abs(t[m] - v) < 0.001 && Math.abs(t[m + 1] - w) < 0.001;
    if (!m) return [v, w, v, w, v, w, v, w];
    for (
      L &&
        (t.push(y, x),
        (y = v),
      ...
      ((n = v),
        ...
        (v === y && w === x) ||
          ...
          R[a]
            ...
            : ((h =
                (((s = H(o * o + i * i)) + (l = H(b * b + M * M))) * e * 0.25) /
                H(Math.pow(b / l + o / s, 2) + Math.pow(M / l + i / s, 2))),
              (f =
                v -
                ((u = v - (v - n) * (s ? h / s : 0)) +
                  ((((g = v + (y - v) * (l ? h / l : 0)) - u) *
              ...
              (d =
                ...
                ((c = w - (w - r) * (s ? h / s : 0)) +
                  ((((p = w + (x - w) * (l ? h / l : 0)) - c) *
                    ((3 * s) / (s + l) + 0.5)) /
                    4 || 0))),
              P.push(N(u + f), N(c + d), N(v), N(w), N(g + f), N(p + d)))));
    return (
      v !== y || w !== x || P.length < 4
        ? P.push(N(y), N(x), N(y), N(x))
        : (P.length -= 2),
      2 === P.length
        ? P.push(v, w, v, w, v, w)
        : L && (P.splice(0, 6), (P.length -= 6)),
      (P.closed = L),
      P
    );
  }
  ...
  function S(t) {
    ...
    !(G in t.style) &&
      ...
      (j = (G = "msTransform") + "Origin");
    for (; e.parentNode && (e = e.parentNode););
    if (((v = window), (E = new Q()), e)) {
  ...
  function ba(t, e) {
    var n,
      ...
      g = t.parentNode,
      f =
        g && !l && g.shadowRoot && g.shadowRoot.appendChild ? g.shadowRoot : g;
    if (t === v) return t;
    if ((u.length || u.push($(t, 1), $(t, 2), $(t, 3)), (n = l ? b : P), l))
      (h
        ? ((o =
              ...
              (r = (r = t.transform ? t.transform.baseVal : {}).numberOfItems
                ? 1 < r.numberOfItems
                  ? (function _consolidate(t) {
                      for (var e = new Q(), n = 0; n < t.numberOfItems; n++)
        ...
        (h || !t.getBoundingClientRect().width ? l : g).appendChild(n),
        n.setAttribute(
          "transform",
          "matrix(" +
            r.a +
      ...
      if (((o = i = 0), k))
        for (
          ...
          4 < (v.getComputedStyle(a)[G] + "").length &&
  ...
  function getGlobalMatrix(t, e, n, r) {
    if (!t || !t.parentNode || (c || S(t)).documentElement === t)
      return new Q();
  ...
  function ra(t, e, n, r, a, o, i, s, l) {
    return (
      (e =
        "cubic" === i.type
          ? [e]
          : (!1 !== i.fromCurrent &&
              e.unshift(pa(n, r, s), a ? pa(n, a, l) : 0),
            i.relative && qa(e),
  ...
  var W,
    ...
    tt,
    o,
    et = "x,translateX,left,marginLeft,xPercent".split(","),
    nt = "y,translateY,top,marginTop,yPercent".split(","),
    i = Math.PI / 180,
    f = /[-+\.]*\d+\.?(?:e-|e\+)?\d*/g,
    rt = function _align(t, e, n) {
      var r,
        a,
        o,
        i = n.align,
        ...
        ? (i &&
            ("self" === i || (r = K(i)[0] || e) === e
              ...
              : (u && !1 !== u[2]
                  ...
                  : (u = [pa(e, "xPercent") / -100, pa(e, "yPercent") / -100]),
                (o = (a = va(e, r, u, "auto")).apply({ x: g, y: f })),
                transformRawPath(
                  t,
                  a.a,
                  a.b,
    ...
    at = function _addDimensionalPropTween(t, e, n, r, a, o) {
      var i = e._gsap,
        s = i.harness,
        l = s && s.aliases && s.aliases[n],
        h = l && l.indexOf(",") < 0 ? l : n,
        u = (t._pt = new g(t._pt, e, h, 0, 0, sa, 0, i.set(e, h, t)));
      ((u.u = J(i.get(e, h, o)) || 0),
        (u.path = r),
        (u.pp = a),
        t._props.push(h));
    ...
    a = {
      ...
      register: function register(t, e, n) {
        ((J = (W = t).utils.getUnit),
          (K = W.utils.toArray),
          (tt = W.core.getStyleSaver),
          (o = W.core.reverting || function () {}),
          (g = n));
      },
      init: function init(t, e, n) {
        ...
        if (
          ...
          (this.rotate = s || 0 === s) &&
            ...
            (this.ru = J(t._gsap.get(t, this.rProp)) || 0)),
          !Array.isArray(i) || "closed" in i || "number" == typeof f)
        )
          (cacheRawPathMeasurements(
            (r = c(rt(getRawPath(e.path), t, e))),
            e.resolution,
          ),
            o.push(r),
            at(this, t, e.x || "x", r, "x", e.unitX || "px"),
            at(this, t, e.y || "y", r, "y", e.unitY || "px"));
        else {
          for (a in f)
            !u && ~et.indexOf(a) ? (u = a) : !g && ~nt.indexOf(a) && (g = a);
          for (a in (u && g
            ? o.push(
                ra(
                  this,
          ...
          f))
            a !== u &&
              a !== g &&
              o.push(ra(this, oa([], i, a, 2), t, a, 0, c, e, J(i[0][a])));
        }
      ...
      arrayToRawPath: function arrayToRawPath(t, e) {
        var n = oa(oa([], t, (e = e || {}).x || "x", 0), t, e.y || "y", 1);
        return (
          e.relative && qa(n),
