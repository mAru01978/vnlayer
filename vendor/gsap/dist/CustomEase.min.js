...
!(function (e, t) {
    ...
    if (e !== o || t !== h) {
      ...
      for (L = 0; L < O; L++)
        ((d = B((a = R + L * z))),
          ...
          (T = B((a += z))),
          (V = k(a)),
          j.push(d - I * y, y + I * d, T + I * V, V - I * T, T, V));
  ...
  function stringToRawPath(e) {
    ...
    if (!e || !isNaN(y[0]) || isNaN(y[1])) return (console.log(b), p);
    for (t = 0; t < C; t++)
      if (
        ((m = i),
        isNaN(y[t]) ? (o = (i = y[t].toUpperCase()) !== y[t]) : t--,
        (a = +y[t + 1]),
        (r = +y[t + 2]),
        o && ((a += M), (r += v)),
        t || ((u = a), (f = r)),
        ...
        (h && (h.length < 8 ? --p.length : (E += h.length), n(h)),
          (M = u = a),
          (v = f = r),
          (h = [a, r]),
          p.push(h),
        ...
        ((c = M),
          (l = v),
          ("C" !== m && "S" !== m) ||
            ((c += M - h[h.length - 4]), (l += v - h[h.length - 3])),
          o || (M = v = 0),
          h.push(c, l, a, r, (M += 1 * y[t + 3]), (v += 1 * y[t + 4])),
          (t += 4));
      else if ("Q" === i)
        ((c = M + (2 / 3) * (a - M)),
          (l = v + (2 / 3) * (r - v)),
          ...
          (M += 1 * y[t + 3]),
          (v += 1 * y[t + 4]),
          h.push(c, l, M + (2 / 3) * (a - M), v + (2 / 3) * (r - v), M, v),
          (t += 4));
      else if ("T" === i)
        ((c = M - h[h.length - 4]),
          (l = v - h[h.length - 3]),
          ...
          (t += 2));
      else if ("H" === i) (fb(M, v, (M = a), v), (t += 1));
      else if ("V" === i) (fb(M, v, M, (v = a + (o ? v - M : 0))), (t += 1));
      else if ("L" === i || "Z" === i)
        ("Z" === i && ((a = u), (r = f), (h.closed = !0)),
          ("L" === i || 0.5 < F(M - a) || 0.5 < F(v - r)) &&
            (fb(M, v, a, r), "L" === i && (t += 2)),
          (M = a),
          (v = r));
      else if ("A" === i) {
        if (
          ...
          for (s = 0; s < g.length; s++) h.push(g[s]);
        ((M = h[h.length - 2]), (v = h[h.length - 1]));
      } else console.log(b);
    return (
      (t = h.length) < 6 ? (p.pop(), (t = 0)) : n(h),
      (p.totalPoints = E + t),
      p
    );
  }
  ...
  function r() {
    (M = q())
      ? (M.registerEase("_CE", i.create), (s = 1))
      : console.warn("Please gsap.registerPlugin(CustomEase)");
  }
  function t(e) {
    return ~~(1e3 * e + (e < 0 ? -0.5 : 0.5)) / 1e3;
  }
  function y(e, t, n, s, a, r, i, o, h, u, f) {
    var c,
      l = (e + n) / 2,
      g = (t + s) / 2,
      m = (n + a) / 2,
    ...
    return (
      ...
      h * (P * P + S * S) < (N + D) * (N + D) &&
        ((c = u.length),
        y(e, t, l, g, M, v, b, w, h, u, f),
        y(b, w, C, E, d, p, i, o, h, u, f + 1 + (u.length - c))),
      u
    );
  }
  var M,
    ...
    v = /[cLlsSaAhHvVtTqQ]/g,
    i =
      (((a = CustomEase.prototype).setData = function setData(e, t) {
        t = t || {};
        var n,
          s,
          a,
              ...
              ? ((u.cx = h.x - u.x),
                ...
                u.cx < l &&
                  (u.cx
                    ...
                    : ((u.cx = 0.001),
                      r === n - 1 &&
                        ((u.x -= 0.001), (l = Math.min(l, 0.001)), (d = 0)))))
              : (g.splice(r--, 1), n--));
        if (((i = 1 / (n = (1 / l + 1) | 0)), (h = g[(o = 0)]), d)) {
          for (r = 0; r < n; r++)
            ((f = r * i),
              h.nx < f && (h = g[++o]),
      ...
      (CustomEase.getSVGData = function getSVGData(e, n) {
        var s,
          a,
          r,
          i,
              ...
              for (var o, h, u, f, c, l = e.length; -1 < --l;)
                for (h = (o = e[l]).length, u = 0; u < h; u += 2)
                  ((f = o[u]),
                    ...
                    (o[u + 1] = f * n + c * a + i));
              return ((e._dirty = 1), e);
            })([e.segment.slice(0)], g, 0, 0, -x, d, y),
          );
        else {
          for (
            s = [d, y],
              i = 1 / (u = Math.max(5, 200 * (n.precision || 1))),
              f = 5 / (u += 2),
              c = t(d + i * g),
              a = ((l = t(y + e(i) * -x)) - y) / (c - d),
              r = 2;
            ...
            ((o = t(d + r * i * g)),
              ...
              (Math.abs((h - l) / (o - c) - a) > f || r === u - 1) &&
                (s.push(c, l), (a = (h - l) / (o - c))),
              (c = o),
              (l = h));
          s = "M" + s.join(",");
        }
        return (p && p.setAttribute("d", s), s);
      }),
      CustomEase);
