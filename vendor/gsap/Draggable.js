...
var gsap,
  ...
  _setTouchActionForAllDescendants = function _setTouchActionForAllDescendants(
    elements,
    value,
  ) {
            ...
            if (allowY) {
              ...
              if (gap < 0) {
                ...
                changeY = -Math.min(
                  ...
                  (autoScrollFactor *
                    (1 -
                      Math.max(0, pointerY - rect.top) / autoScrollMarginTop)) |
                    0,
                );
              }
        ...
        if (scrollProxy) {
          ...
          if (rotationMode) {
            parsedOrigin = target.ownerSVGElement
              ...
              : (
                  _getComputedStyle(target)[_transformOriginProp] || "0 0"
                ).split(" ");
        ...
        if (touches) {
          ...
          if (e !== touch && e.identifier !== touchID) {
            ...
            while (
              ...
              e.target !== target
            ) {} // Some Android devices dispatch a touchstart AND pointerdown initially, and then only pointermove thus the touchID may not match because it was grabbed from the touchstart event whereas the pointer event is the one that the browser dispatches for move, so if the event target matches this Draggable's target, let it through.
